...
page](/docs/transformers/master/en/pretrained_models.html) to see the checkpoints available for each type of model and all [the community models](https://huggingface.co/models).

Each one of the models in the library falls into one of the following categories:

- [autoregressive-models](/docs/transformers/master/en/model_summary.html#autoregressive-models)
- [autoencoding-models](/docs/transformers/master/en/model_summary.html#autoencoding-models)
- [seq-to-seq-models](/docs/transformers/master/en/model_summary.html#seq-to-seq-models)
- [multimodal-models](/docs/transformers/master/en/model_summary.html#multimodal-models)
- [retrieval-based-models](/docs/transformers/master/en/model_summary.html#retrieval-based-models)
...
## [Decoders or autoregressive models](#decoders-or-autoregressive-models)
...
- Use [Axial position encoding](/docs/transformers/master/en/model_summary.html#axial-pos-encoding) (see below for more details). It’s a mechanism to avoid
  having a huge positional encoding matrix (when the sequence length is very big) by factorizing it into smaller
  matrices.
- Replace traditional attention by [LSH (local-sensitive hashing) attention](/docs/transformers/master/en/model_summary.html#lsh-attention) (see below for more
...
## [Encoders or autoencoding models](#encoders-or-autoencoding-models)
...
[local attention section](/docs/transformers/master/en/model_summary.html#local-attention) for more information.
...
## [Sequence-to-sequence models](#sequencetosequence-models)
...
<!--More information in this [model documentation](/docs/transformers/master/en/model_doc/mmbt.html.html). TODO: write this page
-->

<a id='retrieval-based-models'></a>

## [Retrieval-based models](#retrievalbased-models)
...
## [More technical aspects](#more-technical-aspects)

### [Full vs sparse attention](#full-vs-sparse-attention)
...
[Reformer](/docs/transformers/master/en/model_summary.html#reformer) uses LSH attention. In the softmax(QK^t), only the biggest elements (in the softmax
...
[Longformer](/docs/transformers/master/en/model_summary.html#longformer) uses local attention: often, the local context (e.g., what are the two tokens to the
...
<img scale="50 %" align="center" src="imgs/local_attention_mask.png"/>
...
[Reformer](/docs/transformers/master/en/model_summary.html#reformer) uses axial positional encodings: in traditional transformer models, the positional encoding
