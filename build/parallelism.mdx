...
## [ZeRO Data Parallel](#zero-data-parallel)
...
## [Naive Model Parallel (Vertical) and Pipeline Parallel](#naive-model-parallel-vertical-and-pipeline-parallel)
...
## [Which Strategy To Use When](#which-strategy-to-use-when)
