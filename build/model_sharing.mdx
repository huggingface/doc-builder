...
# [Model sharing and uploading](#model-sharing-and-uploading)
...
We have seen in the [training tutorial](/docs/transformers/master/en/training.html): how to fine-tune a model on a given task. You have probably
...
acount by going on _huggingface.co &amp;lt;https://huggingface.co/>_, click on your avatar on the top left corner, then on
...
### [Directly push your model to the hub](#directly-push-your-model-to-the-hub)
...
finetuned model you saved in `save_drectory` by calling:
...
### [Add new files to your model repo](#add-new-files-to-your-model-repo)
...
## [Use your terminal and git](#use-your-terminal-and-git)
...
### [Make your model work on all frameworks](#make-your-model-work-on-all-frameworks)
...
or removing TF. For instance, if you trained a [DistilBertForSequenceClassification](/docs/transformers/master/en/model_doc/distilbert.html#transformers.DistilBertForSequenceClassification), try to type

```
>>> from transformers import TFDistilBertForSequenceClassification
```

and if you trained a [TFDistilBertForSequenceClassification](/docs/transformers/master/en/model_doc/distilbert.html#transformers.TFDistilBertForSequenceClassification), try to type
...
### [Check the directory before pushing to the model hub.](#check-the-directory-before-pushing-to-the-model-hub)

Make sure there are no garbage files in the directory you'll upload. It should only have:

- a _config.json_ file, which saves the [configuration](/docs/transformers/master/en/main_classes/configuration.html) of your model ;
...
- a _special_tokens_map.json_, which is part of your [tokenizer](/docs/transformers/master/en/main_classes/tokenizer.html) save;
- a _tokenizer_config.json_, which is part of your [tokenizer](/docs/transformers/master/en/main_classes/tokenizer.html) save;
- files named _vocab.json_, _vocab.txt_, _merges.txt_, or similar, which contain the vocabulary of your tokenizer, part
  of your [tokenizer](/docs/transformers/master/en/main_classes/tokenizer.html) save;
- maybe a _added_tokens.json_, which is part of your [tokenizer](/docs/transformers/master/en/main_classes/tokenizer.html) save.
