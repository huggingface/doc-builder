...
- somelink to fine-tune pegasus
  on the XSUM dataset. Data download instructions at somelink.
- FP16 is not supported (help/ideas on this appreciated!).
...
> **class transformers.PegasusTokenizer**(vocab_file, pad_token = &lcubpad>, eos_token = &lcub/s>, unk_token = &lcubunk>, mask_token = &amp;lt;mask_2>, mask_token_sent = &amp;lt;mask_1>, additional_special_tokens = None, offset = 103, sp_model_kwargs: typing.Union[typing.Dict[str, typing.Any], NoneType] = None, **kwargs)
...
- pair of sequences: `A B &lcub/s>` (not intended use)
...
> **class transformers.PegasusTokenizerFast**(vocab_file = None, tokenizer_file = None, pad_token = &lcubpad>, eos_token = &lcub/s>, unk_token = &lcubunk>, mask_token = &amp;lt;mask_2>, mask_token_sent = &amp;lt;mask_1>, additional_special_tokens = None, offset = 103, **kwargs)
...
<a id='transformers.PegasusTokenizer'></a>
> **class PegasusTokenizer**(vocab_file, pad_token = &lcubpad>, eos_token = &lcub/s>, unk_token = &lcubunk>, mask_token = &amp;lt;mask_2>, mask_token_sent = &amp;lt;mask_1>, additional_special_tokens = None, offset = 103, sp_model_kwargs: typing.Union[typing.Dict[str, typing.Any], NoneType] = None, **kwargs)
