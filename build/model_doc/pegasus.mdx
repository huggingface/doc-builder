...
- The implementation is completely inherited from [BartForConditionalGeneration](model_doc/bart.html#transformers.BartForConditionalGeneration)
...
This is the configuration class to store the configuration of a [PegasusModel](model_doc/pegasus.html#transformers.PegasusModel). It is used to
...
- **vocab_size** (`int`, _optional_, defaults to 50265) --
  ...
  `inputs_ids` passed when calling [PegasusModel](model_doc/pegasus.html#transformers.PegasusModel) or
  [TFPegasusModel](model_doc/pegasus.html#transformers.TFPegasusModel).
...
- **config** ([PegasusConfig](model_doc/pegasus.html#transformers.PegasusConfig)) --
...
The [PegasusModel](model_doc/pegasus.html#transformers.PegasusModel) forward method, overrides the `__call__` special method.
...
various elements depending on the configuration ([PegasusConfig](model_doc/pegasus.html#transformers.PegasusConfig)) and inputs.
...
The [PegasusForConditionalGeneration](model_doc/pegasus.html#transformers.PegasusForConditionalGeneration) forward method, overrides the `__call__` special method.
...
- **config** ([PegasusConfig](model_doc/pegasus.html#transformers.PegasusConfig)) -- Model configuration class with all the parameters of the model.
...
The [TFPegasusModel](model_doc/pegasus.html#transformers.TFPegasusModel) forward method, overrides the `__call__` special method.
...
elements depending on the configuration ([PegasusConfig](model_doc/pegasus.html#transformers.PegasusConfig)) and inputs.
...
The [TFPegasusForConditionalGeneration](model_doc/pegasus.html#transformers.TFPegasusForConditionalGeneration) forward method, overrides the `__call__` special method.
