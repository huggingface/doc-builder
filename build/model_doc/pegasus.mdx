...
- The implementation is completely inherited from [BartForConditionalGeneration](docs/transformers/:version/:language/model_doc/bart.html#transformers.BartForConditionalGeneration)
...
This is the configuration class to store the configuration of a [PegasusModel](docs/transformers/:version/:language/model_doc/pegasus.html#transformers.PegasusModel). It is used to
...
- **vocab_size** (`int`, _optional_, defaults to 50265) --
  ...
  `inputs_ids` passed when calling [PegasusModel](docs/transformers/:version/:language/model_doc/pegasus.html#transformers.PegasusModel) or
  [TFPegasusModel](docs/transformers/:version/:language/model_doc/pegasus.html#transformers.TFPegasusModel).
...
- **config** ([PegasusConfig](docs/transformers/:version/:language/model_doc/pegasus.html#transformers.PegasusConfig)) --
...
The [PegasusModel](docs/transformers/:version/:language/model_doc/pegasus.html#transformers.PegasusModel) forward method, overrides the `__call__` special method.
...
- **input_ids** (`torch.LongTensor` of shape `(batch_size, sequence_length)`) --
  ...
  Indices can be obtained using [PegasusTokenizer](docs/transformers/:version/:language/model_doc/pegasus.html#transformers.PegasusTokenizer). See
...
various elements depending on the configuration ([PegasusConfig](docs/transformers/:version/:language/model_doc/pegasus.html#transformers.PegasusConfig)) and inputs.
...
The [PegasusForConditionalGeneration](docs/transformers/:version/:language/model_doc/pegasus.html#transformers.PegasusForConditionalGeneration) forward method, overrides the `__call__` special method.
...
- **config** ([PegasusConfig](docs/transformers/:version/:language/model_doc/pegasus.html#transformers.PegasusConfig)) -- Model configuration class with all the parameters of the model.
...
The [TFPegasusModel](docs/transformers/:version/:language/model_doc/pegasus.html#transformers.TFPegasusModel) forward method, overrides the `__call__` special method.
...
elements depending on the configuration ([PegasusConfig](docs/transformers/:version/:language/model_doc/pegasus.html#transformers.PegasusConfig)) and inputs.
...
The [TFPegasusForConditionalGeneration](docs/transformers/:version/:language/model_doc/pegasus.html#transformers.TFPegasusForConditionalGeneration) forward method, overrides the `__call__` special method.
...
A [FlaxSeq2SeqModelOutput](docs/transformers/:version/:language/main_classes/output.html#transformers.modeling_flax_outputs.FlaxSeq2SeqModelOutput) or a tuple of
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising
various elements depending on the configuration ([PegasusConfig](docs/transformers/:version/:language/model_doc/pegasus.html#transformers.PegasusConfig)) and inputs.
...
[FlaxSeq2SeqModelOutput](docs/transformers/:version/:language/main_classes/output.html#transformers.modeling_flax_outputs.FlaxSeq2SeqModelOutput) or `tuple(torch.FloatTensor)`
