...
Note that LayoutXLM requires a different tokenizer, based on [XLMRobertaTokenizer](docs/transformers/:version/:language/model_doc/xlmroberta.html#transformers.XLMRobertaTokenizer). You can
...
As LayoutXLM's architecture is equivalent to that of LayoutLMv2, one can refer to [LayoutLMv2's documentation page](/docs/transformers/:version/:language/layoutlmv2.html) for all tips, code examples and notebooks.
