...
Note that LayoutXLM requires a different tokenizer, based on [XLMRobertaTokenizer](model_doc/xlmroberta.html#transformers.XLMRobertaTokenizer). You can
...
As LayoutXLM's architecture is equivalent to that of LayoutLMv2, one can refer to [LayoutLMv2's documentation page](layoutlmv2.html) for all tips, code examples and notebooks.
