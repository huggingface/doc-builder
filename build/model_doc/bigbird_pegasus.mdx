...
This is the configuration class to store the configuration of a [BigBirdPegasusModel](docs/transformers/:version/:language/model_doc/bigbird_pegasus.html#transformers.BigBirdPegasusModel). It is
...
- **vocab_size** (`int`, _optional_, defaults to 96103) --
  ...
  by the `inputs_ids` passed when calling [BigBirdPegasusModel](docs/transformers/:version/:language/model_doc/bigbird_pegasus.html#transformers.BigBirdPegasusModel).
...
- **config** ([BigBirdPegasusConfig](docs/transformers/:version/:language/model_doc/bigbird_pegasus.html#transformers.BigBirdPegasusConfig)) --
...
The [BigBirdPegasusModel](docs/transformers/:version/:language/model_doc/bigbird_pegasus.html#transformers.BigBirdPegasusModel) forward method, overrides the `__call__` special method.
...
various elements depending on the configuration ([BigBirdPegasusConfig](docs/transformers/:version/:language/model_doc/bigbird_pegasus.html#transformers.BigBirdPegasusConfig)) and inputs.
...
The [BigBirdPegasusForConditionalGeneration](docs/transformers/:version/:language/model_doc/bigbird_pegasus.html#transformers.BigBirdPegasusForConditionalGeneration) forward method, overrides the `__call__` special method.
...
The [BigBirdPegasusForSequenceClassification](docs/transformers/:version/:language/model_doc/bigbird_pegasus.html#transformers.BigBirdPegasusForSequenceClassification) forward method, overrides the `__call__` special method.
...
The [BigBirdPegasusForQuestionAnswering](docs/transformers/:version/:language/model_doc/bigbird_pegasus.html#transformers.BigBirdPegasusForQuestionAnswering) forward method, overrides the `__call__` special method.
