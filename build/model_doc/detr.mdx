...
> **post\_process\_segmentation**(self, results, outputs, orig_target_sizes, max_target_sizes, threshold = 0.5)


Converts the output of [DetrForSegmentation](model_doc/detr.html#transformers.DetrForSegmentation) into actual instance segmentation
predictions. Only supports PyTorch.

> Parameters

- **results** (`List[Dict]`) --
  Results list obtained by [post_process()](model_doc/detr.html#transformers.DetrFeatureExtractor.post_process), to which "masks"
...
- **threshold** (`float`, _optional_, defaults to 0.5) --
  Threshold to use when turning the predicted masks into binary values.

> Returns

A list of dictionaries, each dictionary containing the scores, labels, boxes and masks
