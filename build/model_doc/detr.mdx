...
Here's a TLDR explaining how [DetrForObjectDetection](docs/transformers/:version/:language/model_doc/detr.html#transformers.DetrForObjectDetection) works:
...
segmentation). [DetrForSegmentation](docs/transformers/:version/:language/model_doc/detr.html#transformers.DetrForSegmentation) adds a segmentation mask head on top of
[DetrForObjectDetection](docs/transformers/:version/:language/model_doc/detr.html#transformers.DetrForObjectDetection). The mask head can be trained either jointly, or in a two steps process,
where one first trains a [DetrForObjectDetection](docs/transformers/:version/:language/model_doc/detr.html#transformers.DetrForObjectDetection) model to detect bounding boxes around both
...
- DETR uses so-called **object queries** to detect objects in an image. The number of queries determines the maximum
  ...
  `num_queries` of [DetrConfig](docs/transformers/:version/:language/model_doc/detr.html#transformers.DetrConfig)). Note that it's good to have some slack (in COCO, the
...
- DETR adds position embeddings to the hidden states at each self-attention and cross-attention layer before projecting
  ...
  [DetrConfig](docs/transformers/:version/:language/model_doc/detr.html#transformers.DetrConfig) is set to `"sine"`.
- During training, the authors of DETR did find it helpful to use auxiliary losses in the decoder, especially to help
  ...
  [DetrConfig](docs/transformers/:version/:language/model_doc/detr.html#transformers.DetrConfig) to `True`, then prediction feedforward neural networks and Hungarian losses
...
- [DetrForObjectDetection](docs/transformers/:version/:language/model_doc/detr.html#transformers.DetrForObjectDetection) and [DetrForSegmentation](docs/transformers/:version/:language/model_doc/detr.html#transformers.DetrForSegmentation) can be initialized with
  ...
  [DetrConfig](docs/transformers/:version/:language/model_doc/detr.html#transformers.DetrConfig) to `"tf_mobilenetv3_small_075"`, and then initializing the model with that
  config.
- DETR resizes the input images such that the shortest side is at least a certain amount of pixels while the longest is
  ...
  [DetrFeatureExtractor](docs/transformers/:version/:language/model_doc/detr.html#transformers.DetrFeatureExtractor) to prepare images (and optional annotations in COCO format) for the
  ...
  [pad_and_create_pixel_mask()](docs/transformers/:version/:language/model_doc/detr.html#transformers.DetrFeatureExtractor.pad_and_create_pixel_mask).
...
| **Model**                                   | [DetrForObjectDetection](docs/transformers/:version/:language/model_doc/detr.html#transformers.DetrForObjectDetection)           | [DetrForSegmentation](docs/transformers/:version/:language/model_doc/detr.html#transformers.DetrForSegmentation)                           | [DetrForSegmentation](docs/transformers/:version/:language/model_doc/detr.html#transformers.DetrForSegmentation)                             |
...
| [DetrFeatureExtractor](docs/transformers/:version/:language/model_doc/detr.html#transformers.DetrFeatureExtractor) | ‘annotations’: List[Dict]}, each Dict being a COCO      | ‘annotations’: [List[Dict]] } (in case of COCO detection)            | ‘image_id: int,                                                        |
...
| **Postprocessing** (i.e. converting the     | [post_process()](docs/transformers/:version/:language/model_doc/detr.html#transformers.DetrFeatureExtractor.post_process) | [post_process_segmentation()](docs/transformers/:version/:language/model_doc/detr.html#transformers.DetrFeatureExtractor.post_process_segmentation) | [post_process_segmentation()](docs/transformers/:version/:language/model_doc/detr.html#transformers.DetrFeatureExtractor.post_process_segmentation),  |
| output of the model to COCO API)            |                                                         |                                                                      | [post_process_panoptic()](docs/transformers/:version/:language/model_doc/detr.html#transformers.DetrFeatureExtractor.post_process_panoptic)       |
...
[DetrFeatureExtractor](docs/transformers/:version/:language/model_doc/detr.html#transformers.DetrFeatureExtractor) to create `pixel_values`, `pixel_mask` and optional
`labels`, which can then be used to train (or fine-tune) a model. For evaluation, one should first convert the
outputs of the model using one of the postprocessing methods of [DetrFeatureExtractor](docs/transformers/:version/:language/model_doc/detr.html#transformers.DetrFeatureExtractor). These can
...
Output type of [DetrForObjectDetection](docs/transformers/:version/:language/model_doc/detr.html#transformers.DetrForObjectDetection).
...
- **pred_boxes** (`torch.FloatTensor` of shape `(batch_size, num_queries, 4)`) --
  ...
  possible padding). You can use [post_process()](docs/transformers/:version/:language/model_doc/detr.html#transformers.DetrFeatureExtractor.post_process) to retrieve the
...
Output type of [DetrForSegmentation](docs/transformers/:version/:language/model_doc/detr.html#transformers.DetrForSegmentation).
...
- **pred_masks** (`torch.FloatTensor` of shape `(batch_size, num_queries, height/4, width/4)`) --
  ...
  [post_process_segmentation()](docs/transformers/:version/:language/model_doc/detr.html#transformers.DetrFeatureExtractor.post_process_segmentation) or
  [post_process_panoptic()](docs/transformers/:version/:language/model_doc/detr.html#transformers.DetrFeatureExtractor.post_process_panoptic) to evaluate instance and panoptic
...
This is the configuration class to store the configuration of a [DetrModel](docs/transformers/:version/:language/model_doc/detr.html#transformers.DetrModel). It is used to
...
- **num_queries** (`int`, _optional_, defaults to 100) --
  ...
  [DetrModel](docs/transformers/:version/:language/model_doc/detr.html#transformers.DetrModel) can detect in a single image. For COCO, we recommend 100 queries.
...
- **annotations** (`Dict`, `List[Dict]`, _optional_) --
  ...
  In case [DetrFeatureExtractor](docs/transformers/:version/:language/model_doc/detr.html#transformers.DetrFeatureExtractor) was initialized with `format = "coco_detection"`, the annotations for each image should have the following format: &amp;lcub;'image_id': int,
  'annotations': [annotation]}, with the annotations being a list of COCO object annotations.

  In case [DetrFeatureExtractor](docs/transformers/:version/:language/model_doc/detr.html#transformers.DetrFeatureExtractor) was initialized with `format = "coco_panoptic"`, the annotations for each image should have the following format: &amp;lcub;'image_id': int,
...
- **masks_path** (`pathlib.Path`, _optional_) --
  ...
  relevant in case [DetrFeatureExtractor](docs/transformers/:version/:language/model_doc/detr.html#transformers.DetrFeatureExtractor) was initialized with `format = "coco_panoptic"`.
...
A [BatchFeature](docs/transformers/:version/:language/main_classes/feature_extractor.html#transformers.BatchFeature) with the following fields:
...
Converts the output of [DetrForObjectDetection](docs/transformers/:version/:language/model_doc/detr.html#transformers.DetrForObjectDetection) into the format expected by the COCO api.
...
Converts the output of [DetrForSegmentation](docs/transformers/:version/:language/model_doc/detr.html#transformers.DetrForSegmentation) into image segmentation predictions. Only
supports PyTorch.
...
Converts the output of [DetrForSegmentation](docs/transformers/:version/:language/model_doc/detr.html#transformers.DetrForSegmentation) into actual panoptic predictions. Only
supports PyTorch.
...
- **config** ([DetrConfig](docs/transformers/:version/:language/model_doc/detr.html#transformers.DetrConfig)) --
...
The [DetrModel](docs/transformers/:version/:language/model_doc/detr.html#transformers.DetrModel) forward method, overrides the `__call__` special method.
...
- **pixel_values** (`torch.FloatTensor` of shape `(batch_size, num_channels, height, width)`) --
  ...
  Pixel values can be obtained using [DetrFeatureExtractor](docs/transformers/:version/:language/model_doc/detr.html#transformers.DetrFeatureExtractor). See
  [transformers.DetrFeatureExtractor.__call__()](docs/transformers/:version/:language/model_doc/detr.html#transformers.DetrFeatureExtractor.__call__) for details.
...
A [DetrModelOutput](docs/transformers/:version/:language/model_doc/detr.html#transformers.models.detr.modeling_detr.DetrModelOutput) or a tuple of
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising
various elements depending on the configuration ([DetrConfig](docs/transformers/:version/:language/model_doc/detr.html#transformers.DetrConfig)) and inputs.
...
[DetrModelOutput](docs/transformers/:version/:language/model_doc/detr.html#transformers.models.detr.modeling_detr.DetrModelOutput) or `tuple(torch.FloatTensor)`
...
The [DetrForObjectDetection](docs/transformers/:version/:language/model_doc/detr.html#transformers.DetrForObjectDetection) forward method, overrides the `__call__` special method.
...
A [DetrObjectDetectionOutput](docs/transformers/:version/:language/model_doc/detr.html#transformers.models.detr.modeling_detr.DetrObjectDetectionOutput) or a tuple of
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising
various elements depending on the configuration ([DetrConfig](docs/transformers/:version/:language/model_doc/detr.html#transformers.DetrConfig)) and inputs.
...
[DetrObjectDetectionOutput](docs/transformers/:version/:language/model_doc/detr.html#transformers.models.detr.modeling_detr.DetrObjectDetectionOutput) or `tuple(torch.FloatTensor)`
...
The [DetrForSegmentation](docs/transformers/:version/:language/model_doc/detr.html#transformers.DetrForSegmentation) forward method, overrides the `__call__` special method.
...
A [DetrSegmentationOutput](docs/transformers/:version/:language/model_doc/detr.html#transformers.models.detr.modeling_detr.DetrSegmentationOutput) or a tuple of
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising
various elements depending on the configuration ([DetrConfig](docs/transformers/:version/:language/model_doc/detr.html#transformers.DetrConfig)) and inputs.
...
[DetrSegmentationOutput](docs/transformers/:version/:language/model_doc/detr.html#transformers.models.detr.modeling_detr.DetrSegmentationOutput) or `tuple(torch.FloatTensor)`
