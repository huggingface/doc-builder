...
- **config** ([PretrainedConfig](main_classes/configuration.html#transformers.PretrainedConfig)) -- Model configuration class with all the parameters of the model.
...
> **class transformers.FlaxEncoderDecoderModel**(config: EncoderDecoderConfig, input_shape: typing.Optional[typing.Tuple] = None, seed: int = 0, dtype: dtype = &lcubclass 'jax._src.numpy.lax_numpy.float32'&rcub, **kwargs)
