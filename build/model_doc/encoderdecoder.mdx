...
The [EncoderDecoderModel](docs/transformers/:version/:language/model_doc/encoderdecoder.html#transformers.EncoderDecoderModel) can be used to initialize a sequence-to-sequence model with any
...
After such an [EncoderDecoderModel](docs/transformers/:version/:language/model_doc/encoderdecoder.html#transformers.EncoderDecoderModel) has been trained/fine-tuned, it can be saved/loaded just like
any other models (see the examples for more information).

An application of this architecture could be to leverage two pretrained [BertModel](docs/transformers/:version/:language/model_doc/bert.html#transformers.BertModel) as the encoder
...
[EncoderDecoderConfig](docs/transformers/:version/:language/model_doc/encoderdecoder.html#transformers.EncoderDecoderConfig) is the configuration class to store the configuration of a
[EncoderDecoderModel](docs/transformers/:version/:language/model_doc/encoderdecoder.html#transformers.EncoderDecoderModel). It is used to instantiate an Encoder Decoder model according to the
...
- **kwargs** (_optional_) --
  ...
  - **encoder** ([PretrainedConfig](docs/transformers/:version/:language/main_classes/configuration.html#transformers.PretrainedConfig), _optional_) -- An instance of a configuration
    object that defines the encoder config.
  - **decoder** ([PretrainedConfig](docs/transformers/:version/:language/main_classes/configuration.html#transformers.PretrainedConfig), _optional_) -- An instance of a configuration
...
- **config** ([EncoderDecoderConfig](docs/transformers/:version/:language/model_doc/encoderdecoder.html#transformers.EncoderDecoderConfig)) -- Model configuration class with all the parameters of the model.
  ...
  [EncoderDecoderModel](docs/transformers/:version/:language/model_doc/encoderdecoder.html#transformers.EncoderDecoderModel) is a generic model class that will be instantiated as a transformer
...
The [EncoderDecoderModel](docs/transformers/:version/:language/model_doc/encoderdecoder.html#transformers.EncoderDecoderModel) forward method, overrides the `__call__` special method.
...
- **decoder_input_ids** (`torch.LongTensor` of shape `(batch_size, target_sequence_length)`, _optional_) --
  ...
  [PreTrainedTokenizer](docs/transformers/:version/:language/main_classes/tokenizer.html#transformers.PreTrainedTokenizer). See [transformers.PreTrainedTokenizer.encode()](docs/transformers/:version/:language/internal/tokenization_utils.html#transformers.PreTrainedTokenizerBase.encode) and
...
various elements depending on the configuration ([EncoderDecoderConfig](docs/transformers/:version/:language/model_doc/encoderdecoder.html#transformers.EncoderDecoderConfig)) and inputs.
...
<a id='transformers.TFEncoderDecoderModel'></a>
> **class transformers.TFEncoderDecoderModel**(*args, **kwargs)
...
<a id='transformers.TFEncoderDecoderModel.call'></a>
> **call**(self, input_ids = None, attention_mask = None, decoder_input_ids = None, decoder_attention_mask = None, encoder_outputs = None, past_key_values = None, inputs_embeds = None, decoder_inputs_embeds = None, labels = None, use_cache = None, output_attentions = None, output_hidden_states = None, return_dict = None, training = False, **kwargs)

The [TFEncoderDecoderModel](docs/transformers/:version/:language/model_doc/encoderdecoder.html#transformers.TFEncoderDecoderModel) forward method, overrides the `__call__` special method.
...
elements depending on the configuration ([EncoderDecoderConfig](docs/transformers/:version/:language/model_doc/encoderdecoder.html#transformers.EncoderDecoderConfig)) and inputs.
...
<a id='transformers.TFEncoderDecoderModel.from_encoder_decoder_pretrained'></a>
> **from\_encoder\_decoder\_pretrained**(encoder_pretrained_model_name_or_path: str = None, decoder_pretrained_model_name_or_path: str = None, *model_args, **kwargs)
...
- **config** ([EncoderDecoderConfig](docs/transformers/:version/:language/model_doc/encoderdecoder.html#transformers.EncoderDecoderConfig)) -- Model configuration class with all the parameters of the model.
  ...
  [FlaxEncoderDecoderModel](docs/transformers/:version/:language/model_doc/encoderdecoder.html#transformers.FlaxEncoderDecoderModel) is a generic model class that will be instantiated as a transformer
...
The [FlaxEncoderDecoderModel](docs/transformers/:version/:language/model_doc/encoderdecoder.html#transformers.FlaxEncoderDecoderModel) forward method, overrides the `__call__` special method.
