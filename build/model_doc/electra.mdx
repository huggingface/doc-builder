...
- local: electraconfig
  title: ElectraConfig
- local: electratokenizer
  title: ElectraTokenizer
- local: electratokenizerfast
  title: ElectraTokenizerFast
- local: electra-specific-outputs
  title: Electra specific outputs
- local: electramodel
  title: ElectraModel
- local: electraforpretraining
  title: ElectraForPreTraining
- local: electraformaskedlm
  title: ElectraForMaskedLM
- local: electraforsequenceclassification
  title: ElectraForSequenceClassification
- local: electraformultiplechoice
  title: ElectraForMultipleChoice
- local: electrafortokenclassification
  title: ElectraForTokenClassification
- local: electraforquestionanswering
  title: ElectraForQuestionAnswering
- local: tfelectramodel
  title: TFElectraModel
- local: tfelectraforpretraining
  title: TFElectraForPreTraining
- local: tfelectraformaskedlm
  title: TFElectraForMaskedLM
- local: tfelectraforsequenceclassification
  title: TFElectraForSequenceClassification
- local: tfelectraformultiplechoice
  title: TFElectraForMultipleChoice
- local: tfelectrafortokenclassification
  title: TFElectraForTokenClassification
- local: tfelectraforquestionanswering
  title: TFElectraForQuestionAnswering
- local: flaxelectramodel
  title: FlaxElectraModel
- local: flaxelectraforpretraining
  title: FlaxElectraForPreTraining
- local: flaxelectraformaskedlm
  title: FlaxElectraForMaskedLM
- local: flaxelectraforsequenceclassification
  title: FlaxElectraForSequenceClassification
- local: flaxelectraformultiplechoice
  title: FlaxElectraForMultipleChoice
- local: flaxelectrafortokenclassification
  title: FlaxElectraForTokenClassification
- local: flaxelectraforquestionanswering
...
- The ELECTRA checkpoints saved using [Google Research's implementation](https://github.com/google-research/electra)
  ...
  [ElectraForMaskedLM](/docs/transformers/master/en/model_doc/electra.html#transformers.ElectraForMaskedLM) model, and the generator may be loaded in the
  [ElectraForPreTraining](/docs/transformers/master/en/model_doc/electra.html#transformers.ElectraForPreTraining) model (the classification head will be randomly initialized as it
...
This is the configuration class to store the configuration of a [ElectraModel](/docs/transformers/master/en/model_doc/electra.html#transformers.ElectraModel) or a
[TFElectraModel](/docs/transformers/master/en/model_doc/electra.html#transformers.TFElectraModel). It is used to instantiate a ELECTRA model according to the specified
...
- **vocab_size** (`int`, _optional_, defaults to 30522) --
  ...
  `inputs_ids` passed when calling [ElectraModel](/docs/transformers/master/en/model_doc/electra.html#transformers.ElectraModel) or
  [TFElectraModel](/docs/transformers/master/en/model_doc/electra.html#transformers.TFElectraModel).
...
- **type_vocab_size** (`int`, _optional_, defaults to 2) --
  The vocabulary size of the `token_type_ids` passed when calling [ElectraModel](/docs/transformers/master/en/model_doc/electra.html#transformers.ElectraModel) or
  [TFElectraModel](/docs/transformers/master/en/model_doc/electra.html#transformers.TFElectraModel).
...
[ElectraTokenizer](/docs/transformers/master/en/model_doc/electra.html#transformers.ElectraTokenizer) is identical to [BertTokenizer](/docs/transformers/master/en/model_doc/bert.html#transformers.BertTokenizer) and runs end-to-end
...
## [ElectraTokenizerFast](#electratokenizerfast)
...
[ElectraTokenizerFast](/docs/transformers/master/en/model_doc/electra.html#transformers.ElectraTokenizerFast) is identical to [BertTokenizerFast](/docs/transformers/master/en/model_doc/bert.html#transformers.BertTokenizerFast) and runs
...
Output type of [ElectraForPreTraining](/docs/transformers/master/en/model_doc/electra.html#transformers.ElectraForPreTraining).
...
Output type of [TFElectraForPreTraining](/docs/transformers/master/en/model_doc/electra.html#transformers.TFElectraForPreTraining).
...
- **config** ([ElectraConfig](/docs/transformers/master/en/model_doc/electra.html#transformers.ElectraConfig)) -- Model configuration class with all the parameters of the model.
...
The [ElectraModel](/docs/transformers/master/en/model_doc/electra.html#transformers.ElectraModel) forward method, overrides the `__call__` special method.
...
- **input_ids** (`torch.LongTensor` of shape `(batch_size, sequence_length)`) --
  ...
  Indices can be obtained using [ElectraTokenizer](/docs/transformers/master/en/model_doc/electra.html#transformers.ElectraTokenizer). See
...
A [BaseModelOutputWithCrossAttentions](/docs/transformers/master/en/main_classes/output.html#transformers.modeling_outputs.BaseModelOutputWithCrossAttentions) or a tuple of
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising
various elements depending on the configuration ([ElectraConfig](/docs/transformers/master/en/model_doc/electra.html#transformers.ElectraConfig)) and inputs.
...
[BaseModelOutputWithCrossAttentions](/docs/transformers/master/en/main_classes/output.html#transformers.modeling_outputs.BaseModelOutputWithCrossAttentions) or `tuple(torch.FloatTensor)`
...
The [ElectraForPreTraining](/docs/transformers/master/en/model_doc/electra.html#transformers.ElectraForPreTraining) forward method, overrides the `__call__` special method.
...
A [ElectraForPreTrainingOutput](/docs/transformers/master/en/model_doc/electra.html#transformers.models.electra.modeling_electra.ElectraForPreTrainingOutput) or a tuple of
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising
various elements depending on the configuration ([ElectraConfig](/docs/transformers/master/en/model_doc/electra.html#transformers.ElectraConfig)) and inputs.
...
[ElectraForPreTrainingOutput](/docs/transformers/master/en/model_doc/electra.html#transformers.models.electra.modeling_electra.ElectraForPreTrainingOutput) or `tuple(torch.FloatTensor)`
...
The [ElectraForMaskedLM](/docs/transformers/master/en/model_doc/electra.html#transformers.ElectraForMaskedLM) forward method, overrides the `__call__` special method.
...
The [ElectraForSequenceClassification](/docs/transformers/master/en/model_doc/electra.html#transformers.ElectraForSequenceClassification) forward method, overrides the `__call__` special method.
...
The [ElectraForMultipleChoice](/docs/transformers/master/en/model_doc/electra.html#transformers.ElectraForMultipleChoice) forward method, overrides the `__call__` special method.
...
The [ElectraForTokenClassification](/docs/transformers/master/en/model_doc/electra.html#transformers.ElectraForTokenClassification) forward method, overrides the `__call__` special method.
...
The [ElectraForQuestionAnswering](/docs/transformers/master/en/model_doc/electra.html#transformers.ElectraForQuestionAnswering) forward method, overrides the `__call__` special method.
...
The [TFElectraModel](/docs/transformers/master/en/model_doc/electra.html#transformers.TFElectraModel) forward method, overrides the `__call__` special method.
...
elements depending on the configuration ([ElectraConfig](/docs/transformers/master/en/model_doc/electra.html#transformers.ElectraConfig)) and inputs.
...
The [TFElectraForPreTraining](/docs/transformers/master/en/model_doc/electra.html#transformers.TFElectraForPreTraining) forward method, overrides the `__call__` special method.
...
A [TFElectraForPreTrainingOutput](/docs/transformers/master/en/model_doc/electra.html#transformers.models.electra.modeling_tf_electra.TFElectraForPreTrainingOutput) or a tuple of
`tf.Tensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([ElectraConfig](/docs/transformers/master/en/model_doc/electra.html#transformers.ElectraConfig)) and inputs.
...
[TFElectraForPreTrainingOutput](/docs/transformers/master/en/model_doc/electra.html#transformers.models.electra.modeling_tf_electra.TFElectraForPreTrainingOutput) or `tuple(tf.Tensor)`
...
The [TFElectraForMaskedLM](/docs/transformers/master/en/model_doc/electra.html#transformers.TFElectraForMaskedLM) forward method, overrides the `__call__` special method.
...
The [TFElectraForSequenceClassification](/docs/transformers/master/en/model_doc/electra.html#transformers.TFElectraForSequenceClassification) forward method, overrides the `__call__` special method.
...
The [TFElectraForMultipleChoice](/docs/transformers/master/en/model_doc/electra.html#transformers.TFElectraForMultipleChoice) forward method, overrides the `__call__` special method.
...
The [TFElectraForTokenClassification](/docs/transformers/master/en/model_doc/electra.html#transformers.TFElectraForTokenClassification) forward method, overrides the `__call__` special method.
...
The [TFElectraForQuestionAnswering](/docs/transformers/master/en/model_doc/electra.html#transformers.TFElectraForQuestionAnswering) forward method, overrides the `__call__` special method.
...
## [FlaxElectraForSequenceClassification](#flaxelectraforsequenceclassification)
...
## [FlaxElectraForQuestionAnswering](#flaxelectraforquestionanswering)
