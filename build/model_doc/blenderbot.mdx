...
["&lcubs> That's unfortunate. Are they trying to lose weight or are they just trying to be healthier?&lcub/s>"]
```
...
> **class transformers.BlenderbotTokenizer**(vocab_file, merges_file, errors = replace, bos_token = &lcubs>, eos_token = &lcub/s>, sep_token = &lcub/s>, cls_token = &lcubs>, unk_token = &lcubunk>, pad_token = &lcubpad>, mask_token = &lcubmask>, add_prefix_space = False, **kwargs)
...
>>> print("Human: ", REPLY)
>>> NEXT_UTTERANCE = (
... "My friends are cool but they eat too many carbs.&lcub/s> &lcubs>That's unfortunate. "
... "Are they trying to lose weight or are they just trying to be healthier?&lcub/s> "
... "&lcubs> I'm not sure."
... )
