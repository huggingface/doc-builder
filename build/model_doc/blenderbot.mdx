...
This is the configuration class to store the configuration of a [BlenderbotModel](docs/transformers/:version/:language/model_doc/blenderbot.html#transformers.BlenderbotModel). It is used
...
- **vocab_size** (`int`, _optional_, defaults to 50265) --
  ...
  the `inputs_ids` passed when calling [BlenderbotModel](docs/transformers/:version/:language/model_doc/blenderbot.html#transformers.BlenderbotModel) or
  [TFBlenderbotModel](docs/transformers/:version/:language/model_doc/blenderbot.html#transformers.TFBlenderbotModel).
...
`Blenderbot` is nearly identical to [RobertaTokenizer](docs/transformers/:version/:language/model_doc/roberta.html#transformers.RobertaTokenizer) and runs
...
Refer to superclass [RobertaTokenizer](docs/transformers/:version/:language/model_doc/roberta.html#transformers.RobertaTokenizer) for usage examples and documentation concerning
parameters.
...
- **config** ([BlenderbotConfig](docs/transformers/:version/:language/model_doc/blenderbot.html#transformers.BlenderbotConfig)) --
...
The [BlenderbotModel](docs/transformers/:version/:language/model_doc/blenderbot.html#transformers.BlenderbotModel) forward method, overrides the `__call__` special method.
...
- **input_ids** (`torch.LongTensor` of shape `(batch_size, sequence_length)`) --
  ...
  Indices can be obtained using [BlenderbotTokenizer](docs/transformers/:version/:language/model_doc/blenderbot.html#transformers.BlenderbotTokenizer). See
...
various elements depending on the configuration ([BlenderbotConfig](docs/transformers/:version/:language/model_doc/blenderbot.html#transformers.BlenderbotConfig)) and inputs.
...
The [BlenderbotForConditionalGeneration](docs/transformers/:version/:language/model_doc/blenderbot.html#transformers.BlenderbotForConditionalGeneration) forward method, overrides the `__call__` special method.
...
- **config** ([BlenderbotConfig](docs/transformers/:version/:language/model_doc/blenderbot.html#transformers.BlenderbotConfig)) -- Model configuration class with all the parameters of the model.
...
The [TFBlenderbotModel](docs/transformers/:version/:language/model_doc/blenderbot.html#transformers.TFBlenderbotModel) forward method, overrides the `__call__` special method.
...
elements depending on the configuration ([BlenderbotConfig](docs/transformers/:version/:language/model_doc/blenderbot.html#transformers.BlenderbotConfig)) and inputs.
...
The [TFBlenderbotForConditionalGeneration](docs/transformers/:version/:language/model_doc/blenderbot.html#transformers.TFBlenderbotForConditionalGeneration) forward method, overrides the `__call__` special method.
