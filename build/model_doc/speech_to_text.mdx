...
The [Speech2TextFeatureExtractor](/docs/transformers/master/en/model_doc/speech_to_text.html#transformers.Speech2TextFeatureExtractor) class is responsible for extracting the log-mel filter-bank
features. The [Speech2TextProcessor](/docs/transformers/master/en/model_doc/speech_to_text.html#transformers.Speech2TextProcessor) wraps [Speech2TextFeatureExtractor](/docs/transformers/master/en/model_doc/speech_to_text.html#transformers.Speech2TextFeatureExtractor) and
[Speech2TextTokenizer](/docs/transformers/master/en/model_doc/speech_to_text.html#transformers.Speech2TextTokenizer) into a single instance to both extract the input features and decode the
predicted token ids.
...
## [Speech2TextConfig](#speechtextconfig)
...
This is the configuration class to store the configuration of a [Speech2TextModel](/docs/transformers/master/en/model_doc/speech_to_text.html#transformers.Speech2TextModel). It is used
...
## [Speech2TextFeatureExtractor](#speechtextfeatureextractor)
...
This feature extractor inherits from [Speech2TextFeatureExtractor](/docs/transformers/master/en/model_doc/speech_to_text.html#transformers.Speech2TextFeatureExtractor) which contains most of the
...
## [Speech2TextProcessor](#speechtextprocessor)
...
[Speech2TextProcessor](/docs/transformers/master/en/model_doc/speech_to_text.html#transformers.Speech2TextProcessor) offers all the functionalities of
[Speech2TextFeatureExtractor](/docs/transformers/master/en/model_doc/speech_to_text.html#transformers.Speech2TextFeatureExtractor) and [Speech2TextTokenizer](/docs/transformers/master/en/model_doc/speech_to_text.html#transformers.Speech2TextTokenizer). See the
[__call__()](/docs/transformers/master/en/model_doc/speech_to_text.html#transformers.Speech2TextProcessor.__call__) and [decode()](/docs/transformers/master/en/model_doc/speech_to_text.html#transformers.Speech2TextProcessor.decode) for more
information.

> Parameters

- **feature_extractor** (`Speech2TextFeatureExtractor`) --
  An instance of [Speech2TextFeatureExtractor](/docs/transformers/master/en/model_doc/speech_to_text.html#transformers.Speech2TextFeatureExtractor). The feature extractor is a required
  input.
- **tokenizer** (`Speech2TextTokenizer`) --
  An instance of [Speech2TextTokenizer](/docs/transformers/master/en/model_doc/speech_to_text.html#transformers.Speech2TextTokenizer). The tokenizer is a required input.
...
[__call__()](/docs/transformers/master/en/model_doc/speech_to_text.html#transformers.Speech2TextFeatureExtractor.__call__) and returns its output. If used in the context
[as_target_processor()](/docs/transformers/master/en/model_doc/speech_to_text.html#transformers.Speech2TextProcessor.as_target_processor) this method forwards all its arguments to
Speech2TextTokenizer's [__call__()](/docs/transformers/master/en/internal/tokenization_utils.html#transformers.PreTrainedTokenizerBase.__call__). Please refer to the doctsring of
...
Instantiate a [Speech2TextProcessor](/docs/transformers/master/en/model_doc/speech_to_text.html#transformers.Speech2TextProcessor) from a pretrained Speech2Text processor.
...
[from_pretrained()](/docs/transformers/master/en/model_doc/speech_to_text.html#transformers.Speech2TextProcessor.from_pretrained) class method.
...
## [Speech2TextModel](#speechtextmodel)
...
- **config** ([Speech2TextConfig](/docs/transformers/master/en/model_doc/speech_to_text.html#transformers.Speech2TextConfig)) --
...
The [Speech2TextModel](/docs/transformers/master/en/model_doc/speech_to_text.html#transformers.Speech2TextModel) forward method, overrides the `__call__` special method.
...
- **input_features** (`torch.LongTensor` of shape `(batch_size, sequence_length, feature_size)`) --
  ...
  into `input_features`, the [Speech2TextTokenizer](/docs/transformers/master/en/model_doc/speech_to_text.html#transformers.Speech2TextTokenizer) should be used for extracting
...
various elements depending on the configuration ([Speech2TextConfig](/docs/transformers/master/en/model_doc/speech_to_text.html#transformers.Speech2TextConfig)) and inputs.
...
## [Speech2TextForConditionalGeneration](#speechtextforconditionalgeneration)
...
The [Speech2TextForConditionalGeneration](/docs/transformers/master/en/model_doc/speech_to_text.html#transformers.Speech2TextForConditionalGeneration) forward method, overrides the `__call__` special method.
