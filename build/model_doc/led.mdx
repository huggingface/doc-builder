...
- [LEDForConditionalGeneration](docs/transformers/:version/:language/model_doc/led.html#transformers.LEDForConditionalGeneration) is an extension of
  [BartForConditionalGeneration](docs/transformers/:version/:language/model_doc/bart.html#transformers.BartForConditionalGeneration) exchanging the traditional *self-attention* layer with
  *Longformer*'s *chunked self-attention* layer. [LEDTokenizer](docs/transformers/:version/:language/model_doc/led.html#transformers.LEDTokenizer) is an alias of
  [BartTokenizer](docs/transformers/:version/:language/model_doc/bart.html#transformers.BartTokenizer).
- LED works very well on long-range *sequence-to-sequence* tasks where the `input_ids` largely exceed a length of
  1024 tokens.
- LED pads the `input_ids` to be a multiple of `config.attention_window` if required. Therefore a small speed-up is
  gained, when [LEDTokenizer](docs/transformers/:version/:language/model_doc/led.html#transformers.LEDTokenizer) is used with the `pad_to_multiple_of` argument.
- LED makes use of *global attention* by means of the `global_attention_mask` (see
  [LongformerModel](docs/transformers/:version/:language/model_doc/longformer.html#transformers.LongformerModel)). For summarization, it is advised to put *global attention* only on the first
...
This is the configuration class to store the configuration of a [LEDModel](docs/transformers/:version/:language/model_doc/led.html#transformers.LEDModel). It is used to
...
- **vocab_size** (`int`, _optional_, defaults to 50265) --
  ...
  `inputs_ids` passed when calling [LEDModel](docs/transformers/:version/:language/model_doc/led.html#transformers.LEDModel) or [TFLEDModel](docs/transformers/:version/:language/model_doc/led.html#transformers.TFLEDModel).
...
<a id='transformers.LEDTokenizer'></a>
> **class transformers.LEDTokenizer**(vocab_file, merges_file, errors = replace, bos_token = <s>, eos_token = </s>, sep_token = </s>, cls_token = <s>, unk_token = <unk>, pad_token = <pad>, mask_token = <mask>, add_prefix_space = False, **kwargs)


Construct a LED tokenizer.

[LEDTokenizer](docs/transformers/:version/:language/model_doc/led.html#transformers.LEDTokenizer) is identical to [BartTokenizer](docs/transformers/:version/:language/model_doc/bart.html#transformers.BartTokenizer) and runs end-to-end
tokenization: punctuation splitting and wordpiece.

Refer to superclass [BartTokenizer](docs/transformers/:version/:language/model_doc/bart.html#transformers.BartTokenizer) for usage examples and documentation concerning
parameters.
...
<a id='transformers.LEDTokenizerFast'></a>
> **class transformers.LEDTokenizerFast**(vocab_file = None, merges_file = None, tokenizer_file = None, errors = replace, bos_token = <s>, eos_token = </s>, sep_token = </s>, cls_token = <s>, unk_token = <unk>, pad_token = <pad>, mask_token = <mask>, add_prefix_space = False, **kwargs)


Construct a "fast" LED tokenizer (backed by HuggingFace's _tokenizers_ library).

[LEDTokenizerFast](docs/transformers/:version/:language/model_doc/led.html#transformers.LEDTokenizerFast) is identical to [BartTokenizerFast](docs/transformers/:version/:language/model_doc/bart.html#transformers.BartTokenizerFast) and runs
end-to-end tokenization: punctuation splitting and wordpiece.

Refer to superclass [BartTokenizerFast](docs/transformers/:version/:language/model_doc/bart.html#transformers.BartTokenizerFast) for usage examples and documentation concerning
parameters.


<a id='transformers.LEDTokenizer'></a>
> **class LEDTokenizer**(vocab_file, merges_file, errors = replace, bos_token = <s>, eos_token = </s>, sep_token = </s>, cls_token = <s>, unk_token = <unk>, pad_token = <pad>, mask_token = <mask>, add_prefix_space = False, **kwargs)
...
<a id='transformers.models.led.modeling_led.LEDEncoderBaseModelOutput'></a>
> **class transformers.models.led.modeling\_led.LEDEncoderBaseModelOutput**(last_hidden_state: FloatTensor, hidden_states: typing.Optional[typing.Tuple[torch.FloatTensor]] = None, attentions: typing.Optional[typing.Tuple[torch.FloatTensor]] = None, global_attentions: typing.Optional[typing.Tuple[torch.FloatTensor]] = None)
...
<a id='transformers.models.led.modeling_led.LEDSeq2SeqModelOutput'></a>
> **class transformers.models.led.modeling\_led.LEDSeq2SeqModelOutput**(last_hidden_state: FloatTensor = None, past_key_values: typing.Optional[typing.List[torch.FloatTensor]] = None, decoder_hidden_states: typing.Optional[typing.Tuple[torch.FloatTensor]] = None, decoder_attentions: typing.Optional[typing.Tuple[torch.FloatTensor]] = None, cross_attentions: typing.Optional[typing.Tuple[torch.FloatTensor]] = None, encoder_last_hidden_state: typing.Optional[torch.FloatTensor] = None, encoder_hidden_states: typing.Optional[typing.Tuple[torch.FloatTensor]] = None, encoder_attentions: typing.Optional[typing.Tuple[torch.FloatTensor]] = None, encoder_global_attentions: typing.Optional[typing.Tuple[torch.FloatTensor]] = None)
...
<a id='transformers.models.led.modeling_led.LEDSeq2SeqLMOutput'></a>
> **class transformers.models.led.modeling\_led.LEDSeq2SeqLMOutput**(loss: typing.Optional[torch.FloatTensor] = None, logits: FloatTensor = None, past_key_values: typing.Optional[typing.List[torch.FloatTensor]] = None, decoder_hidden_states: typing.Optional[typing.Tuple[torch.FloatTensor]] = None, decoder_attentions: typing.Optional[typing.Tuple[torch.FloatTensor]] = None, cross_attentions: typing.Optional[typing.Tuple[torch.FloatTensor]] = None, encoder_last_hidden_state: typing.Optional[torch.FloatTensor] = None, encoder_hidden_states: typing.Optional[typing.Tuple[torch.FloatTensor]] = None, encoder_attentions: typing.Optional[typing.Tuple[torch.FloatTensor]] = None, encoder_global_attentions: typing.Optional[typing.Tuple[torch.FloatTensor]] = None)
...
<a id='transformers.models.led.modeling_led.LEDSeq2SeqSequenceClassifierOutput'></a>
> **class transformers.models.led.modeling\_led.LEDSeq2SeqSequenceClassifierOutput**(loss: typing.Optional[torch.FloatTensor] = None, logits: FloatTensor = None, past_key_values: typing.Optional[typing.List[torch.FloatTensor]] = None, decoder_hidden_states: typing.Optional[typing.Tuple[torch.FloatTensor]] = None, decoder_attentions: typing.Optional[typing.Tuple[torch.FloatTensor]] = None, cross_attentions: typing.Optional[typing.Tuple[torch.FloatTensor]] = None, encoder_last_hidden_state: typing.Optional[torch.FloatTensor] = None, encoder_hidden_states: typing.Optional[typing.Tuple[torch.FloatTensor]] = None, encoder_attentions: typing.Optional[typing.Tuple[torch.FloatTensor]] = None, encoder_global_attentions: typing.Optional[typing.Tuple[torch.FloatTensor]] = None)
...
<a id='transformers.models.led.modeling_led.LEDSeq2SeqQuestionAnsweringModelOutput'></a>
...
<a id='transformers.models.led.modeling_tf_led.TFLEDEncoderBaseModelOutput'></a>
> **class transformers.models.led.modeling\_tf\_led.TFLEDEncoderBaseModelOutput**(last_hidden_state: Tensor = None, hidden_states: typing.Optional[typing.Tuple[tensorflow.python.framework.ops.Tensor]] = None, attentions: typing.Optional[typing.Tuple[tensorflow.python.framework.ops.Tensor]] = None, global_attentions: typing.Optional[typing.Tuple[tensorflow.python.framework.ops.Tensor]] = None)
...
<a id='transformers.models.led.modeling_tf_led.TFLEDSeq2SeqModelOutput'></a>
> **class transformers.models.led.modeling\_tf\_led.TFLEDSeq2SeqModelOutput**(last_hidden_state: Tensor = None, past_key_values: typing.Optional[typing.List[tensorflow.python.framework.ops.Tensor]] = None, decoder_hidden_states: typing.Optional[typing.Tuple[tensorflow.python.framework.ops.Tensor]] = None, decoder_attentions: typing.Optional[typing.Tuple[tensorflow.python.framework.ops.Tensor]] = None, cross_attentions: typing.Optional[typing.Tuple[tensorflow.python.framework.ops.Tensor]] = None, encoder_last_hidden_state: typing.Optional[tensorflow.python.framework.ops.Tensor] = None, encoder_hidden_states: typing.Optional[typing.Tuple[tensorflow.python.framework.ops.Tensor]] = None, encoder_attentions: typing.Optional[typing.Tuple[tensorflow.python.framework.ops.Tensor]] = None, encoder_global_attentions: typing.Optional[typing.Tuple[tensorflow.python.framework.ops.Tensor]] = None)
...
<a id='transformers.models.led.modeling_tf_led.TFLEDSeq2SeqLMOutput'></a>
...
<a id='transformers.LEDModel'></a>
> **class transformers.LEDModel**(config: LEDConfig)
...
- **config** ([LEDConfig](docs/transformers/:version/:language/model_doc/led.html#transformers.LEDConfig)) --
...
<a id='transformers.LEDModel.forward'></a>
...
The [LEDModel](docs/transformers/:version/:language/model_doc/led.html#transformers.LEDModel) forward method, overrides the `__call__` special method.
...
- **input_ids** (`torch.LongTensor` of shape `(batch_size, sequence_length)`) --
  ...
  Indices can be obtained using [LEDTokenizer](docs/transformers/:version/:language/model_doc/led.html#transformers.LEDTokenizer). See
...
various elements depending on the configuration ([LEDConfig](docs/transformers/:version/:language/model_doc/led.html#transformers.LEDConfig)) and inputs.
...
<a id='transformers.LEDForConditionalGeneration'></a>
> **class transformers.LEDForConditionalGeneration**(config: LEDConfig)
...
<a id='transformers.LEDForConditionalGeneration.forward'></a>
> **forward**(self, input_ids = None, attention_mask = None, decoder_input_ids = None, decoder_attention_mask = None, head_mask = None, decoder_head_mask = None, cross_attn_head_mask = None, encoder_outputs = None, global_attention_mask = None, past_key_values = None, inputs_embeds = None, decoder_inputs_embeds = None, labels = None, use_cache = None, output_attentions = None, output_hidden_states = None, return_dict = None)

The [LEDForConditionalGeneration](docs/transformers/:version/:language/model_doc/led.html#transformers.LEDForConditionalGeneration) forward method, overrides the `__call__` special method.
...
<a id='transformers.LEDForSequenceClassification'></a>
> **class transformers.LEDForSequenceClassification**(config: LEDConfig, **kwargs)
...
<a id='transformers.LEDForSequenceClassification.forward'></a>
> **forward**(self, input_ids = None, attention_mask = None, decoder_input_ids = None, decoder_attention_mask = None, head_mask = None, decoder_head_mask = None, cross_attn_head_mask = None, encoder_outputs = None, global_attention_mask = None, inputs_embeds = None, decoder_inputs_embeds = None, labels = None, use_cache = None, output_attentions = None, output_hidden_states = None, return_dict = None)

The [LEDForSequenceClassification](docs/transformers/:version/:language/model_doc/led.html#transformers.LEDForSequenceClassification) forward method, overrides the `__call__` special method.
...
A [Seq2SeqSequenceClassifierOutput](docs/transformers/:version/:language/main_classes/output.html#transformers.modeling_outputs.Seq2SeqSequenceClassifierOutput) or a tuple of
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising
various elements depending on the configuration ([LEDConfig](docs/transformers/:version/:language/model_doc/led.html#transformers.LEDConfig)) and inputs.
...
[Seq2SeqSequenceClassifierOutput](docs/transformers/:version/:language/main_classes/output.html#transformers.modeling_outputs.Seq2SeqSequenceClassifierOutput) or `tuple(torch.FloatTensor)`
...
<a id='transformers.LEDForQuestionAnswering'></a>
> **class transformers.LEDForQuestionAnswering**(config)
...
<a id='transformers.LEDForQuestionAnswering.forward'></a>
> **forward**(self, input_ids = None, attention_mask = None, decoder_input_ids = None, decoder_attention_mask = None, head_mask = None, decoder_head_mask = None, cross_attn_head_mask = None, encoder_outputs = None, global_attention_mask = None, start_positions = None, end_positions = None, inputs_embeds = None, decoder_inputs_embeds = None, use_cache = None, output_attentions = None, output_hidden_states = None, return_dict = None)

The [LEDForQuestionAnswering](docs/transformers/:version/:language/model_doc/led.html#transformers.LEDForQuestionAnswering) forward method, overrides the `__call__` special method.
...
A [Seq2SeqQuestionAnsweringModelOutput](docs/transformers/:version/:language/main_classes/output.html#transformers.modeling_outputs.Seq2SeqQuestionAnsweringModelOutput) or a tuple of
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising
various elements depending on the configuration ([LEDConfig](docs/transformers/:version/:language/model_doc/led.html#transformers.LEDConfig)) and inputs.
...
[Seq2SeqQuestionAnsweringModelOutput](docs/transformers/:version/:language/main_classes/output.html#transformers.modeling_outputs.Seq2SeqQuestionAnsweringModelOutput) or `tuple(torch.FloatTensor)`
...
<a id='transformers.TFLEDModel'></a>
> **class transformers.TFLEDModel**(*args, **kwargs)
...
- **config** ([LEDConfig](docs/transformers/:version/:language/model_doc/led.html#transformers.LEDConfig)) -- Model configuration class with all the parameters of the model.
...
A [TFLEDSeq2SeqModelOutput](docs/transformers/:version/:language/model_doc/led.html#transformers.models.led.modeling_tf_led.TFLEDSeq2SeqModelOutput) or a tuple of
`tf.Tensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([LEDConfig](docs/transformers/:version/:language/model_doc/led.html#transformers.LEDConfig)) and inputs.
...
[TFLEDSeq2SeqModelOutput](docs/transformers/:version/:language/model_doc/led.html#transformers.models.led.modeling_tf_led.TFLEDSeq2SeqModelOutput) or `tuple(tf.Tensor)`
...
<a id='transformers.TFLEDForConditionalGeneration'></a>
> **class transformers.TFLEDForConditionalGeneration**(*args, **kwargs)
...
<a id='transformers.TFLEDForConditionalGeneration.call'></a>
> **call**(self, input_ids = None, attention_mask = None, decoder_input_ids = None, decoder_attention_mask = None, head_mask = None, decoder_head_mask = None, encoder_outputs: typing.Optional[transformers.models.led.modeling_tf_led.TFLEDEncoderBaseModelOutput] = None, global_attention_mask = None, past_key_values = None, inputs_embeds = None, decoder_inputs_embeds = None, use_cache = None, output_attentions = None, output_hidden_states = None, return_dict = None, labels = None, training = False, **kwargs)

The [TFLEDForConditionalGeneration](docs/transformers/:version/:language/model_doc/led.html#transformers.TFLEDForConditionalGeneration) forward method, overrides the `__call__` special method.
...
A [TFLEDSeq2SeqLMOutput](docs/transformers/:version/:language/model_doc/led.html#transformers.models.led.modeling_tf_led.TFLEDSeq2SeqLMOutput) or a tuple of
`tf.Tensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([LEDConfig](docs/transformers/:version/:language/model_doc/led.html#transformers.LEDConfig)) and inputs.
...
[TFLEDSeq2SeqLMOutput](docs/transformers/:version/:language/model_doc/led.html#transformers.models.led.modeling_tf_led.TFLEDSeq2SeqLMOutput) or `tuple(tf.Tensor)`
