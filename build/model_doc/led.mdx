...
- [LEDForConditionalGeneration](model_doc/led.html#transformers.LEDForConditionalGeneration) is an extension of
  [BartForConditionalGeneration](model_doc/bart.html#transformers.BartForConditionalGeneration) exchanging the traditional *self-attention* layer with
  *Longformer*'s *chunked self-attention* layer. [LEDTokenizer](model_doc/led.html#transformers.LEDTokenizer) is an alias of
  [BartTokenizer](model_doc/bart.html#transformers.BartTokenizer).
- LED works very well on long-range *sequence-to-sequence* tasks where the `input_ids` largely exceed a length of
  1024 tokens.
- LED pads the `input_ids` to be a multiple of `config.attention_window` if required. Therefore a small speed-up is
  gained, when [LEDTokenizer](model_doc/led.html#transformers.LEDTokenizer) is used with the `pad_to_multiple_of` argument.
- LED makes use of *global attention* by means of the `global_attention_mask` (see
  [LongformerModel](model_doc/longformer.html#transformers.LongformerModel)). For summarization, it is advised to put *global attention* only on the first
  `&lcubs>` token. For question answering, it is advised to put *global attention* on all tokens of the question.
...
- **vocab_size** (`int`, _optional_, defaults to 50265) --
  ...
  `inputs_ids` passed when calling [LEDModel](model_doc/led.html#transformers.LEDModel) or [TFLEDModel](model_doc/led.html#transformers.TFLEDModel).
...
> **class transformers.LEDTokenizer**(vocab_file, merges_file, errors = replace, bos_token = &lcubs>, eos_token = &lcub/s>, sep_token = &lcub/s>, cls_token = &lcubs>, unk_token = &lcubunk>, pad_token = &lcubpad>, mask_token = &lcubmask>, add_prefix_space = False, **kwargs)


Construct a LED tokenizer.

[LEDTokenizer](model_doc/led.html#transformers.LEDTokenizer) is identical to [BartTokenizer](model_doc/bart.html#transformers.BartTokenizer) and runs end-to-end
tokenization: punctuation splitting and wordpiece.

Refer to superclass [BartTokenizer](model_doc/bart.html#transformers.BartTokenizer) for usage examples and documentation concerning
parameters.
...
> **class transformers.LEDTokenizerFast**(vocab_file = None, merges_file = None, tokenizer_file = None, errors = replace, bos_token = &lcubs>, eos_token = &lcub/s>, sep_token = &lcub/s>, cls_token = &lcubs>, unk_token = &lcubunk>, pad_token = &lcubpad>, mask_token = &lcubmask>, add_prefix_space = False, **kwargs)


Construct a "fast" LED tokenizer (backed by HuggingFace's _tokenizers_ library).

[LEDTokenizerFast](model_doc/led.html#transformers.LEDTokenizerFast) is identical to [BartTokenizerFast](model_doc/bart.html#transformers.BartTokenizerFast) and runs
end-to-end tokenization: punctuation splitting and wordpiece.

Refer to superclass [BartTokenizerFast](model_doc/bart.html#transformers.BartTokenizerFast) for usage examples and documentation concerning
parameters.


<a id='transformers.LEDTokenizer'></a>
> **class LEDTokenizer**(vocab_file, merges_file, errors = replace, bos_token = &lcubs>, eos_token = &lcub/s>, sep_token = &lcub/s>, cls_token = &lcubs>, unk_token = &lcubunk>, pad_token = &lcubpad>, mask_token = &lcubmask>, add_prefix_space = False, **kwargs)
...
- **config** ([LEDConfig](model_doc/led.html#transformers.LEDConfig)) --
...
The [LEDModel](model_doc/led.html#transformers.LEDModel) forward method, overrides the `__call__` special method.
...
- **input_ids** (`torch.LongTensor` of shape `(batch_size, sequence_length)`) --
  ...
  Indices can be obtained using [LEDTokenizer](model_doc/led.html#transformers.LEDTokenizer). See
...
- **global_attention_mask** (`torch.FloatTensor` of shape `(batch_size, sequence_length)`, _optional_) --
  ...
  For example, for classification, the &lcubs> token should be given global attention. For QA, all question
...
various elements depending on the configuration ([LEDConfig](model_doc/led.html#transformers.LEDConfig)) and inputs.
...
The [LEDForConditionalGeneration](model_doc/led.html#transformers.LEDForConditionalGeneration) forward method, overrides the `__call__` special method.
...
The [LEDForSequenceClassification](model_doc/led.html#transformers.LEDForSequenceClassification) forward method, overrides the `__call__` special method.
...
The [LEDForQuestionAnswering](model_doc/led.html#transformers.LEDForQuestionAnswering) forward method, overrides the `__call__` special method.
...
- **config** ([LEDConfig](model_doc/led.html#transformers.LEDConfig)) -- Model configuration class with all the parameters of the model.
...
The [TFLEDModel](model_doc/led.html#transformers.TFLEDModel) forward method, overrides the `__call__` special method.
...
A [TFLEDSeq2SeqModelOutput](model_doc/led.html#transformers.models.led.modeling_tf_led.TFLEDSeq2SeqModelOutput) or a tuple of
`tf.Tensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([LEDConfig](model_doc/led.html#transformers.LEDConfig)) and inputs.
...
[TFLEDSeq2SeqModelOutput](model_doc/led.html#transformers.models.led.modeling_tf_led.TFLEDSeq2SeqModelOutput) or `tuple(tf.Tensor)`
...
The [TFLEDForConditionalGeneration](model_doc/led.html#transformers.TFLEDForConditionalGeneration) forward method, overrides the `__call__` special method.
...
A [TFLEDSeq2SeqLMOutput](model_doc/led.html#transformers.models.led.modeling_tf_led.TFLEDSeq2SeqLMOutput) or a tuple of
`tf.Tensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([LEDConfig](model_doc/led.html#transformers.LEDConfig)) and inputs.
...
[TFLEDSeq2SeqLMOutput](model_doc/led.html#transformers.models.led.modeling_tf_led.TFLEDSeq2SeqLMOutput) or `tuple(tf.Tensor)`
