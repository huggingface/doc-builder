...
- local: ledtokenizer
  title: LEDTokenizer
- local: ledtokenizerfast
  title: LEDTokenizerFast
- local: led-specific-outputs
  title: LED specific outputs
- local: ledmodel
  title: LEDModel
- local: ledforconditionalgeneration
  title: LEDForConditionalGeneration
- local: ledforsequenceclassification
  title: LEDForSequenceClassification
- local: ledforquestionanswering
  title: LEDForQuestionAnswering
- local: tfledmodel
  title: TFLEDModel
- local: tfledforconditionalgeneration
...
- [LEDForConditionalGeneration](/docs/transformers/master/en/model_doc/led.html#transformers.LEDForConditionalGeneration) is an extension of
  [BartForConditionalGeneration](/docs/transformers/master/en/model_doc/bart.html#transformers.BartForConditionalGeneration) exchanging the traditional *self-attention* layer with
  *Longformer*'s *chunked self-attention* layer. [LEDTokenizer](/docs/transformers/master/en/model_doc/led.html#transformers.LEDTokenizer) is an alias of
  [BartTokenizer](/docs/transformers/master/en/model_doc/bart.html#transformers.BartTokenizer).
- LED works very well on long-range *sequence-to-sequence* tasks where the `input_ids` largely exceed a length of
  1024 tokens.
- LED pads the `input_ids` to be a multiple of `config.attention_window` if required. Therefore a small speed-up is
  gained, when [LEDTokenizer](/docs/transformers/master/en/model_doc/led.html#transformers.LEDTokenizer) is used with the `pad_to_multiple_of` argument.
- LED makes use of *global attention* by means of the `global_attention_mask` (see
  [LongformerModel](/docs/transformers/master/en/model_doc/longformer.html#transformers.LongformerModel)). For summarization, it is advised to put *global attention* only on the first
...
This is the configuration class to store the configuration of a [LEDModel](/docs/transformers/master/en/model_doc/led.html#transformers.LEDModel). It is used to
...
- **vocab_size** (`int`, _optional_, defaults to 50265) --
  ...
  `inputs_ids` passed when calling [LEDModel](/docs/transformers/master/en/model_doc/led.html#transformers.LEDModel) or [TFLEDModel](/docs/transformers/master/en/model_doc/led.html#transformers.TFLEDModel).
...
[LEDTokenizer](/docs/transformers/master/en/model_doc/led.html#transformers.LEDTokenizer) is identical to [BartTokenizer](/docs/transformers/master/en/model_doc/bart.html#transformers.BartTokenizer) and runs end-to-end
tokenization: punctuation splitting and wordpiece.

Refer to superclass [BartTokenizer](/docs/transformers/master/en/model_doc/bart.html#transformers.BartTokenizer) for usage examples and documentation concerning
parameters.
...
## [LEDTokenizerFast](#ledtokenizerfast)
...
[LEDTokenizerFast](/docs/transformers/master/en/model_doc/led.html#transformers.LEDTokenizerFast) is identical to [BartTokenizerFast](/docs/transformers/master/en/model_doc/bart.html#transformers.BartTokenizerFast) and runs
end-to-end tokenization: punctuation splitting and wordpiece.

Refer to superclass [BartTokenizerFast](/docs/transformers/master/en/model_doc/bart.html#transformers.BartTokenizerFast) for usage examples and documentation concerning
parameters.
...
- **config** ([LEDConfig](/docs/transformers/master/en/model_doc/led.html#transformers.LEDConfig)) --
...
The [LEDModel](/docs/transformers/master/en/model_doc/led.html#transformers.LEDModel) forward method, overrides the `__call__` special method.
...
- **input_ids** (`torch.LongTensor` of shape `(batch_size, sequence_length)`) --
  ...
  Indices can be obtained using [LEDTokenizer](/docs/transformers/master/en/model_doc/led.html#transformers.LEDTokenizer). See
...
various elements depending on the configuration ([LEDConfig](/docs/transformers/master/en/model_doc/led.html#transformers.LEDConfig)) and inputs.
...
The [LEDForConditionalGeneration](/docs/transformers/master/en/model_doc/led.html#transformers.LEDForConditionalGeneration) forward method, overrides the `__call__` special method.
...
The [LEDForSequenceClassification](/docs/transformers/master/en/model_doc/led.html#transformers.LEDForSequenceClassification) forward method, overrides the `__call__` special method.
...
The [LEDForQuestionAnswering](/docs/transformers/master/en/model_doc/led.html#transformers.LEDForQuestionAnswering) forward method, overrides the `__call__` special method.
...
- **config** ([LEDConfig](/docs/transformers/master/en/model_doc/led.html#transformers.LEDConfig)) -- Model configuration class with all the parameters of the model.
...
The [TFLEDModel](/docs/transformers/master/en/model_doc/led.html#transformers.TFLEDModel) forward method, overrides the `__call__` special method.
...
A [TFLEDSeq2SeqModelOutput](/docs/transformers/master/en/model_doc/led.html#transformers.models.led.modeling_tf_led.TFLEDSeq2SeqModelOutput) or a tuple of
`tf.Tensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([LEDConfig](/docs/transformers/master/en/model_doc/led.html#transformers.LEDConfig)) and inputs.
...
[TFLEDSeq2SeqModelOutput](/docs/transformers/master/en/model_doc/led.html#transformers.models.led.modeling_tf_led.TFLEDSeq2SeqModelOutput) or `tuple(tf.Tensor)`
...
## [TFLEDForConditionalGeneration](#tfledforconditionalgeneration)
...
The [TFLEDForConditionalGeneration](/docs/transformers/master/en/model_doc/led.html#transformers.TFLEDForConditionalGeneration) forward method, overrides the `__call__` special method.
...
A [TFLEDSeq2SeqLMOutput](/docs/transformers/master/en/model_doc/led.html#transformers.models.led.modeling_tf_led.TFLEDSeq2SeqLMOutput) or a tuple of
`tf.Tensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([LEDConfig](/docs/transformers/master/en/model_doc/led.html#transformers.LEDConfig)) and inputs.
...
[TFLEDSeq2SeqLMOutput](/docs/transformers/master/en/model_doc/led.html#transformers.models.led.modeling_tf_led.TFLEDSeq2SeqLMOutput) or `tuple(tf.Tensor)`
