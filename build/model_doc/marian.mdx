...
- The modeling code is the same as [BartForConditionalGeneration](docs/transformers/:version/:language/model_doc/bart.html#transformers.BartForConditionalGeneration) with a few minor modifications:
...
This is the configuration class to store the configuration of a [MarianModel](docs/transformers/:version/:language/model_doc/marian.html#transformers.MarianModel). It is used to
...
- **vocab_size** (`int`, _optional_, defaults to 50265) --
  ...
  `inputs_ids` passed when calling [MarianModel](docs/transformers/:version/:language/model_doc/marian.html#transformers.MarianModel) or
  [TFMarianModel](docs/transformers/:version/:language/model_doc/marian.html#transformers.TFMarianModel).
...
- **config** ([MarianConfig](docs/transformers/:version/:language/model_doc/marian.html#transformers.MarianConfig)) --
...
The [MarianModel](docs/transformers/:version/:language/model_doc/marian.html#transformers.MarianModel) forward method, overrides the `__call__` special method.
...
- **input_ids** (`torch.LongTensor` of shape `(batch_size, sequence_length)`) --
  ...
  Indices can be obtained using [MarianTokenizer](docs/transformers/:version/:language/model_doc/marian.html#transformers.MarianTokenizer). See
...
various elements depending on the configuration ([MarianConfig](docs/transformers/:version/:language/model_doc/marian.html#transformers.MarianConfig)) and inputs.
...
The [MarianMTModel](docs/transformers/:version/:language/model_doc/marian.html#transformers.MarianMTModel) forward method, overrides the `__call__` special method.
...
- **config** ([MarianConfig](docs/transformers/:version/:language/model_doc/marian.html#transformers.MarianConfig)) -- Model configuration class with all the parameters of the model.
...
The [TFMarianModel](docs/transformers/:version/:language/model_doc/marian.html#transformers.TFMarianModel) forward method, overrides the `__call__` special method.
...
elements depending on the configuration ([MarianConfig](docs/transformers/:version/:language/model_doc/marian.html#transformers.MarianConfig)) and inputs.
...
The [TFMarianMTModel](docs/transformers/:version/:language/model_doc/marian.html#transformers.TFMarianMTModel) forward method, overrides the `__call__` special method.
