...
The regular [__call__()](docs/transformers/:version/:language/internal/tokenization_utils.html#transformers.PreTrainedTokenizerBase.__call__) will encode source text format, and it should be wrapped
inside the context manager [as_target_tokenizer()](docs/transformers/:version/:language/model_doc/mbart.html#transformers.MBartTokenizer.as_target_tokenizer) to encode target text format.
...
MBart-50 has its own tokenizer [MBart50Tokenizer](docs/transformers/:version/:language/model_doc/mbart.html#transformers.MBart50Tokenizer).
...
This is the configuration class to store the configuration of a [MBartModel](docs/transformers/:version/:language/model_doc/mbart.html#transformers.MBartModel). It is used to
...
- **vocab_size** (`int`, _optional_, defaults to 50265) --
  ...
  `inputs_ids` passed when calling [MBartModel](docs/transformers/:version/:language/model_doc/mbart.html#transformers.MBartModel) or
  [TFMBartModel](docs/transformers/:version/:language/model_doc/mbart.html#transformers.TFMBartModel).
...
[MBartTokenizer](docs/transformers/:version/:language/model_doc/mbart.html#transformers.MBartTokenizer) is a subclass of [XLMRobertaTokenizer](docs/transformers/:version/:language/model_doc/xlmroberta.html#transformers.XLMRobertaTokenizer). Refer to
superclass [XLMRobertaTokenizer](docs/transformers/:version/:language/model_doc/xlmroberta.html#transformers.XLMRobertaTokenizer) for usage examples and documentation concerning the
...
[MBartTokenizerFast](docs/transformers/:version/:language/model_doc/mbart.html#transformers.MBartTokenizerFast) is a subclass of [XLMRobertaTokenizerFast](docs/transformers/:version/:language/model_doc/xlmroberta.html#transformers.XLMRobertaTokenizerFast). Refer to
superclass [XLMRobertaTokenizerFast](docs/transformers/:version/:language/model_doc/xlmroberta.html#transformers.XLMRobertaTokenizerFast) for usage examples and documentation concerning the
initialization parameters and other methods.
...
- **config** ([MBartConfig](docs/transformers/:version/:language/model_doc/mbart.html#transformers.MBartConfig)) --
...
The [MBartModel](docs/transformers/:version/:language/model_doc/mbart.html#transformers.MBartModel) forward method, overrides the `__call__` special method.
...
- **input_ids** (`torch.LongTensor` of shape `(batch_size, sequence_length)`) --
  ...
  Indices can be obtained using [MBartTokenizer](docs/transformers/:version/:language/model_doc/mbart.html#transformers.MBartTokenizer). See
...
various elements depending on the configuration ([MBartConfig](docs/transformers/:version/:language/model_doc/mbart.html#transformers.MBartConfig)) and inputs.
...
The [MBartForConditionalGeneration](docs/transformers/:version/:language/model_doc/mbart.html#transformers.MBartForConditionalGeneration) forward method, overrides the `__call__` special method.
...
The [MBartForQuestionAnswering](docs/transformers/:version/:language/model_doc/mbart.html#transformers.MBartForQuestionAnswering) forward method, overrides the `__call__` special method.
...
The [MBartForSequenceClassification](docs/transformers/:version/:language/model_doc/mbart.html#transformers.MBartForSequenceClassification) forward method, overrides the `__call__` special method.
...
- **config** ([MBartConfig](docs/transformers/:version/:language/model_doc/mbart.html#transformers.MBartConfig)) -- Model configuration class with all the parameters of the model.
...
The [TFMBartModel](docs/transformers/:version/:language/model_doc/mbart.html#transformers.TFMBartModel) forward method, overrides the `__call__` special method.
...
elements depending on the configuration ([MBartConfig](docs/transformers/:version/:language/model_doc/mbart.html#transformers.MBartConfig)) and inputs.
...
The [TFMBartForConditionalGeneration](docs/transformers/:version/:language/model_doc/mbart.html#transformers.TFMBartForConditionalGeneration) forward method, overrides the `__call__` special method.
