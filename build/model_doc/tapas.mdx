...
...         encoding = &lcubkey: val.squeeze(0) for key, val in encoding.items()}
...
>>> id2aggregation = &lcub0: "NONE", 1: "SUM", 2: "AVERAGE", 3:"COUNT"}
...
- **aggregation_labels** (`Dict[int, label]`, _optional_) --
  ...
  aggregation labels: `&lcub0: "NONE", 1: "SUM", 2: "AVERAGE", 3: "COUNT"}`
