...
- local: gptneomodel
  title: GPTNeoModel
- local: gptneoforcausallm
  title: GPTNeoForCausalLM
- local: gptneoforsequenceclassification
  title: GPTNeoForSequenceClassification
- local: flaxgptneomodel
  title: FlaxGPTNeoModel
- local: flaxgptneoforcausallm
...
This is the configuration class to store the configuration of a [GPTNeoModel](/docs/transformers/master/en/model_doc/gpt_neo.html#transformers.GPTNeoModel). It is used to
...
- **vocab_size** (`int`, _optional_, defaults to 50257) --
  ...
  `inputs_ids` passed when calling [GPTNeoModel](/docs/transformers/master/en/model_doc/gpt_neo.html#transformers.GPTNeoModel). Vocabulary size of the model.
  Defines the different tokens that can be represented by the _inputs_ids_ passed to the forward method of
  [GPTNeoModel](/docs/transformers/master/en/model_doc/gpt_neo.html#transformers.GPTNeoModel).
...
- **type_vocab_size** (`int`, _optional_, defaults to 2) --
  The vocabulary size of the `token_type_ids` passed when calling [GPTNeoModel](/docs/transformers/master/en/model_doc/gpt_neo.html#transformers.GPTNeoModel).
...
- **config** ([GPTNeoConfig](/docs/transformers/master/en/model_doc/gpt_neo.html#transformers.GPTNeoConfig)) -- Model configuration class with all the parameters of the model.
...
The [GPTNeoModel](/docs/transformers/master/en/model_doc/gpt_neo.html#transformers.GPTNeoModel) forward method, overrides the `__call__` special method.
...
various elements depending on the configuration ([GPTNeoConfig](/docs/transformers/master/en/model_doc/gpt_neo.html#transformers.GPTNeoConfig)) and inputs.
...
The [GPTNeoForCausalLM](/docs/transformers/master/en/model_doc/gpt_neo.html#transformers.GPTNeoForCausalLM) forward method, overrides the `__call__` special method.
...
[GPTNeoForSequenceClassification](/docs/transformers/master/en/model_doc/gpt_neo.html#transformers.GPTNeoForSequenceClassification) uses the last token in order to do the classification, as
...
The [GPTNeoForSequenceClassification](/docs/transformers/master/en/model_doc/gpt_neo.html#transformers.GPTNeoForSequenceClassification) forward method, overrides the `__call__` special method.
