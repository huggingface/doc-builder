...
<a id='transformers.GPTNeoConfig'></a>
> **class transformers.GPTNeoConfig**(vocab_size = 50257, max_position_embeddings = 2048, hidden_size = 2048, num_layers = 24, attention_types = [[['global', 'local'], 12]], num_heads = 16, intermediate_size = None, window_size = 256, activation_function = gelu_new, resid_dropout = 0.0, embed_dropout = 0.0, attention_dropout = 0.0, layer_norm_epsilon = 1e-05, initializer_range = 0.02, summary_type = cls_index, summary_use_proj = True, summary_activation = None, summary_proj_to_labels = True, summary_first_dropout = 0.1, use_cache = True, bos_token_id = 50256, eos_token_id = 50256, **kwargs)


This is the configuration class to store the configuration of a [GPTNeoModel](docs/transformers/:version/:language/model_doc/gpt_neo.html#transformers.GPTNeoModel). It is used to
...
- **vocab_size** (`int`, _optional_, defaults to 50257) --
  ...
  `inputs_ids` passed when calling [GPTNeoModel](docs/transformers/:version/:language/model_doc/gpt_neo.html#transformers.GPTNeoModel). Vocabulary size of the model.
  Defines the different tokens that can be represented by the _inputs_ids_ passed to the forward method of
  [GPTNeoModel](docs/transformers/:version/:language/model_doc/gpt_neo.html#transformers.GPTNeoModel).
...
- **type_vocab_size** (`int`, _optional_, defaults to 2) --
  The vocabulary size of the `token_type_ids` passed when calling [GPTNeoModel](docs/transformers/:version/:language/model_doc/gpt_neo.html#transformers.GPTNeoModel).
...
<a id='transformers.GPTNeoModel'></a>
> **class transformers.GPTNeoModel**(config)
...
- **config** ([GPTNeoConfig](docs/transformers/:version/:language/model_doc/gpt_neo.html#transformers.GPTNeoConfig)) -- Model configuration class with all the parameters of the model.
...
<a id='transformers.GPTNeoModel.forward'></a>
...
The [GPTNeoModel](docs/transformers/:version/:language/model_doc/gpt_neo.html#transformers.GPTNeoModel) forward method, overrides the `__call__` special method.
...
various elements depending on the configuration ([GPTNeoConfig](docs/transformers/:version/:language/model_doc/gpt_neo.html#transformers.GPTNeoConfig)) and inputs.
...
<a id='transformers.GPTNeoForCausalLM'></a>
> **class transformers.GPTNeoForCausalLM**(config)
...
<a id='transformers.GPTNeoForCausalLM.forward'></a>
...
The [GPTNeoForCausalLM](docs/transformers/:version/:language/model_doc/gpt_neo.html#transformers.GPTNeoForCausalLM) forward method, overrides the `__call__` special method.
...
<a id='transformers.GPTNeoForSequenceClassification'></a>
> **class transformers.GPTNeoForSequenceClassification**(config)


The GPTNeo Model transformer with a sequence classification head on top (linear layer).

[GPTNeoForSequenceClassification](docs/transformers/:version/:language/model_doc/gpt_neo.html#transformers.GPTNeoForSequenceClassification) uses the last token in order to do the classification, as
...
<a id='transformers.GPTNeoForSequenceClassification.forward'></a>
> **forward**(self, input_ids = None, past_key_values = None, attention_mask = None, token_type_ids = None, position_ids = None, head_mask = None, inputs_embeds = None, labels = None, use_cache = None, output_attentions = None, output_hidden_states = None, return_dict = None)

The [GPTNeoForSequenceClassification](docs/transformers/:version/:language/model_doc/gpt_neo.html#transformers.GPTNeoForSequenceClassification) forward method, overrides the `__call__` special method.
...
<a id='transformers.FlaxGPTNeoPreTrainedModel.__call__'></a>
> **\_\_call\_\_**(self, input_ids, attention_mask = None, position_ids = None, params: dict = None, past_key_values: dict = None, dropout_rng: PRNGKey = None, train: bool = False, output_attentions: typing.Optional[bool] = None, output_hidden_states: typing.Optional[bool] = None, return_dict: typing.Optional[bool] = None)
