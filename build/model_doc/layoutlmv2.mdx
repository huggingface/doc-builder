...
[LayoutXLM's documentation page](layoutxlm.html).
...
This is the configuration class to store the configuration of a [LayoutLMv2Model](model_doc/layoutlmv2.html#transformers.LayoutLMv2Model). It is used
...
- **vocab_size** (`int`, _optional_, defaults to 30522) --
  ...
  the `inputs_ids` passed when calling [LayoutLMv2Model](model_doc/layoutlmv2.html#transformers.LayoutLMv2Model) or
  `TFLayoutLMv2Model`.
...
- **type_vocab_size** (`int`, _optional_, defaults to 2) --
  The vocabulary size of the `token_type_ids` passed when calling [LayoutLMv2Model](model_doc/layoutlmv2.html#transformers.LayoutLMv2Model)
...
- **return_tensors** (`str` or [TensorType](internal/file_utils.html#transformers.TensorType), _optional_, defaults to `'np'`) --
...
- **words** -- Optional words as identified by Tesseract OCR (only when
  [LayoutLMv2FeatureExtractor](model_doc/layoutlmv2.html#transformers.LayoutLMv2FeatureExtractor) was initialized with `apply_ocr` set to `True`).
- **boxes** -- Optional bounding boxes as identified by Tesseract OCR, normalized based on the image size
  (only when [LayoutLMv2FeatureExtractor](model_doc/layoutlmv2.html#transformers.LayoutLMv2FeatureExtractor) was initialized with `apply_ocr` set to
  `True`).
...
Construct a LayoutLMv2 tokenizer. Based on WordPiece. [LayoutLMv2Tokenizer](model_doc/layoutlmv2.html#transformers.LayoutLMv2Tokenizer) can be used to
...
[LayoutLMv2Tokenizer](model_doc/layoutlmv2.html#transformers.LayoutLMv2Tokenizer) runs end-to-end tokenization: punctuation splitting and wordpiece. It
...
[LayoutLMv2Processor](model_doc/layoutlmv2.html#transformers.LayoutLMv2Processor) offers all the functionalities you need to prepare data for the model.

It first uses [LayoutLMv2FeatureExtractor](model_doc/layoutlmv2.html#transformers.LayoutLMv2FeatureExtractor) to resize document images to a fixed size, and
optionally applies OCR to get words and normalized bounding boxes. These are then provided to
[LayoutLMv2Tokenizer](model_doc/layoutlmv2.html#transformers.LayoutLMv2Tokenizer) or [LayoutLMv2TokenizerFast](model_doc/layoutlmv2.html#transformers.LayoutLMv2TokenizerFast), which turns the words
...
- **feature_extractor** (`LayoutLMv2FeatureExtractor`) --
  An instance of [LayoutLMv2FeatureExtractor](model_doc/layoutlmv2.html#transformers.LayoutLMv2FeatureExtractor). The feature extractor is a required
  input.
- **tokenizer** (`LayoutLMv2Tokenizer` or `LayoutLMv2TokenizerFast`) --
  An instance of [LayoutLMv2Tokenizer](model_doc/layoutlmv2.html#transformers.LayoutLMv2Tokenizer) or
  [LayoutLMv2TokenizerFast](model_doc/layoutlmv2.html#transformers.LayoutLMv2TokenizerFast). The tokenizer is a required input.
...
[__call__()](model_doc/layoutlmv2.html#transformers.LayoutLMv2FeatureExtractor.__call__). In case [~LayoutLMv2FeatureExtractor](model_doc/layoutlmv2.html#transformers.LayoutLMv2FeatureExtractor) was
initialized with `apply_ocr` set to `True`, it passes the obtained words and bounding boxes along with
the additional arguments to [__call__()](model_doc/layoutlmv2.html#transformers.LayoutLMv2Tokenizer.__call__) and returns the output, together
with resized `images`. In case [~LayoutLMv2FeatureExtractor](model_doc/layoutlmv2.html#transformers.LayoutLMv2FeatureExtractor) was initialized with `apply_ocr`
set to `False`, it passes the words (`text`/``text_pair`) and `boxes` specified by the user along with the additional arguments to [__call__()](model_doc/layoutlmv2.html#transformers.LayoutLMv2Tokenizer.__call__) and returns the output, together with resized `images``.
...
- **config** ([LayoutLMv2Config](model_doc/layoutlmv2.html#transformers.LayoutLMv2Config)) -- Model configuration class with all the parameters of the model.
...
The [LayoutLMv2Model](model_doc/layoutlmv2.html#transformers.LayoutLMv2Model) forward method, overrides the `__call__` special method.
...
- **input_ids** (`torch.LongTensor` of shape `(batch_size, sequence_length)`) --
  ...
  Indices can be obtained using [transformers.LayoutLMv2Tokenizer](model_doc/layoutlmv2.html#transformers.LayoutLMv2Tokenizer). See
...
various elements depending on the configuration ([LayoutLMv2Config](model_doc/layoutlmv2.html#transformers.LayoutLMv2Config)) and inputs.
...
The [LayoutLMv2ForSequenceClassification](model_doc/layoutlmv2.html#transformers.LayoutLMv2ForSequenceClassification) forward method, overrides the `__call__` special method.
...
The [LayoutLMv2ForTokenClassification](model_doc/layoutlmv2.html#transformers.LayoutLMv2ForTokenClassification) forward method, overrides the `__call__` special method.
...
The [LayoutLMv2ForQuestionAnswering](model_doc/layoutlmv2.html#transformers.LayoutLMv2ForQuestionAnswering) forward method, overrides the `__call__` special method.
