...
- local: overview
  title: Overview
- local: transfoxlconfig
  title: TransfoXLConfig
- local: transfoxltokenizer
  title: TransfoXLTokenizer
- local: transfoxl-specific-outputs
  title: TransfoXL specific outputs
- local: transfoxlmodel
  title: TransfoXLModel
- local: transfoxllmheadmodel
  title: TransfoXLLMHeadModel
- local: transfoxlforsequenceclassification
  title: TransfoXLForSequenceClassification
- local: tftransfoxlmodel
  title: TFTransfoXLModel
- local: tftransfoxllmheadmodel
  title: TFTransfoXLLMHeadModel
- local: tftransfoxlforsequenceclassification
  title: TFTransfoXLForSequenceClassification
- local: internal-layers
...
This is the configuration class to store the configuration of a [TransfoXLModel](/docs/transformers/master/en/model_doc/transformerxl.html#transformers.TransfoXLModel) or a
[TFTransfoXLModel](/docs/transformers/master/en/model_doc/transformerxl.html#transformers.TFTransfoXLModel). It is used to instantiate a Transformer-XL model according to the
...
- **vocab_size** (`int`, _optional_, defaults to 267735) --
  ...
  `inputs_ids` passed when calling [TransfoXLModel](/docs/transformers/master/en/model_doc/transformerxl.html#transformers.TransfoXLModel) or
  [TFTransfoXLModel](/docs/transformers/master/en/model_doc/transformerxl.html#transformers.TFTransfoXLModel).
...
- **config** ([TransfoXLConfig](/docs/transformers/master/en/model_doc/transformerxl.html#transformers.TransfoXLConfig)) -- Model configuration class with all the parameters of the model.
...
The [TransfoXLModel](/docs/transformers/master/en/model_doc/transformerxl.html#transformers.TransfoXLModel) forward method, overrides the `__call__` special method.
...
- **input_ids** (`torch.LongTensor` of shape `(batch_size, sequence_length)`) --
  ...
  Indices can be obtained using [TransfoXLTokenizer](/docs/transformers/master/en/model_doc/transformerxl.html#transformers.TransfoXLTokenizer). See
...
A [TransfoXLModelOutput](/docs/transformers/master/en/model_doc/transformerxl.html#transformers.models.transfo_xl.modeling_transfo_xl.TransfoXLModelOutput) or a tuple of
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising
various elements depending on the configuration ([TransfoXLConfig](/docs/transformers/master/en/model_doc/transformerxl.html#transformers.TransfoXLConfig)) and inputs.
...
[TransfoXLModelOutput](/docs/transformers/master/en/model_doc/transformerxl.html#transformers.models.transfo_xl.modeling_transfo_xl.TransfoXLModelOutput) or `tuple(torch.FloatTensor)`
...
The [TransfoXLLMHeadModel](/docs/transformers/master/en/model_doc/transformerxl.html#transformers.TransfoXLLMHeadModel) forward method, overrides the `__call__` special method.
...
A [TransfoXLLMHeadModelOutput](/docs/transformers/master/en/model_doc/transformerxl.html#transformers.models.transfo_xl.modeling_transfo_xl.TransfoXLLMHeadModelOutput) or a tuple of
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising
various elements depending on the configuration ([TransfoXLConfig](/docs/transformers/master/en/model_doc/transformerxl.html#transformers.TransfoXLConfig)) and inputs.
...
[TransfoXLLMHeadModelOutput](/docs/transformers/master/en/model_doc/transformerxl.html#transformers.models.transfo_xl.modeling_transfo_xl.TransfoXLLMHeadModelOutput) or `tuple(torch.FloatTensor)`
...
## [TransfoXLForSequenceClassification](#transfoxlforsequenceclassification)
...
[TransfoXLForSequenceClassification](/docs/transformers/master/en/model_doc/transformerxl.html#transformers.TransfoXLForSequenceClassification) uses the last token in order to do the classification, as
...
The [TransfoXLForSequenceClassification](/docs/transformers/master/en/model_doc/transformerxl.html#transformers.TransfoXLForSequenceClassification) forward method, overrides the `__call__` special method.
...
The [TFTransfoXLModel](/docs/transformers/master/en/model_doc/transformerxl.html#transformers.TFTransfoXLModel) forward method, overrides the `__call__` special method.
...
A [TFTransfoXLModelOutput](/docs/transformers/master/en/model_doc/transformerxl.html#transformers.models.transfo_xl.modeling_tf_transfo_xl.TFTransfoXLModelOutput) or a tuple of
`tf.Tensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([TransfoXLConfig](/docs/transformers/master/en/model_doc/transformerxl.html#transformers.TransfoXLConfig)) and inputs.
...
[TFTransfoXLModelOutput](/docs/transformers/master/en/model_doc/transformerxl.html#transformers.models.transfo_xl.modeling_tf_transfo_xl.TFTransfoXLModelOutput) or `tuple(tf.Tensor)`
...
The [TFTransfoXLLMHeadModel](/docs/transformers/master/en/model_doc/transformerxl.html#transformers.TFTransfoXLLMHeadModel) forward method, overrides the `__call__` special method.
...
A [TFTransfoXLLMHeadModelOutput](/docs/transformers/master/en/model_doc/transformerxl.html#transformers.models.transfo_xl.modeling_tf_transfo_xl.TFTransfoXLLMHeadModelOutput) or a tuple of
`tf.Tensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([TransfoXLConfig](/docs/transformers/master/en/model_doc/transformerxl.html#transformers.TransfoXLConfig)) and inputs.
...
[TFTransfoXLLMHeadModelOutput](/docs/transformers/master/en/model_doc/transformerxl.html#transformers.models.transfo_xl.modeling_tf_transfo_xl.TFTransfoXLLMHeadModelOutput) or `tuple(tf.Tensor)`
...
[TFTransfoXLForSequenceClassification](/docs/transformers/master/en/model_doc/transformerxl.html#transformers.TFTransfoXLForSequenceClassification) uses the last token in order to do the classification,
...
The [TFTransfoXLForSequenceClassification](/docs/transformers/master/en/model_doc/transformerxl.html#transformers.TFTransfoXLForSequenceClassification) forward method, overrides the `__call__` special method.
