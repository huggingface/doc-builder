...
This is the configuration class to store the configuration of a [SEWDModel](/docs/transformers/master/en/model_doc/sew_d.html#transformers.SEWDModel). It is used to
...
- **final_dropout** (`float`, _optional_, defaults to 0.1) --
  The dropout probability for the final projection layer of [SEWDForCTC](/docs/transformers/master/en/model_doc/sew_d.html#transformers.SEWDForCTC).
...
- **ctc_loss_reduction** (`str`, _optional_, defaults to `"sum"`) --
  ...
  instance of [SEWDForCTC](/docs/transformers/master/en/model_doc/sew_d.html#transformers.SEWDForCTC).
...
- **config** ([SEWDConfig](/docs/transformers/master/en/model_doc/sew_d.html#transformers.SEWDConfig)) -- Model configuration class with all the parameters of the model.
...
The [SEWDModel](/docs/transformers/master/en/model_doc/sew_d.html#transformers.SEWDModel) forward method, overrides the `__call__` special method.
...
various elements depending on the configuration ([SEWDConfig](/docs/transformers/master/en/model_doc/sew_d.html#transformers.SEWDConfig)) and inputs.
...
The [SEWDForCTC](/docs/transformers/master/en/model_doc/sew_d.html#transformers.SEWDForCTC) forward method, overrides the `__call__` special method.
...
The [SEWDForSequenceClassification](/docs/transformers/master/en/model_doc/sew_d.html#transformers.SEWDForSequenceClassification) forward method, overrides the `__call__` special method.
