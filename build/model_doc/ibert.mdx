...
This is the configuration class to store the configuration of a [IBertModel](model_doc/ibert.html#transformers.IBertModel). It is used to
...
- **vocab_size** (`int`, _optional_, defaults to 30522) --
  ...
  `inputs_ids` passed when calling [IBertModel](model_doc/ibert.html#transformers.IBertModel)
...
- **type_vocab_size** (`int`, _optional_, defaults to 2) --
  The vocabulary size of the `token_type_ids` passed when calling [IBertModel](model_doc/ibert.html#transformers.IBertModel)
...
- **config** ([IBertConfig](model_doc/ibert.html#transformers.IBertConfig)) -- Model configuration class with all the parameters of the
...
The [IBertModel](model_doc/ibert.html#transformers.IBertModel) forward method, overrides the `__call__` special method.
...
various elements depending on the configuration ([IBertConfig](model_doc/ibert.html#transformers.IBertConfig)) and inputs.
...
The [IBertForMaskedLM](model_doc/ibert.html#transformers.IBertForMaskedLM) forward method, overrides the `__call__` special method.
...
The [IBertForSequenceClassification](model_doc/ibert.html#transformers.IBertForSequenceClassification) forward method, overrides the `__call__` special method.
...
The [IBertForMultipleChoice](model_doc/ibert.html#transformers.IBertForMultipleChoice) forward method, overrides the `__call__` special method.
...
The [IBertForTokenClassification](model_doc/ibert.html#transformers.IBertForTokenClassification) forward method, overrides the `__call__` special method.
...
The [IBertForQuestionAnswering](model_doc/ibert.html#transformers.IBertForQuestionAnswering) forward method, overrides the `__call__` special method.
