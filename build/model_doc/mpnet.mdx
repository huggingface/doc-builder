...
> **class transformers.MPNetTokenizer**(vocab_file, do_lower_case = True, do_basic_tokenize = True, never_split = None, bos_token = &lcubs>, eos_token = &lcub/s>, sep_token = &lcub/s>, cls_token = &lcubs>, unk_token = [UNK], pad_token = &lcubpad>, mask_token = &lcubmask>, tokenize_chinese_chars = True, strip_accents = None, **kwargs)
...
> **class transformers.MPNetTokenizerFast**(vocab_file = None, tokenizer_file = None, do_lower_case = True, bos_token = &lcubs>, eos_token = &lcub/s>, sep_token = &lcub/s>, cls_token = &lcubs>, unk_token = [UNK], pad_token = &lcubpad>, mask_token = &lcubmask>, tokenize_chinese_chars = True, strip_accents = None, **kwargs)
...
<a id='transformers.MPNetTokenizer'></a>
> **class MPNetTokenizer**(vocab_file, do_lower_case = True, do_basic_tokenize = True, never_split = None, bos_token = &lcubs>, eos_token = &lcub/s>, sep_token = &lcub/s>, cls_token = &lcubs>, unk_token = [UNK], pad_token = &lcubpad>, mask_token = &lcubmask>, tokenize_chinese_chars = True, strip_accents = None, **kwargs)
