...
This is the configuration class to store the configuration of a [MPNetModel](model_doc/mpnet.html#transformers.MPNetModel) or a
[TFMPNetModel](model_doc/mpnet.html#transformers.TFMPNetModel). It is used to instantiate a MPNet model according to the specified arguments,
...
- **vocab_size** (`int`, _optional_, defaults to 30527) --
  ...
  `inputs_ids` passed when calling [MPNetModel](model_doc/mpnet.html#transformers.MPNetModel) or
  [TFMPNetModel](model_doc/mpnet.html#transformers.TFMPNetModel).
...
This tokenizer inherits from [BertTokenizer](model_doc/bert.html#transformers.BertTokenizer) which contains most of the methods. Users should
...
- **config** ([MPNetConfig](model_doc/mpnet.html#transformers.MPNetConfig)) -- Model configuration class with all the parameters of the model.
...
The [MPNetModel](model_doc/mpnet.html#transformers.MPNetModel) forward method, overrides the `__call__` special method.
...
- **input_ids** (`torch.LongTensor` of shape `(batch_size, sequence_length)`) --
  ...
  Indices can be obtained using [transformers.MPNetTokenizer](model_doc/mpnet.html#transformers.MPNetTokenizer). See
...
various elements depending on the configuration ([MPNetConfig](model_doc/mpnet.html#transformers.MPNetConfig)) and inputs.
...
The [MPNetForMaskedLM](model_doc/mpnet.html#transformers.MPNetForMaskedLM) forward method, overrides the `__call__` special method.
...
The [MPNetForSequenceClassification](model_doc/mpnet.html#transformers.MPNetForSequenceClassification) forward method, overrides the `__call__` special method.
...
The [MPNetForMultipleChoice](model_doc/mpnet.html#transformers.MPNetForMultipleChoice) forward method, overrides the `__call__` special method.
...
The [MPNetForTokenClassification](model_doc/mpnet.html#transformers.MPNetForTokenClassification) forward method, overrides the `__call__` special method.
...
The [MPNetForQuestionAnswering](model_doc/mpnet.html#transformers.MPNetForQuestionAnswering) forward method, overrides the `__call__` special method.
...
The [TFMPNetModel](model_doc/mpnet.html#transformers.TFMPNetModel) forward method, overrides the `__call__` special method.
...
- **input_ids** (`Numpy array` or `tf.Tensor` of shape `(batch_size, sequence_length)`) --
  ...
  Indices can be obtained using [MPNetTokenizer](model_doc/mpnet.html#transformers.MPNetTokenizer). See
...
elements depending on the configuration ([MPNetConfig](model_doc/mpnet.html#transformers.MPNetConfig)) and inputs.
...
The [TFMPNetForMaskedLM](model_doc/mpnet.html#transformers.TFMPNetForMaskedLM) forward method, overrides the `__call__` special method.
...
The [TFMPNetForSequenceClassification](model_doc/mpnet.html#transformers.TFMPNetForSequenceClassification) forward method, overrides the `__call__` special method.
...
The [TFMPNetForMultipleChoice](model_doc/mpnet.html#transformers.TFMPNetForMultipleChoice) forward method, overrides the `__call__` special method.
...
The [TFMPNetForTokenClassification](model_doc/mpnet.html#transformers.TFMPNetForTokenClassification) forward method, overrides the `__call__` special method.
...
The [TFMPNetForQuestionAnswering](model_doc/mpnet.html#transformers.TFMPNetForQuestionAnswering) forward method, overrides the `__call__` special method.
