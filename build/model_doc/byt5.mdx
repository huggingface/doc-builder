...
ByT5's architecture is based on the T5v1.1 model, so one can refer to [T5v1.1's documentation page](/docs/transformers/:version/:language/t5v1.1.html). They
...
> **class transformers.ByT5Tokenizer**(eos_token = </s>, unk_token = <unk>, pad_token = <pad>, extra_ids = 125, additional_special_tokens = None, **kwargs)
...
See [ByT5Tokenizer](docs/transformers/:version/:language/model_doc/byt5.html#transformers.ByT5Tokenizer) for all details.
