...
ByT5's architecture is based on the T5v1.1 model, so one can refer to [T5v1.1's documentation page](/docs/transformers/master/en/t5v1.1.html). They
...
See [ByT5Tokenizer](/docs/transformers/master/en/model_doc/byt5.html#transformers.ByT5Tokenizer) for all details.
