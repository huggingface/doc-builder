...
- As the BEiT models expect each image to be of the same size (resolution), one can use
  [BeitFeatureExtractor](model_doc/beit.html#transformers.BeitFeatureExtractor) to resize (or rescale) and normalize images for the model.
...
- BEiT uses relative position embeddings, inspired by the T5 model. During pre-training, the authors shared the
  ...
  `use_relative_position_bias` attribute of [BeitConfig](model_doc/beit.html#transformers.BeitConfig) to `True` in order to add
  position embeddings.
...
This is the configuration class to store the configuration of a [BeitModel](model_doc/beit.html#transformers.BeitModel). It is used to
...
- **config** ([BeitConfig](model_doc/beit.html#transformers.BeitConfig)) -- Model configuration class with all the parameters of the model.
...
The [BeitModel](model_doc/beit.html#transformers.BeitModel) forward method, overrides the `__call__` special method.
...
- **pixel_values** (`torch.FloatTensor` of shape `(batch_size, num_channels, height, width)`) --
  Pixel values. Pixel values can be obtained using [BeitFeatureExtractor](model_doc/beit.html#transformers.BeitFeatureExtractor). See
  [transformers.BeitFeatureExtractor.__call__()](model_doc/beit.html#transformers.BeitFeatureExtractor.__call__) for details.
...
various elements depending on the configuration ([BeitConfig](model_doc/beit.html#transformers.BeitConfig)) and inputs.
...
The [BeitForMaskedImageModeling](model_doc/beit.html#transformers.BeitForMaskedImageModeling) forward method, overrides the `__call__` special method.
...
The [BeitForImageClassification](model_doc/beit.html#transformers.BeitForImageClassification) forward method, overrides the `__call__` special method.
