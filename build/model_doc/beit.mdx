...
- local: beitconfig
  title: BeitConfig
- local: beitfeatureextractor
  title: BeitFeatureExtractor
- local: beitmodel
  title: BeitModel
- local: beitformaskedimagemodeling
  title: BeitForMaskedImageModeling
- local: beitforimageclassification
  title: BeitForImageClassification
- local: flaxbeitmodel
  title: FlaxBeitModel
- local: flaxbeitformaskedimagemodeling
  title: FlaxBeitForMaskedImageModeling
- local: flaxbeitforimageclassification
