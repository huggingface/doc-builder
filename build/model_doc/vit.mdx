...
- As the Vision Transformer expects each image to be of the same size (resolution), one can use
  [ViTFeatureExtractor](model_doc/vit.html#transformers.ViTFeatureExtractor) to resize (or rescale) and normalize images for the model.
...
- DeiT (Data-efficient Image Transformers) by Facebook AI. DeiT models are distilled vision transformers. Refer to
  [DeiT's documentation page](deit.html). The authors of DeiT also released more efficiently trained ViT models, which
  you can directly plug into [ViTModel](model_doc/vit.html#transformers.ViTModel) or [ViTForImageClassification](model_doc/vit.html#transformers.ViTForImageClassification). There
  ...
  [DeiTFeatureExtractor](model_doc/deit.html#transformers.DeiTFeatureExtractor) in order to prepare images for the model.
...
- BEiT (BERT pre-training of Image Transformers) by Microsoft Research. BEiT models outperform supervised pre-trained
  ...
  Refer to [BEiT's documentation page](beit.html).
...
This is the configuration class to store the configuration of a [ViTModel](model_doc/vit.html#transformers.ViTModel). It is used to
...
- **config** ([ViTConfig](model_doc/vit.html#transformers.ViTConfig)) -- Model configuration class with all the parameters of the model.
...
The [ViTModel](model_doc/vit.html#transformers.ViTModel) forward method, overrides the `__call__` special method.
...
- **pixel_values** (`torch.FloatTensor` of shape `(batch_size, num_channels, height, width)`) --
  Pixel values. Pixel values can be obtained using [ViTFeatureExtractor](model_doc/vit.html#transformers.ViTFeatureExtractor). See
  [transformers.ViTFeatureExtractor.__call__()](model_doc/vit.html#transformers.ViTFeatureExtractor.__call__) for details.
...
various elements depending on the configuration ([ViTConfig](model_doc/vit.html#transformers.ViTConfig)) and inputs.
...
The [ViTForImageClassification](model_doc/vit.html#transformers.ViTForImageClassification) forward method, overrides the `__call__` special method.
