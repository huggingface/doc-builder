...
- local: ttokenizer
  title: T5Tokenizer
- local: ttokenizerfast
  title: T5TokenizerFast
- local: tmodel
  title: T5Model
- local: tforconditionalgeneration
  title: T5ForConditionalGeneration
- local: tencodermodel
  title: T5EncoderModel
- local: tftmodel
  title: TFT5Model
- local: tftforconditionalgeneration
  title: TFT5ForConditionalGeneration
- local: tftencodermodel
  title: TFT5EncoderModel
- local: flaxtmodel
  title: FlaxT5Model
- local: flaxtforconditionalgeneration
...
- Unsupervised denoising training
  ...
  [T5Tokenizer](/docs/transformers/master/en/model_doc/mt5.html#transformers.T5Tokenizer).
...
## [T5TokenizerFast](#ttokenizerfast)
...
- **input_ids** (`torch.LongTensor` of shape `(batch_size, sequence_length)`) --
  ...
  Indices can be obtained using [T5Tokenizer](/docs/transformers/master/en/model_doc/mt5.html#transformers.T5Tokenizer). See
...
## [T5ForConditionalGeneration](#tforconditionalgeneration)
...
## [TFT5ForConditionalGeneration](#tftforconditionalgeneration)
...
## [TFT5EncoderModel](#tftencodermodel)
...
## [FlaxT5ForConditionalGeneration](#flaxtforconditionalgeneration)
