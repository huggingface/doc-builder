...
- **T5v1.1**: T5v1.1 is an improved version of T5 with some architectural tweaks, and is pre-trained on C4 only without
  mixing in the supervised tasks. Refer to the documentation of T5v1.1 which can be found [here](/docs/transformers/:version/:language/t5v1.1.html).

- **mT5**: mT5 is a multilingual T5 model. It is pre-trained on the mC4 corpus, which includes 101 languages. Refer to
  the documentation of mT5 which can be found [here](/docs/transformers/:version/:language/mt5.html).

- **byT5**: byT5 is a T5 model pre-trained on byte sequences rather than SentencePiece subword token sequences. Refer
  to the documentation of byT5 which can be found [here](/docs/transformers/:version/:language/byt5.html).
...
One can use [T5ForConditionalGeneration](docs/transformers/:version/:language/model_doc/t5.html#transformers.T5ForConditionalGeneration) (or the Tensorflow/Flax variant), which includes the
...
- Unsupervised denoising training
  ...
  [T5Tokenizer](docs/transformers/:version/:language/model_doc/t5.html#transformers.T5Tokenizer).
...
At inference time, it is recommended to use [generate()](docs/transformers/:version/:language/main_classes/model.html#transformers.generation_utils.GenerationMixin.generate). This
...
[generate()](docs/transformers/:version/:language/main_classes/model.html#transformers.generation_utils.GenerationMixin.generate), make sure you start it with the `pad_token_id`.
...
This is the configuration class to store the configuration of a [T5Model](docs/transformers/:version/:language/model_doc/t5.html#transformers.T5Model) or a
[TFT5Model](docs/transformers/:version/:language/model_doc/t5.html#transformers.TFT5Model). It is used to instantiate a T5 model according to the specified arguments,
...
`inputs_ids` passed when calling [T5Model](docs/transformers/:version/:language/model_doc/t5.html#transformers.T5Model) or [TFT5Model](docs/transformers/:version/:language/model_doc/t5.html#transformers.TFT5Model).
...
- **config** ([T5Config](docs/transformers/:version/:language/model_doc/t5.html#transformers.T5Config)) -- Model configuration class with all the parameters of the model.
...
The [T5Model](docs/transformers/:version/:language/model_doc/t5.html#transformers.T5Model) forward method, overrides the `__call__` special method.
...
- **input_ids** (`torch.LongTensor` of shape `(batch_size, sequence_length)`) --
  ...
  Indices can be obtained using [T5Tokenizer](docs/transformers/:version/:language/model_doc/t5.html#transformers.T5Tokenizer). See
...
various elements depending on the configuration ([T5Config](docs/transformers/:version/:language/model_doc/t5.html#transformers.T5Config)) and inputs.
...
The [T5ForConditionalGeneration](docs/transformers/:version/:language/model_doc/t5.html#transformers.T5ForConditionalGeneration) forward method, overrides the `__call__` special method.
...
The [T5EncoderModel](docs/transformers/:version/:language/model_doc/t5.html#transformers.T5EncoderModel) forward method, overrides the `__call__` special method.
...
The [TFT5Model](docs/transformers/:version/:language/model_doc/t5.html#transformers.TFT5Model) forward method, overrides the `__call__` special method.
...
A [TFSeq2SeqModelOutput](docs/transformers/:version/:language/main_classes/output.html#transformers.modeling_tf_outputs.TFSeq2SeqModelOutput) or a tuple of
`tf.Tensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([T5Config](docs/transformers/:version/:language/model_doc/t5.html#transformers.T5Config)) and inputs.
...
[TFSeq2SeqModelOutput](docs/transformers/:version/:language/main_classes/output.html#transformers.modeling_tf_outputs.TFSeq2SeqModelOutput) or `tuple(tf.Tensor)`
...
The [TFT5ForConditionalGeneration](docs/transformers/:version/:language/model_doc/t5.html#transformers.TFT5ForConditionalGeneration) forward method, overrides the `__call__` special method.
...
A [TFSeq2SeqLMOutput](docs/transformers/:version/:language/main_classes/output.html#transformers.modeling_tf_outputs.TFSeq2SeqLMOutput) or a tuple of
`tf.Tensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([T5Config](docs/transformers/:version/:language/model_doc/t5.html#transformers.T5Config)) and inputs.
...
[TFSeq2SeqLMOutput](docs/transformers/:version/:language/main_classes/output.html#transformers.modeling_tf_outputs.TFSeq2SeqLMOutput) or `tuple(tf.Tensor)`
...
The [TFT5EncoderModel](docs/transformers/:version/:language/model_doc/t5.html#transformers.TFT5EncoderModel) forward method, overrides the `__call__` special method.
...
A [FlaxSeq2SeqLMOutput](docs/transformers/:version/:language/main_classes/output.html#transformers.modeling_flax_outputs.FlaxSeq2SeqLMOutput) or a tuple of
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising
various elements depending on the configuration ([T5Config](docs/transformers/:version/:language/model_doc/t5.html#transformers.T5Config)) and inputs.
...
[FlaxSeq2SeqLMOutput](docs/transformers/:version/:language/main_classes/output.html#transformers.modeling_flax_outputs.FlaxSeq2SeqLMOutput) or `tuple(torch.FloatTensor)`
...
A [FlaxBaseModelOutputWithPastAndCrossAttentions](docs/transformers/:version/:language/main_classes/output.html#transformers.modeling_flax_outputs.FlaxBaseModelOutputWithPastAndCrossAttentions) or a tuple of
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising
various elements depending on the configuration (`T5Config'>`) and inputs.
...
[FlaxBaseModelOutputWithPastAndCrossAttentions](docs/transformers/:version/:language/main_classes/output.html#transformers.modeling_flax_outputs.FlaxBaseModelOutputWithPastAndCrossAttentions) or `tuple(torch.FloatTensor)`
...
A [FlaxCausalLMOutputWithCrossAttentions](docs/transformers/:version/:language/main_classes/output.html#transformers.modeling_flax_outputs.FlaxCausalLMOutputWithCrossAttentions) or a tuple of
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising
various elements depending on the configuration (`T5Config'>`) and inputs.
...
[FlaxCausalLMOutputWithCrossAttentions](docs/transformers/:version/:language/main_classes/output.html#transformers.modeling_flax_outputs.FlaxCausalLMOutputWithCrossAttentions) or `tuple(torch.FloatTensor)`
