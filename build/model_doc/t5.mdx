...
- **T5v1.1**: T5v1.1 is an improved version of T5 with some architectural tweaks, and is pre-trained on C4 only without
  mixing in the supervised tasks. Refer to the documentation of T5v1.1 which can be found [here](t5v1.1.html).

- **mT5**: mT5 is a multilingual T5 model. It is pre-trained on the mC4 corpus, which includes 101 languages. Refer to
  the documentation of mT5 which can be found [here](mt5.html).

- **byT5**: byT5 is a T5 model pre-trained on byte sequences rather than SentencePiece subword token sequences. Refer
  to the documentation of byT5 which can be found [here](byt5.html).
...
One can use [T5ForConditionalGeneration](model_doc/t5.html#transformers.T5ForConditionalGeneration) (or the Tensorflow/Flax variant), which includes the
...
- Unsupervised denoising training
  ...
  sentinel token represents a unique mask token for this sentence and should start with `&lcubextra_id_0>`,
  `&lcubextra_id_1>`, ... up to `&lcubextra_id_99>`. As a default, 100 sentinel tokens are available in
  [T5Tokenizer](model_doc/t5.html#transformers.T5Tokenizer).
...
input_ids = tokenizer('The &lcubextra_id_0> walks in &lcubextra_id_1> park', return_tensors='pt').input_ids
labels = tokenizer('&lcubextra_id_0> cute dog &lcubextra_id_1> the &lcubextra_id_2>', return_tensors='pt').input_ids
...
At inference time, it is recommended to use [generate()](main_classes/model.html#transformers.generation_utils.GenerationMixin.generate). This
...
[generate()](main_classes/model.html#transformers.generation_utils.GenerationMixin.generate), make sure you start it with the `pad_token_id`.
...
This is the configuration class to store the configuration of a [T5Model](model_doc/t5.html#transformers.T5Model) or a
[TFT5Model](model_doc/t5.html#transformers.TFT5Model). It is used to instantiate a T5 model according to the specified arguments,
...
> **class transformers.T5Tokenizer**(vocab_file, eos_token = &lcub/s>, unk_token = &lcubunk>, pad_token = &lcubpad>, extra_ids = 100, additional_special_tokens = None, sp_model_kwargs: typing.Union[typing.Dict[str, typing.Any], NoneType] = None, **kwargs)
...
> **class transformers.T5TokenizerFast**(vocab_file = None, tokenizer_file = None, eos_token = &lcub/s>, unk_token = &lcubunk>, pad_token = &lcubpad>, extra_ids = 100, additional_special_tokens = None, **kwargs)
...
<a id='transformers.T5Tokenizer'></a>
> **class T5Tokenizer**(vocab_file, eos_token = &lcub/s>, unk_token = &lcubunk>, pad_token = &lcubpad>, extra_ids = 100, additional_special_tokens = None, sp_model_kwargs: typing.Union[typing.Dict[str, typing.Any], NoneType] = None, **kwargs)
...
- **config** ([T5Config](model_doc/t5.html#transformers.T5Config)) -- Model configuration class with all the parameters of the model.
...
The [T5Model](model_doc/t5.html#transformers.T5Model) forward method, overrides the `__call__` special method.
...
- **input_ids** (`torch.LongTensor` of shape `(batch_size, sequence_length)`) --
  ...
  Indices can be obtained using [T5Tokenizer](model_doc/t5.html#transformers.T5Tokenizer). See
...
various elements depending on the configuration ([T5Config](model_doc/t5.html#transformers.T5Config)) and inputs.
...
The [T5ForConditionalGeneration](model_doc/t5.html#transformers.T5ForConditionalGeneration) forward method, overrides the `__call__` special method.
...
The [T5EncoderModel](model_doc/t5.html#transformers.T5EncoderModel) forward method, overrides the `__call__` special method.
...
The [TFT5Model](model_doc/t5.html#transformers.TFT5Model) forward method, overrides the `__call__` special method.
...
elements depending on the configuration ([T5Config](model_doc/t5.html#transformers.T5Config)) and inputs.
...
The [TFT5ForConditionalGeneration](model_doc/t5.html#transformers.TFT5ForConditionalGeneration) forward method, overrides the `__call__` special method.
...
>>> # training
>>> inputs = tokenizer('The &lcubextra_id_0> walks in &lcubextra_id_1> park', return_tensors='tf').input_ids
>>> labels = tokenizer('&lcubextra_id_0> cute dog &lcubextra_id_1> the &lcubextra_id_2>', return_tensors='tf').input_ids
...
The [TFT5EncoderModel](model_doc/t5.html#transformers.TFT5EncoderModel) forward method, overrides the `__call__` special method.
...
> **class transformers.FlaxT5Model**(config: T5Config, input_shape: typing.Tuple[int] = (1, 1), seed: int = 0, dtype: dtype = &lcubclass 'jax._src.numpy.lax_numpy.float32'&rcub, **kwargs)
...
> **class transformers.FlaxT5ForConditionalGeneration**(config: T5Config, input_shape: typing.Tuple[int] = (1, 1), seed: int = 0, dtype: dtype = &lcubclass 'jax._src.numpy.lax_numpy.float32'&rcub, **kwargs)
