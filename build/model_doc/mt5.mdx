...
This is the configuration class to store the configuration of a [MT5Model](docs/transformers/:version/:language/model_doc/mt5.html#transformers.MT5Model) or a
[TFMT5Model](docs/transformers/:version/:language/model_doc/mt5.html#transformers.TFMT5Model). It is used to instantiate a mT5 model according to the specified arguments,
...
See [T5Tokenizer](docs/transformers/:version/:language/model_doc/t5.html#transformers.T5Tokenizer) for all details.
...
See [T5TokenizerFast](docs/transformers/:version/:language/model_doc/t5.html#transformers.T5TokenizerFast) for all details.
...
This class overrides [T5Model](docs/transformers/:version/:language/model_doc/t5.html#transformers.T5Model). Please check the superclass for the appropriate documentation
...
This class overrides [T5ForConditionalGeneration](docs/transformers/:version/:language/model_doc/t5.html#transformers.T5ForConditionalGeneration). Please check the superclass for the
...
This class overrides [T5EncoderModel](docs/transformers/:version/:language/model_doc/t5.html#transformers.T5EncoderModel). Please check the superclass for the appropriate
...
This class overrides [TFT5Model](docs/transformers/:version/:language/model_doc/t5.html#transformers.TFT5Model). Please check the superclass for the appropriate
documentation alongside usage examples.
...
This class overrides [TFT5ForConditionalGeneration](docs/transformers/:version/:language/model_doc/t5.html#transformers.TFT5ForConditionalGeneration). Please check the superclass for the
appropriate documentation alongside usage examples.
...
This class overrides [TFT5EncoderModel](docs/transformers/:version/:language/model_doc/t5.html#transformers.TFT5EncoderModel). Please check the superclass for the appropriate
documentation alongside usage examples.
...
This class overrides [FlaxT5Model](docs/transformers/:version/:language/model_doc/t5.html#transformers.FlaxT5Model). Please check the superclass for the appropriate
documentation alongside usage examples.
...
This class overrides [FlaxT5ForConditionalGeneration](docs/transformers/:version/:language/model_doc/t5.html#transformers.FlaxT5ForConditionalGeneration). Please check the superclass for the
appropriate documentation alongside usage examples.
