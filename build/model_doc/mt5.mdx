...
See [T5Tokenizer](/docs/transformers/master/en/model_doc/t5.html#transformers.T5Tokenizer) for all details.
...
See [T5TokenizerFast](/docs/transformers/master/en/model_doc/t5.html#transformers.T5TokenizerFast) for all details.
