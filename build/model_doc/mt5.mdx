...
- local: mttokenizer
  title: MT5Tokenizer
- local: mttokenizerfast
  title: MT5TokenizerFast
- local: mtmodel
  title: MT5Model
- local: mtforconditionalgeneration
  title: MT5ForConditionalGeneration
- local: mtencodermodel
  title: MT5EncoderModel
- local: tfmtmodel
  title: TFMT5Model
- local: tfmtforconditionalgeneration
  title: TFMT5ForConditionalGeneration
- local: tfmtencodermodel
  title: TFMT5EncoderModel
- local: flaxmtmodel
  title: FlaxMT5Model
- local: flaxmtforconditionalgeneration
...
This is the configuration class to store the configuration of a [MT5Model](/docs/transformers/master/en/model_doc/mt5.html#transformers.MT5Model) or a
[TFMT5Model](/docs/transformers/master/en/model_doc/mt5.html#transformers.TFMT5Model). It is used to instantiate a mT5 model according to the specified arguments,
...
See [T5Tokenizer](/docs/transformers/master/en/model_doc/mt5.html#transformers.T5Tokenizer) for all details.


## [MT5TokenizerFast](#mttokenizerfast)
...
See [T5TokenizerFast](/docs/transformers/master/en/model_doc/mt5.html#transformers.T5TokenizerFast) for all details.
...
This class overrides [T5Model](/docs/transformers/master/en/model_doc/t5.html#transformers.T5Model). Please check the superclass for the appropriate documentation
...
## [MT5ForConditionalGeneration](#mtforconditionalgeneration)

<a id='transformers.MT5ForConditionalGeneration'></a>
> **class transformers.MT5ForConditionalGeneration**(config)


This class overrides [T5ForConditionalGeneration](/docs/transformers/master/en/model_doc/t5.html#transformers.T5ForConditionalGeneration). Please check the superclass for the
...
## [MT5EncoderModel](#mtencodermodel)

<a id='transformers.MT5EncoderModel'></a>
> **class transformers.MT5EncoderModel**(config: T5Config)


This class overrides [T5EncoderModel](/docs/transformers/master/en/model_doc/t5.html#transformers.T5EncoderModel). Please check the superclass for the appropriate
...
## [TFMT5Model](#tfmtmodel)

<a id='transformers.TFMT5Model'></a>
> **class transformers.TFMT5Model**(*args, **kwargs)


This class overrides [TFT5Model](/docs/transformers/master/en/model_doc/t5.html#transformers.TFT5Model). Please check the superclass for the appropriate
documentation alongside usage examples.
...
## [TFMT5ForConditionalGeneration](#tfmtforconditionalgeneration)

<a id='transformers.TFMT5ForConditionalGeneration'></a>
> **class transformers.TFMT5ForConditionalGeneration**(*args, **kwargs)


This class overrides [TFT5ForConditionalGeneration](/docs/transformers/master/en/model_doc/t5.html#transformers.TFT5ForConditionalGeneration). Please check the superclass for the
appropriate documentation alongside usage examples.
...
## [TFMT5EncoderModel](#tfmtencodermodel)

<a id='transformers.TFMT5EncoderModel'></a>
> **class transformers.TFMT5EncoderModel**(*args, **kwargs)


This class overrides [TFT5EncoderModel](/docs/transformers/master/en/model_doc/t5.html#transformers.TFT5EncoderModel). Please check the superclass for the appropriate
documentation alongside usage examples.
...
This class overrides [FlaxT5Model](/docs/transformers/master/en/model_doc/t5.html#transformers.FlaxT5Model). Please check the superclass for the appropriate
documentation alongside usage examples.
...
## [FlaxMT5ForConditionalGeneration](#flaxmtforconditionalgeneration)
...
This class overrides [FlaxT5ForConditionalGeneration](/docs/transformers/master/en/model_doc/t5.html#transformers.FlaxT5ForConditionalGeneration). Please check the superclass for the
appropriate documentation alongside usage examples.
