...
- local: training
  title: Training
- local: reformerconfig
  title: ReformerConfig
- local: reformertokenizer
  title: ReformerTokenizer
- local: reformertokenizerfast
  title: ReformerTokenizerFast
- local: reformermodel
  title: ReformerModel
- local: reformermodelwithlmhead
  title: ReformerModelWithLMHead
- local: reformerformaskedlm
  title: ReformerForMaskedLM
- local: reformerforsequenceclassification
  title: ReformerForSequenceClassification
- local: reformerforquestionanswering
...
For training, the [ReformerModelWithLMHead](/docs/transformers/master/en/model_doc/reformer.html#transformers.ReformerModelWithLMHead) should be used as follows:
...
This is the configuration class to store the configuration of a [ReformerModel](/docs/transformers/master/en/model_doc/reformer.html#transformers.ReformerModel). It is used to
...
- **is_decoder** (`bool`, _optional_, defaults to `False`) --
  ...
  [ReformerModel](/docs/transformers/master/en/model_doc/reformer.html#transformers.ReformerModel). When using the Reformer for causal language modeling, this argument
...
- **vocab_size** (`int`, _optional_, defaults to 320) --\
  ...
  the `inputs_ids` passed when calling [ReformerModel](/docs/transformers/master/en/model_doc/reformer.html#transformers.ReformerModel).
...
- **config** ([ReformerConfig](/docs/transformers/master/en/model_doc/reformer.html#transformers.ReformerConfig)) -- Model configuration class with all the parameters of the model.
...
The [ReformerModel](/docs/transformers/master/en/model_doc/reformer.html#transformers.ReformerModel) forward method, overrides the `__call__` special method.
...
- **input_ids** (`torch.LongTensor` of shape `(batch_size, sequence_length)`) --
  ...
  Indices can be obtained using [ReformerTokenizer](/docs/transformers/master/en/model_doc/reformer.html#transformers.ReformerTokenizer). See
...
- **num_hashes** (`int`, _optional_) --
  ...
  For more information, see `num_hashes` in [ReformerConfig](/docs/transformers/master/en/model_doc/reformer.html#transformers.ReformerConfig).
...
various elements depending on the configuration ([ReformerConfig](/docs/transformers/master/en/model_doc/reformer.html#transformers.ReformerConfig)) and inputs.
...
The [ReformerModelWithLMHead](/docs/transformers/master/en/model_doc/reformer.html#transformers.ReformerModelWithLMHead) forward method, overrides the `__call__` special method.
...
The [ReformerForMaskedLM](/docs/transformers/master/en/model_doc/reformer.html#transformers.ReformerForMaskedLM) forward method, overrides the `__call__` special method.
...
The [ReformerForSequenceClassification](/docs/transformers/master/en/model_doc/reformer.html#transformers.ReformerForSequenceClassification) forward method, overrides the `__call__` special method.
...
The [ReformerForQuestionAnswering](/docs/transformers/master/en/model_doc/reformer.html#transformers.ReformerForQuestionAnswering) forward method, overrides the `__call__` special method.
