...
For training, the [ReformerModelWithLMHead](docs/transformers/:version/:language/model_doc/reformer.html#transformers.ReformerModelWithLMHead) should be used as follows:
...
<a id='transformers.ReformerConfig'></a>
...
This is the configuration class to store the configuration of a [ReformerModel](docs/transformers/:version/:language/model_doc/reformer.html#transformers.ReformerModel). It is used to
...
- **attention_head_size** (`int`, _optional_, defaults to 64) --
...
- **attn_layers** (`List[str]`, _optional_, defaults to `["local", "lsh", "local", "lsh", "local", "lsh"]`) --
  ...
  For more information on LSHSelfAttention layer, see [LSH Self Attention](reformer.html#lsh-self-attention). For more information on LocalSelfAttention layer, see [Local Self
  Attention](reformer.html#local-self-attention).
- **axial_pos_embds** (`bool`, _optional_, defaults to `True`) --
  ...
  work, see [Axial Position Encodings](reformer.html#axial-positional-encodings).
...
- **axial_pos_shape** (`List[int]`, _optional_, defaults to `[64, 64]`) --
  ...
  For more information on how axial position embeddings work, see [Axial Position Encodings](reformer.html#axial-positional-encodings).
...
- **chunk_size_lm_head** (`int`, _optional_, defaults to 0) --
  ...
  For more information on feed forward chunking, see [How does Feed Forward Chunking work?](../glossary.html#feed-forward-chunking).
...
- **is_decoder** (`bool`, _optional_, defaults to `False`) --
  ...
  [ReformerModel](docs/transformers/:version/:language/model_doc/reformer.html#transformers.ReformerModel). When using the Reformer for causal language modeling, this argument
...
- **vocab_size** (`int`, _optional_, defaults to 320) --\
  ...
  the `inputs_ids` passed when calling [ReformerModel](docs/transformers/:version/:language/model_doc/reformer.html#transformers.ReformerModel).
...
<a id='transformers.ReformerTokenizer.save_vocabulary'></a>
...
<a id='transformers.ReformerModel'></a>
> **class transformers.ReformerModel**(config)
...
- **config** ([ReformerConfig](docs/transformers/:version/:language/model_doc/reformer.html#transformers.ReformerConfig)) -- Model configuration class with all the parameters of the model.
...
<a id='transformers.ReformerModel.forward'></a>
> **forward**(self, input_ids = None, attention_mask = None, position_ids = None, head_mask = None, inputs_embeds = None, num_hashes = None, past_buckets_states = None, use_cache = None, output_hidden_states = None, output_attentions = None, return_dict = None)

The [ReformerModel](docs/transformers/:version/:language/model_doc/reformer.html#transformers.ReformerModel) forward method, overrides the `__call__` special method.
...
- **input_ids** (`torch.LongTensor` of shape `(batch_size, sequence_length)`) --
  ...
  Indices can be obtained using [ReformerTokenizer](docs/transformers/:version/:language/model_doc/reformer.html#transformers.ReformerTokenizer). See
...
- **num_hashes** (`int`, _optional_) --
  ...
  For more information, see `num_hashes` in [ReformerConfig](docs/transformers/:version/:language/model_doc/reformer.html#transformers.ReformerConfig).
...
various elements depending on the configuration ([ReformerConfig](docs/transformers/:version/:language/model_doc/reformer.html#transformers.ReformerConfig)) and inputs.
...
`ReformerModelOutput` or `tuple(torch.FloatTensor)`
...
<a id='transformers.ReformerModelWithLMHead'></a>
> **class transformers.ReformerModelWithLMHead**(config)
...
<a id='transformers.ReformerModelWithLMHead.forward'></a>
> **forward**(self, input_ids = None, position_ids = None, attention_mask = None, head_mask = None, inputs_embeds = None, num_hashes = None, past_buckets_states = None, use_cache = None, output_hidden_states = None, output_attentions = None, return_dict = None, labels = None)

The [ReformerModelWithLMHead](docs/transformers/:version/:language/model_doc/reformer.html#transformers.ReformerModelWithLMHead) forward method, overrides the `__call__` special method.
...
<a id='transformers.ReformerForMaskedLM'></a>
> **class transformers.ReformerForMaskedLM**(config)
...
<a id='transformers.ReformerForMaskedLM.forward'></a>
> **forward**(self, input_ids = None, position_ids = None, attention_mask = None, head_mask = None, inputs_embeds = None, num_hashes = None, labels = None, output_hidden_states = None, output_attentions = None, return_dict = None)

The [ReformerForMaskedLM](docs/transformers/:version/:language/model_doc/reformer.html#transformers.ReformerForMaskedLM) forward method, overrides the `__call__` special method.
...
<a id='transformers.ReformerForSequenceClassification'></a>
> **class transformers.ReformerForSequenceClassification**(config)
...
<a id='transformers.ReformerForSequenceClassification.forward'></a>
> **forward**(self, input_ids = None, position_ids = None, attention_mask = None, head_mask = None, inputs_embeds = None, num_hashes = None, labels = None, output_hidden_states = None, output_attentions = None, return_dict = None)

The [ReformerForSequenceClassification](docs/transformers/:version/:language/model_doc/reformer.html#transformers.ReformerForSequenceClassification) forward method, overrides the `__call__` special method.
...
<a id='transformers.ReformerForQuestionAnswering'></a>
> **class transformers.ReformerForQuestionAnswering**(config)
...
<a id='transformers.ReformerForQuestionAnswering.forward'></a>
> **forward**(self, input_ids = None, position_ids = None, attention_mask = None, head_mask = None, inputs_embeds = None, num_hashes = None, start_positions = None, end_positions = None, output_hidden_states = None, output_attentions = None, return_dict = None)

The [ReformerForQuestionAnswering](docs/transformers/:version/:language/model_doc/reformer.html#transformers.ReformerForQuestionAnswering) forward method, overrides the `__call__` special method.
