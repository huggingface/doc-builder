...
This is the configuration class to store the configuration of a [RetriBertModel](docs/transformers/:version/:language/model_doc/retribert.html#transformers.RetriBertModel). It is used
...
- **vocab_size** (`int`, _optional_, defaults to 30522) --
  ...
  the `inputs_ids` passed when calling [RetriBertModel](docs/transformers/:version/:language/model_doc/retribert.html#transformers.RetriBertModel)
...
`RetroBertTokenizer` is identical to [BertTokenizer](docs/transformers/:version/:language/model_doc/bert.html#transformers.BertTokenizer) and runs end-to-end
...
[RetriBertTokenizerFast](docs/transformers/:version/:language/model_doc/retribert.html#transformers.RetriBertTokenizerFast) is identical to [BertTokenizerFast](docs/transformers/:version/:language/model_doc/bert.html#transformers.BertTokenizerFast) and runs
...
- **config** ([RetriBertConfig](docs/transformers/:version/:language/model_doc/retribert.html#transformers.RetriBertConfig)) -- Model configuration class with all the parameters of the model.
...
- **input_ids_query** (`torch.LongTensor` of shape `(batch_size, sequence_length)`) --
  ...
  Indices can be obtained using [RetriBertTokenizer](docs/transformers/:version/:language/model_doc/retribert.html#transformers.RetriBertTokenizer). See
