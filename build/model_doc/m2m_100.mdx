...
The [M2M100Tokenizer](model_doc/m2m_100.html#transformers.M2M100Tokenizer) depends on `sentencepiece` so be sure to install it before running the
...
This is the configuration class to store the configuration of a [M2M100Model](model_doc/m2m_100.html#transformers.M2M100Model). It is used to
...
- **vocab_size** (`int`, _optional_, defaults to 50265) --
  ...
  `inputs_ids` passed when calling [M2M100Model](model_doc/m2m_100.html#transformers.M2M100Model) or
...
> **class transformers.M2M100Tokenizer**(vocab_file, spm_file, src_lang = None, tgt_lang = None, bos_token = &lcubs>, eos_token = &lcub/s>, sep_token = &lcub/s>, pad_token = &lcubpad>, unk_token = &lcubunk>, sp_model_kwargs: typing.Union[typing.Dict[str, typing.Any], NoneType] = None, **kwargs)
...
- **config** ([M2M100Config](model_doc/m2m_100.html#transformers.M2M100Config)) --
...
The [M2M100Model](model_doc/m2m_100.html#transformers.M2M100Model) forward method, overrides the `__call__` special method.
...
- **input_ids** (`torch.LongTensor` of shape `(batch_size, sequence_length)`) --
  ...
  Indices can be obtained using [M2M100Tokenizer](model_doc/m2m_100.html#transformers.M2M100Tokenizer). See
...
various elements depending on the configuration ([M2M100Config](model_doc/m2m_100.html#transformers.M2M100Config)) and inputs.
...
The [M2M100ForConditionalGeneration](model_doc/m2m_100.html#transformers.M2M100ForConditionalGeneration) forward method, overrides the `__call__` special method.
