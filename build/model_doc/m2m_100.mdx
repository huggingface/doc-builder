...
- local: mmmodel
  title: M2M100Model
- local: mmforconditionalgeneration
...
The [M2M100Tokenizer](/docs/transformers/master/en/model_doc/m2m_100.html#transformers.M2M100Tokenizer) depends on `sentencepiece` so be sure to install it before running the
...
This is the configuration class to store the configuration of a [M2M100Model](/docs/transformers/master/en/model_doc/m2m_100.html#transformers.M2M100Model). It is used to
...
- **vocab_size** (`int`, _optional_, defaults to 50265) --
  ...
  `inputs_ids` passed when calling [M2M100Model](/docs/transformers/master/en/model_doc/m2m_100.html#transformers.M2M100Model) or
...
- **config** ([M2M100Config](/docs/transformers/master/en/model_doc/m2m_100.html#transformers.M2M100Config)) --
...
The [M2M100Model](/docs/transformers/master/en/model_doc/m2m_100.html#transformers.M2M100Model) forward method, overrides the `__call__` special method.
...
- **input_ids** (`torch.LongTensor` of shape `(batch_size, sequence_length)`) --
  ...
  Indices can be obtained using [M2M100Tokenizer](/docs/transformers/master/en/model_doc/m2m_100.html#transformers.M2M100Tokenizer). See
...
various elements depending on the configuration ([M2M100Config](/docs/transformers/master/en/model_doc/m2m_100.html#transformers.M2M100Config)) and inputs.
...
## [M2M100ForConditionalGeneration](#mmforconditionalgeneration)
...
The [M2M100ForConditionalGeneration](/docs/transformers/master/en/model_doc/m2m_100.html#transformers.M2M100ForConditionalGeneration) forward method, overrides the `__call__` special method.
