...
This is the configuration class to store the configuration of a [HubertModel](model_doc/hubert.html#transformers.HubertModel). It is used to
...
- **vocab_size** (`int`, _optional_, defaults to 32) --
  ...
  `inputs_ids` passed when calling [HubertModel](model_doc/hubert.html#transformers.HubertModel). Vocabulary size of the model.
  Defines the different tokens that can be represented by the _inputs_ids_ passed to the forward method of
  [HubertModel](model_doc/hubert.html#transformers.HubertModel).
...
- **final_dropout** (`float`, _optional_, defaults to 0.1) --
  The dropout probabilitiy for the final projection layer of [Wav2Vec2ForCTC](model_doc/wav2vec2.html#transformers.Wav2Vec2ForCTC).
...
- **ctc_loss_reduction** (`str`, _optional_, defaults to `"sum"`) --
  ...
  instance of [HubertForCTC](model_doc/hubert.html#transformers.HubertForCTC).
...
- **use_weighted_layer_sum** (`bool`, _optional_, defaults to `False`) --
  ...
  instance of [HubertForSequenceClassification](model_doc/hubert.html#transformers.HubertForSequenceClassification).
...
- **config** ([HubertConfig](model_doc/hubert.html#transformers.HubertConfig)) -- Model configuration class with all the parameters of the model.
...
The [HubertModel](model_doc/hubert.html#transformers.HubertModel) forward method, overrides the `__call__` special method.
...
various elements depending on the configuration ([HubertConfig](model_doc/hubert.html#transformers.HubertConfig)) and inputs.
...
The [HubertForCTC](model_doc/hubert.html#transformers.HubertForCTC) forward method, overrides the `__call__` special method.
...
The [HubertForSequenceClassification](model_doc/hubert.html#transformers.HubertForSequenceClassification) forward method, overrides the `__call__` special method.
...
The [TFHubertModel](model_doc/hubert.html#transformers.TFHubertModel) forward method, overrides the `__call__` special method.
...
elements depending on the configuration ([HubertConfig](model_doc/hubert.html#transformers.HubertConfig)) and inputs.
...
The [TFHubertForCTC](model_doc/hubert.html#transformers.TFHubertForCTC) forward method, overrides the `__call__` special method.
