...
- **final_dropout** (`float`, _optional_, defaults to 0.1) --
  The dropout probabilitiy for the final projection layer of [Wav2Vec2ForCTC](/docs/transformers/master/en/model_doc/wav2vec2.html#transformers.Wav2Vec2ForCTC).
