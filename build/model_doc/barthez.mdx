...
> **class transformers.BarthezTokenizer**(vocab_file, bos_token = &lcubs>, eos_token = &lcub/s>, sep_token = &lcub/s>, cls_token = &lcubs>, unk_token = &lcubunk>, pad_token = &lcubpad>, mask_token = &lcubmask>, sp_model_kwargs: typing.Union[typing.Dict[str, typing.Any], NoneType] = None, **kwargs)
...
> **class transformers.BarthezTokenizerFast**(vocab_file = None, tokenizer_file = None, bos_token = &lcubs>, eos_token = &lcub/s>, sep_token = &lcub/s>, cls_token = &lcubs>, unk_token = &lcubunk>, pad_token = &lcubpad>, mask_token = &lcubmask>, **kwargs)
...
<a id='transformers.BarthezTokenizer'></a>
> **class BarthezTokenizer**(vocab_file, bos_token = &lcubs>, eos_token = &lcub/s>, sep_token = &lcub/s>, cls_token = &lcubs>, unk_token = &lcubunk>, pad_token = &lcubpad>, mask_token = &lcubmask>, sp_model_kwargs: typing.Union[typing.Dict[str, typing.Any], NoneType] = None, **kwargs)
