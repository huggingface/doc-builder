...
Adapted from [CamembertTokenizer](docs/transformers/:version/:language/model_doc/camembert.html#transformers.CamembertTokenizer) and [BartTokenizer](docs/transformers/:version/:language/model_doc/bart.html#transformers.BartTokenizer). Construct a
...
Adapted from [CamembertTokenizer](docs/transformers/:version/:language/model_doc/camembert.html#transformers.CamembertTokenizer) and [BartTokenizer](docs/transformers/:version/:language/model_doc/bart.html#transformers.BartTokenizer). Construct a "fast"
BARThez tokenizer. Based on [SentencePiece](https://github.com/google/sentencepiece).
