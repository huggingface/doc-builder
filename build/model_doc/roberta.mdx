...
- This implementation is the same as [BertModel](/docs/transformers/master/en/model_doc/bert.html#transformers.BertModel) with a tiny embeddings tweak as well as a setup
...
This is the configuration class to store the configuration of a [RobertaModel](/docs/transformers/master/en/model_doc/roberta.html#transformers.RobertaModel) or a
[TFRobertaModel](/docs/transformers/master/en/model_doc/roberta.html#transformers.TFRobertaModel). It is used to instantiate a RoBERTa model according to the specified
...
The [RobertaConfig](/docs/transformers/master/en/model_doc/roberta.html#transformers.RobertaConfig) class directly inherits [BertConfig](/docs/transformers/master/en/model_doc/bert.html#transformers.BertConfig). It reuses the
...
- **config** ([RobertaConfig](/docs/transformers/master/en/model_doc/roberta.html#transformers.RobertaConfig)) -- Model configuration class with all the parameters of the
...
The [TFRobertaForCausalLM](/docs/transformers/master/en/model_doc/roberta.html#transformers.TFRobertaForCausalLM) forward method, overrides the `__call__` special method.
