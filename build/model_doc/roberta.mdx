...
- This implementation is the same as [BertModel](docs/transformers/:version/:language/model_doc/bert.html#transformers.BertModel) with a tiny embeddings tweak as well as a setup
...
- [CamemBERT](/docs/transformers/:version/:language/camembert.html) is a wrapper around RoBERTa. Refer to this page for usage examples.
...
This is the configuration class to store the configuration of a [RobertaModel](docs/transformers/:version/:language/model_doc/roberta.html#transformers.RobertaModel) or a
[TFRobertaModel](docs/transformers/:version/:language/model_doc/roberta.html#transformers.TFRobertaModel). It is used to instantiate a RoBERTa model according to the specified
...
The [RobertaConfig](docs/transformers/:version/:language/model_doc/roberta.html#transformers.RobertaConfig) class directly inherits [BertConfig](docs/transformers/:version/:language/model_doc/bert.html#transformers.BertConfig). It reuses the
...
- **config** ([RobertaConfig](docs/transformers/:version/:language/model_doc/roberta.html#transformers.RobertaConfig)) -- Model configuration class with all the parameters of the
...
The [RobertaModel](docs/transformers/:version/:language/model_doc/roberta.html#transformers.RobertaModel) forward method, overrides the `__call__` special method.
...
- **input_ids** (`torch.LongTensor` of shape `(batch_size, sequence_length)`) --
  ...
  Indices can be obtained using [RobertaTokenizer](docs/transformers/:version/:language/model_doc/roberta.html#transformers.RobertaTokenizer). See
...
various elements depending on the configuration ([RobertaConfig](docs/transformers/:version/:language/model_doc/roberta.html#transformers.RobertaConfig)) and inputs.
...
The [RobertaForCausalLM](docs/transformers/:version/:language/model_doc/roberta.html#transformers.RobertaForCausalLM) forward method, overrides the `__call__` special method.
...
The [RobertaForMaskedLM](docs/transformers/:version/:language/model_doc/roberta.html#transformers.RobertaForMaskedLM) forward method, overrides the `__call__` special method.
...
The [RobertaForSequenceClassification](docs/transformers/:version/:language/model_doc/roberta.html#transformers.RobertaForSequenceClassification) forward method, overrides the `__call__` special method.
...
The [RobertaForMultipleChoice](docs/transformers/:version/:language/model_doc/roberta.html#transformers.RobertaForMultipleChoice) forward method, overrides the `__call__` special method.
...
The [RobertaForTokenClassification](docs/transformers/:version/:language/model_doc/roberta.html#transformers.RobertaForTokenClassification) forward method, overrides the `__call__` special method.
...
The [RobertaForQuestionAnswering](docs/transformers/:version/:language/model_doc/roberta.html#transformers.RobertaForQuestionAnswering) forward method, overrides the `__call__` special method.
...
The [TFRobertaModel](docs/transformers/:version/:language/model_doc/roberta.html#transformers.TFRobertaModel) forward method, overrides the `__call__` special method.
...
elements depending on the configuration ([RobertaConfig](docs/transformers/:version/:language/model_doc/roberta.html#transformers.RobertaConfig)) and inputs.
...
<a id='transformers.TFRobertaForCausalLM'></a>
> **class transformers.TFRobertaForCausalLM**(*args, **kwargs)

<a id='transformers.TFRobertaForCausalLM.call'></a>
...
The [TFRobertaForCausalLM](docs/transformers/:version/:language/model_doc/roberta.html#transformers.TFRobertaForCausalLM) forward method, overrides the `__call__` special method.
...
The [TFRobertaForMaskedLM](docs/transformers/:version/:language/model_doc/roberta.html#transformers.TFRobertaForMaskedLM) forward method, overrides the `__call__` special method.
...
The [TFRobertaForSequenceClassification](docs/transformers/:version/:language/model_doc/roberta.html#transformers.TFRobertaForSequenceClassification) forward method, overrides the `__call__` special method.
...
The [TFRobertaForMultipleChoice](docs/transformers/:version/:language/model_doc/roberta.html#transformers.TFRobertaForMultipleChoice) forward method, overrides the `__call__` special method.
...
The [TFRobertaForTokenClassification](docs/transformers/:version/:language/model_doc/roberta.html#transformers.TFRobertaForTokenClassification) forward method, overrides the `__call__` special method.
...
The [TFRobertaForQuestionAnswering](docs/transformers/:version/:language/model_doc/roberta.html#transformers.TFRobertaForQuestionAnswering) forward method, overrides the `__call__` special method.
