...
- An example of how to train [BartForConditionalGeneration](docs/transformers/:version/:language/model_doc/bart.html#transformers.BartForConditionalGeneration) with a Hugging Face `datasets`
...
- Bart doesn't use `token_type_ids` for sequence classification. Use [BartTokenizer](docs/transformers/:version/:language/model_doc/bart.html#transformers.BartTokenizer) or
  [encode()](docs/transformers/:version/:language/internal/tokenization_utils.html#transformers.PreTrainedTokenizerBase.encode) to get the proper splitting.
- The forward pass of [BartModel](docs/transformers/:version/:language/model_doc/bart.html#transformers.BartModel) will create the `decoder_input_ids` if they are not passed.
...
- [generate()](docs/transformers/:version/:language/main_classes/model.html#transformers.generation_utils.GenerationMixin.generate) should be used for conditional generation tasks like
...
This is the configuration class to store the configuration of a [BartModel](docs/transformers/:version/:language/model_doc/bart.html#transformers.BartModel). It is used to
...
- **vocab_size** (`int`, _optional_, defaults to 50265) --
  ...
  `inputs_ids` passed when calling [BartModel](docs/transformers/:version/:language/model_doc/bart.html#transformers.BartModel) or
  [TFBartModel](docs/transformers/:version/:language/model_doc/bart.html#transformers.TFBartModel).
...
- **use_cache** (`bool`, _optional_, defaults to `True`) --
  ...
  The number of labels to use in [BartForSequenceClassification](docs/transformers/:version/:language/model_doc/bart.html#transformers.BartForSequenceClassification).
...
[BartTokenizer](docs/transformers/:version/:language/model_doc/bart.html#transformers.BartTokenizer) is identical to [RobertaTokenizer](docs/transformers/:version/:language/model_doc/roberta.html#transformers.RobertaTokenizer). Refer to superclass
[RobertaTokenizer](docs/transformers/:version/:language/model_doc/roberta.html#transformers.RobertaTokenizer) for usage examples and documentation concerning the initialization
...
[BartTokenizerFast](docs/transformers/:version/:language/model_doc/bart.html#transformers.BartTokenizerFast) is identical to [RobertaTokenizerFast](docs/transformers/:version/:language/model_doc/roberta.html#transformers.RobertaTokenizerFast). Refer to
superclass [RobertaTokenizerFast](docs/transformers/:version/:language/model_doc/roberta.html#transformers.RobertaTokenizerFast) for usage examples and documentation concerning the
...
- **config** ([BartConfig](docs/transformers/:version/:language/model_doc/bart.html#transformers.BartConfig)) --
...
The [BartModel](docs/transformers/:version/:language/model_doc/bart.html#transformers.BartModel) forward method, overrides the `__call__` special method.
...
- **input_ids** (`torch.LongTensor` of shape `(batch_size, sequence_length)`) --
  ...
  Indices can be obtained using [BartTokenizer](docs/transformers/:version/:language/model_doc/bart.html#transformers.BartTokenizer). See
...
various elements depending on the configuration ([BartConfig](docs/transformers/:version/:language/model_doc/bart.html#transformers.BartConfig)) and inputs.
...
The [BartForConditionalGeneration](docs/transformers/:version/:language/model_doc/bart.html#transformers.BartForConditionalGeneration) forward method, overrides the `__call__` special method.
...
The [BartForSequenceClassification](docs/transformers/:version/:language/model_doc/bart.html#transformers.BartForSequenceClassification) forward method, overrides the `__call__` special method.
...
The [BartForQuestionAnswering](docs/transformers/:version/:language/model_doc/bart.html#transformers.BartForQuestionAnswering) forward method, overrides the `__call__` special method.
...
- **config** ([BartConfig](docs/transformers/:version/:language/model_doc/bart.html#transformers.BartConfig)) -- Model configuration class with all the parameters of the model.
...
The [TFBartModel](docs/transformers/:version/:language/model_doc/bart.html#transformers.TFBartModel) forward method, overrides the `__call__` special method.
...
elements depending on the configuration ([BartConfig](docs/transformers/:version/:language/model_doc/bart.html#transformers.BartConfig)) and inputs.
...
The [TFBartForConditionalGeneration](docs/transformers/:version/:language/model_doc/bart.html#transformers.TFBartForConditionalGeneration) forward method, overrides the `__call__` special method.
...
A [FlaxSeq2SeqSequenceClassifierOutput](docs/transformers/:version/:language/main_classes/output.html#transformers.modeling_flax_outputs.FlaxSeq2SeqSequenceClassifierOutput) or a tuple of
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising
various elements depending on the configuration ([BartConfig](docs/transformers/:version/:language/model_doc/bart.html#transformers.BartConfig)) and inputs.
...
[FlaxSeq2SeqSequenceClassifierOutput](docs/transformers/:version/:language/main_classes/output.html#transformers.modeling_flax_outputs.FlaxSeq2SeqSequenceClassifierOutput) or `tuple(torch.FloatTensor)`
...
A [FlaxSeq2SeqQuestionAnsweringModelOutput](docs/transformers/:version/:language/main_classes/output.html#transformers.modeling_flax_outputs.FlaxSeq2SeqQuestionAnsweringModelOutput) or a tuple of
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising
various elements depending on the configuration ([BartConfig](docs/transformers/:version/:language/model_doc/bart.html#transformers.BartConfig)) and inputs.
...
[FlaxSeq2SeqQuestionAnsweringModelOutput](docs/transformers/:version/:language/main_classes/output.html#transformers.modeling_flax_outputs.FlaxSeq2SeqQuestionAnsweringModelOutput) or `tuple(torch.FloatTensor)`
