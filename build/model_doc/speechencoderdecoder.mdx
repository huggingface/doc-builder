...
sections:
- local: speechencoderdecoderconfig
  title: SpeechEncoderDecoderConfig
- local: speechencoderdecodermodel
...
# [Speech Encoder Decoder Models](#speech-encoder-decoder-models)

The [SpeechEncoderDecoderModel](/docs/transformers/master/en/model_doc/speechencoderdecoder.html#transformers.SpeechEncoderDecoderModel) can be used to initialize a speech-sequence-to-text-sequence model
with any pretrained speech autoencoding model as the encoder (*e.g.* [Wav2Vec2](/docs/transformers/master/en/wav2vec2.html), [Hubert](/docs/transformers/master/en/hubert.html)) and any pretrained autoregressive model as the decoder.
...
An example of how to use a [SpeechEncoderDecoderModel](/docs/transformers/master/en/model_doc/speechencoderdecoder.html#transformers.SpeechEncoderDecoderModel) for inference can be seen in
[Speech2Text2](/docs/transformers/master/en/speech_to_text_2.html).
...
[SpeechEncoderDecoderConfig](/docs/transformers/master/en/model_doc/speechencoderdecoder.html#transformers.SpeechEncoderDecoderConfig) is the configuration class to store the configuration of a
[SpeechEncoderDecoderModel](/docs/transformers/master/en/model_doc/speechencoderdecoder.html#transformers.SpeechEncoderDecoderModel). It is used to instantiate an Encoder Decoder model according to
...
Instantiate a [SpeechEncoderDecoderConfig](/docs/transformers/master/en/model_doc/speechencoderdecoder.html#transformers.SpeechEncoderDecoderConfig) (or a derived class) from a pre-trained encoder
...
[SpeechEncoderDecoderConfig](/docs/transformers/master/en/model_doc/speechencoderdecoder.html#transformers.SpeechEncoderDecoderConfig)
...
- **config** ([SpeechEncoderDecoderConfig](/docs/transformers/master/en/model_doc/speechencoderdecoder.html#transformers.SpeechEncoderDecoderConfig)) -- Model configuration class with all the parameters of the model.
  ...
  [SpeechEncoderDecoderModel](/docs/transformers/master/en/model_doc/speechencoderdecoder.html#transformers.SpeechEncoderDecoderModel) is a generic model class that will be instantiated as a
...
The [SpeechEncoderDecoderModel](/docs/transformers/master/en/model_doc/speechencoderdecoder.html#transformers.SpeechEncoderDecoderModel) forward method, overrides the `__call__` special method.
...
various elements depending on the configuration ([SpeechEncoderDecoderConfig](/docs/transformers/master/en/model_doc/speechencoderdecoder.html#transformers.SpeechEncoderDecoderConfig)) and inputs.
