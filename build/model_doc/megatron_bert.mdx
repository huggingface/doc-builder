...
This is the configuration class to store the configuration of a [MegatronBertModel](docs/transformers/:version/:language/model_doc/megatron_bert.html#transformers.MegatronBertModel). It is
...
- **vocab_size** (`int`, _optional_, defaults to 29056) --
  ...
  by the `inputs_ids` passed when calling [MegatronBertModel](docs/transformers/:version/:language/model_doc/megatron_bert.html#transformers.MegatronBertModel).
...
- **type_vocab_size** (`int`, _optional_, defaults to 2) --
  ...
  [MegatronBertModel](docs/transformers/:version/:language/model_doc/megatron_bert.html#transformers.MegatronBertModel).
...
- **config** ([MegatronBertConfig](docs/transformers/:version/:language/model_doc/megatron_bert.html#transformers.MegatronBertConfig)) -- Model configuration class with all the parameters of the model.
...
The [MegatronBertModel](docs/transformers/:version/:language/model_doc/megatron_bert.html#transformers.MegatronBertModel) forward method, overrides the `__call__` special method.
...
various elements depending on the configuration ([MegatronBertConfig](docs/transformers/:version/:language/model_doc/megatron_bert.html#transformers.MegatronBertConfig)) and inputs.
...
The [MegatronBertForMaskedLM](docs/transformers/:version/:language/model_doc/megatron_bert.html#transformers.MegatronBertForMaskedLM) forward method, overrides the `__call__` special method.
...
The [MegatronBertForCausalLM](docs/transformers/:version/:language/model_doc/megatron_bert.html#transformers.MegatronBertForCausalLM) forward method, overrides the `__call__` special method.
...
The [MegatronBertForNextSentencePrediction](docs/transformers/:version/:language/model_doc/megatron_bert.html#transformers.MegatronBertForNextSentencePrediction) forward method, overrides the `__call__` special method.
...
The [MegatronBertForPreTraining](docs/transformers/:version/:language/model_doc/megatron_bert.html#transformers.MegatronBertForPreTraining) forward method, overrides the `__call__` special method.
...
The [MegatronBertForSequenceClassification](docs/transformers/:version/:language/model_doc/megatron_bert.html#transformers.MegatronBertForSequenceClassification) forward method, overrides the `__call__` special method.
...
The [MegatronBertForMultipleChoice](docs/transformers/:version/:language/model_doc/megatron_bert.html#transformers.MegatronBertForMultipleChoice) forward method, overrides the `__call__` special method.
...
The [MegatronBertForTokenClassification](docs/transformers/:version/:language/model_doc/megatron_bert.html#transformers.MegatronBertForTokenClassification) forward method, overrides the `__call__` special method.
...
The [MegatronBertForQuestionAnswering](docs/transformers/:version/:language/model_doc/megatron_bert.html#transformers.MegatronBertForQuestionAnswering) forward method, overrides the `__call__` special method.
