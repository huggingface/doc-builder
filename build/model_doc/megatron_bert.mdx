...
> `megatron_bert_345m_v0_1_&lcubcased, uncased}.zip` and that the commands are run from inside that folder:
...
This is the configuration class to store the configuration of a [MegatronBertModel](model_doc/megatron_bert.html#transformers.MegatronBertModel). It is
...
- **vocab_size** (`int`, _optional_, defaults to 29056) --
  ...
  by the `inputs_ids` passed when calling [MegatronBertModel](model_doc/megatron_bert.html#transformers.MegatronBertModel).
...
- **type_vocab_size** (`int`, _optional_, defaults to 2) --
  ...
  [MegatronBertModel](model_doc/megatron_bert.html#transformers.MegatronBertModel).
...
- **config** ([MegatronBertConfig](model_doc/megatron_bert.html#transformers.MegatronBertConfig)) -- Model configuration class with all the parameters of the model.
...
The [MegatronBertModel](model_doc/megatron_bert.html#transformers.MegatronBertModel) forward method, overrides the `__call__` special method.
...
various elements depending on the configuration ([MegatronBertConfig](model_doc/megatron_bert.html#transformers.MegatronBertConfig)) and inputs.
...
The [MegatronBertForMaskedLM](model_doc/megatron_bert.html#transformers.MegatronBertForMaskedLM) forward method, overrides the `__call__` special method.
...
The [MegatronBertForCausalLM](model_doc/megatron_bert.html#transformers.MegatronBertForCausalLM) forward method, overrides the `__call__` special method.
...
The [MegatronBertForNextSentencePrediction](model_doc/megatron_bert.html#transformers.MegatronBertForNextSentencePrediction) forward method, overrides the `__call__` special method.
...
The [MegatronBertForPreTraining](model_doc/megatron_bert.html#transformers.MegatronBertForPreTraining) forward method, overrides the `__call__` special method.
...
The [MegatronBertForSequenceClassification](model_doc/megatron_bert.html#transformers.MegatronBertForSequenceClassification) forward method, overrides the `__call__` special method.
...
The [MegatronBertForMultipleChoice](model_doc/megatron_bert.html#transformers.MegatronBertForMultipleChoice) forward method, overrides the `__call__` special method.
...
The [MegatronBertForTokenClassification](model_doc/megatron_bert.html#transformers.MegatronBertForTokenClassification) forward method, overrides the `__call__` special method.
...
The [MegatronBertForQuestionAnswering](model_doc/megatron_bert.html#transformers.MegatronBertForQuestionAnswering) forward method, overrides the `__call__` special method.
