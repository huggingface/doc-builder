...
This is the configuration class to store the configuration of a [Wav2Vec2Model](/docs/transformers/master/en/model_doc/wav2vec2.html#transformers.Wav2Vec2Model). It is used to
...
- **vocab_size** (`int`, _optional_, defaults to 32) --
  ...
  the `inputs_ids` passed when calling [Wav2Vec2Model](/docs/transformers/master/en/model_doc/wav2vec2.html#transformers.Wav2Vec2Model) or
  [TFWav2Vec2Model](/docs/transformers/master/en/model_doc/wav2vec2.html#transformers.TFWav2Vec2Model). Vocabulary size of the model. Defines the different tokens that can
  be represented by the _inputs_ids_ passed to the forward method of [Wav2Vec2Model](/docs/transformers/master/en/model_doc/wav2vec2.html#transformers.Wav2Vec2Model).
...
- **ctc_loss_reduction** (`str`, _optional_, defaults to `"sum"`) --
  ...
  instance of [Wav2Vec2ForCTC](/docs/transformers/master/en/model_doc/wav2vec2.html#transformers.Wav2Vec2ForCTC).
...
## [Wav2Vec2CTCTokenizer](#wavvecctctokenizer)
...
## [Wav2Vec2FeatureExtractor](#wavvecfeatureextractor)
...
[SequenceFeatureExtractor](/docs/transformers/master/en/main_classes/feature_extractor.html#transformers.SequenceFeatureExtractor) which contains most of the main
...
- **return_attention_mask** (`bool`, _optional_, defaults to `False`) --
  Whether or not [__call__()](/docs/transformers/master/en/model_doc/wav2vec2.html#transformers.Wav2Vec2FeatureExtractor.__call__) should return `attention_mask`.
...
## [Wav2Vec2Processor](#wavvecprocessor)
...
[Wav2Vec2Processor](/docs/transformers/master/en/model_doc/wav2vec2.html#transformers.Wav2Vec2Processor) offers all the functionalities of
[Wav2Vec2FeatureExtractor](/docs/transformers/master/en/model_doc/wav2vec2.html#transformers.Wav2Vec2FeatureExtractor) and [Wav2Vec2CTCTokenizer](/docs/transformers/master/en/model_doc/wav2vec2.html#transformers.Wav2Vec2CTCTokenizer). See the docstring
of [__call__()](/docs/transformers/master/en/model_doc/wav2vec2.html#transformers.Wav2Vec2Processor.__call__) and [decode()](/docs/transformers/master/en/model_doc/wav2vec2.html#transformers.Wav2Vec2Processor.decode) for more
information.

> Parameters

- **feature_extractor** (`Wav2Vec2FeatureExtractor`) --
  An instance of [Wav2Vec2FeatureExtractor](/docs/transformers/master/en/model_doc/wav2vec2.html#transformers.Wav2Vec2FeatureExtractor). The feature extractor is a required input.
- **tokenizer** (`Wav2Vec2CTCTokenizer`) --
  An instance of [Wav2Vec2CTCTokenizer](/docs/transformers/master/en/model_doc/wav2vec2.html#transformers.Wav2Vec2CTCTokenizer). The tokenizer is a required input.
...
[__call__()](/docs/transformers/master/en/model_doc/wav2vec2.html#transformers.Wav2Vec2FeatureExtractor.__call__) and returns its output. If used in the context
[as_target_processor()](/docs/transformers/master/en/model_doc/wav2vec2.html#transformers.Wav2Vec2Processor.as_target_processor) this method forwards all its arguments to
Wav2Vec2CTCTokenizer's [__call__()](/docs/transformers/master/en/internal/tokenization_utils.html#transformers.PreTrainedTokenizerBase.__call__). Please refer to the docstring of
...
When used in normal mode, this method forwards all its arguments to Wav2Vec2FeatureExtractor's
[pad()](/docs/transformers/master/en/main_classes/feature_extractor.html#transformers.SequenceFeatureExtractor.pad) and returns its output. If used in the context
[as_target_processor()](/docs/transformers/master/en/model_doc/wav2vec2.html#transformers.Wav2Vec2Processor.as_target_processor) this method forwards all its arguments to
Wav2Vec2CTCTokenizer's [pad()](/docs/transformers/master/en/internal/tokenization_utils.html#transformers.PreTrainedTokenizerBase.pad). Please refer to the docstring of the
...
Instantiate a [Wav2Vec2Processor](/docs/transformers/master/en/model_doc/wav2vec2.html#transformers.Wav2Vec2Processor) from a pretrained Wav2Vec2 processor.

<Tip>

This class method is simply calling Wav2Vec2FeatureExtractor's
[from_pretrained()](/docs/transformers/master/en/main_classes/feature_extractor.html#transformers.feature_extraction_utils.FeatureExtractionMixin.from_pretrained) and
...
**kwargs --
Additional keyword arguments passed along to both [SequenceFeatureExtractor](/docs/transformers/master/en/main_classes/feature_extractor.html#transformers.SequenceFeatureExtractor) and
...
that it can be re-loaded using the [from_pretrained()](/docs/transformers/master/en/model_doc/wav2vec2.html#transformers.Wav2Vec2Processor.from_pretrained) class method.

<Tip>

This class method is simply calling
[save_pretrained()](/docs/transformers/master/en/main_classes/feature_extractor.html#transformers.feature_extraction_utils.FeatureExtractionMixin.save_pretrained) and
...
## [Wav2Vec2 specific outputs](#wavvec-specific-outputs)
...
- **config** ([Wav2Vec2Config](/docs/transformers/master/en/model_doc/wav2vec2.html#transformers.Wav2Vec2Config)) -- Model configuration class with all the parameters of the model.
...
The [Wav2Vec2Model](/docs/transformers/master/en/model_doc/wav2vec2.html#transformers.Wav2Vec2Model) forward method, overrides the `__call__` special method.
...
various elements depending on the configuration ([Wav2Vec2Config](/docs/transformers/master/en/model_doc/wav2vec2.html#transformers.Wav2Vec2Config)) and inputs.
...
The [Wav2Vec2ForCTC](/docs/transformers/master/en/model_doc/wav2vec2.html#transformers.Wav2Vec2ForCTC) forward method, overrides the `__call__` special method.
...
## [Wav2Vec2ForSequenceClassification](#wavvecforsequenceclassification)
...
The [Wav2Vec2ForSequenceClassification](/docs/transformers/master/en/model_doc/wav2vec2.html#transformers.Wav2Vec2ForSequenceClassification) forward method, overrides the `__call__` special method.
...
## [Wav2Vec2ForPreTraining](#wavvecforpretraining)
...
The [Wav2Vec2ForPreTraining](/docs/transformers/master/en/model_doc/wav2vec2.html#transformers.Wav2Vec2ForPreTraining) forward method, overrides the `__call__` special method.
...
A [Wav2Vec2ForPreTrainingOutput](/docs/transformers/master/en/model_doc/wav2vec2.html#transformers.models.wav2vec2.modeling_wav2vec2.Wav2Vec2ForPreTrainingOutput) or a tuple of
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising
various elements depending on the configuration ([Wav2Vec2Config](/docs/transformers/master/en/model_doc/wav2vec2.html#transformers.Wav2Vec2Config)) and inputs.
...
[Wav2Vec2ForPreTrainingOutput](/docs/transformers/master/en/model_doc/wav2vec2.html#transformers.models.wav2vec2.modeling_wav2vec2.Wav2Vec2ForPreTrainingOutput) or `tuple(torch.FloatTensor)`


## [TFWav2Vec2Model](#tfwavvecmodel)
...
The [TFWav2Vec2Model](/docs/transformers/master/en/model_doc/wav2vec2.html#transformers.TFWav2Vec2Model) forward method, overrides the `__call__` special method.
...
elements depending on the configuration ([Wav2Vec2Config](/docs/transformers/master/en/model_doc/wav2vec2.html#transformers.Wav2Vec2Config)) and inputs.
...
## [TFWav2Vec2ForCTC](#tfwavvecforctc)
...
The [TFWav2Vec2ForCTC](/docs/transformers/master/en/model_doc/wav2vec2.html#transformers.TFWav2Vec2ForCTC) forward method, overrides the `__call__` special method.
...
## [FlaxWav2Vec2Model](#flaxwavvecmodel)
...
A [FlaxWav2Vec2BaseModelOutput](/docs/transformers/master/en/model_doc/wav2vec2.html#transformers.models.wav2vec2.modeling_flax_wav2vec2.FlaxWav2Vec2BaseModelOutput) or a tuple of
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising
...
[FlaxWav2Vec2BaseModelOutput](/docs/transformers/master/en/model_doc/wav2vec2.html#transformers.models.wav2vec2.modeling_flax_wav2vec2.FlaxWav2Vec2BaseModelOutput) or `tuple(torch.FloatTensor)`
...
## [FlaxWav2Vec2ForCTC](#flaxwavvecforctc)
...
## [FlaxWav2Vec2ForPreTraining](#flaxwavvecforpretraining)
...
The [FlaxWav2Vec2ForPreTraining](/docs/transformers/master/en/model_doc/wav2vec2.html#transformers.FlaxWav2Vec2ForPreTraining) forward method, overrides the `__call__` special method.
...
A [FlaxWav2Vec2ForPreTrainingOutput](/docs/transformers/master/en/model_doc/wav2vec2.html#transformers.models.wav2vec2.modeling_flax_wav2vec2.FlaxWav2Vec2ForPreTrainingOutput) or a tuple of
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising
various elements depending on the configuration (`Wav2Vec2Config'>`) and inputs.
...
[FlaxWav2Vec2ForPreTrainingOutput](/docs/transformers/master/en/model_doc/wav2vec2.html#transformers.models.wav2vec2.modeling_flax_wav2vec2.FlaxWav2Vec2ForPreTrainingOutput) or `tuple(torch.FloatTensor)`
