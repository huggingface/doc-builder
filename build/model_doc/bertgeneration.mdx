...
[EncoderDecoderModel](docs/transformers/:version/:language/model_doc/encoderdecoder.html#transformers.EncoderDecoderModel) as proposed in [Leveraging Pre-trained Checkpoints for Sequence Generation
...
- The model can be used in combination with the [EncoderDecoderModel](docs/transformers/:version/:language/model_doc/encoderdecoder.html#transformers.EncoderDecoderModel) to leverage two pretrained
...
- Pretrained [EncoderDecoderModel](docs/transformers/:version/:language/model_doc/encoderdecoder.html#transformers.EncoderDecoderModel) are also directly available in the model hub, e.g.,
...
- [BertGenerationEncoder](docs/transformers/:version/:language/model_doc/bertgeneration.html#transformers.BertGenerationEncoder) and [BertGenerationDecoder](docs/transformers/:version/:language/model_doc/bertgeneration.html#transformers.BertGenerationDecoder) should be used in
...
- **config** ([BertGenerationConfig](docs/transformers/:version/:language/model_doc/bertgeneration.html#transformers.BertGenerationConfig)) -- Model configuration class with all the parameters of the model.
  ...
  [EncoderDecoderModel](docs/transformers/:version/:language/model_doc/encoderdecoder.html#transformers.EncoderDecoderModel) class as described in [Leveraging Pre-trained Checkpoints for Sequence
...
The [BertGenerationEncoder](docs/transformers/:version/:language/model_doc/bertgeneration.html#transformers.BertGenerationEncoder) forward method, overrides the `__call__` special method.
...
- **input_ids** (`torch.LongTensor` of shape `(batch_size, sequence_length)`) --
  ...
  Indices can be obtained using [BertGenerationTokenizer](docs/transformers/:version/:language/model_doc/bertgeneration.html#transformers.BertGenerationTokenizer). See
...
various elements depending on the configuration ([BertGenerationConfig](docs/transformers/:version/:language/model_doc/bertgeneration.html#transformers.BertGenerationConfig)) and inputs.
...
The [BertGenerationDecoder](docs/transformers/:version/:language/model_doc/bertgeneration.html#transformers.BertGenerationDecoder) forward method, overrides the `__call__` special method.
