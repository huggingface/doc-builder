...
- local: overview
  title: Overview
- local: bertgenerationconfig
  title: BertGenerationConfig
- local: bertgenerationtokenizer
  title: BertGenerationTokenizer
- local: bertgenerationencoder
  title: BertGenerationEncoder
- local: bertgenerationdecoder
...
# [BertGeneration](#bertgeneration)

## [Overview](#overview)

The BertGeneration model is a BERT model that can be leveraged for sequence-to-sequence tasks using
[EncoderDecoderModel](/docs/transformers/master/en/model_doc/encoderdecoder.html#transformers.EncoderDecoderModel) as proposed in [Leveraging Pre-trained Checkpoints for Sequence Generation
...
- The model can be used in combination with the [EncoderDecoderModel](/docs/transformers/master/en/model_doc/encoderdecoder.html#transformers.EncoderDecoderModel) to leverage two pretrained
...
- Pretrained [EncoderDecoderModel](/docs/transformers/master/en/model_doc/encoderdecoder.html#transformers.EncoderDecoderModel) are also directly available in the model hub, e.g.,
...
- [BertGenerationEncoder](/docs/transformers/master/en/model_doc/bertgeneration.html#transformers.BertGenerationEncoder) and [BertGenerationDecoder](/docs/transformers/master/en/model_doc/bertgeneration.html#transformers.BertGenerationDecoder) should be used in
...
## [BertGenerationTokenizer](#bertgenerationtokenizer)
...
- **config** ([BertGenerationConfig](/docs/transformers/master/en/model_doc/bertgeneration.html#transformers.BertGenerationConfig)) -- Model configuration class with all the parameters of the model.
  ...
  [EncoderDecoderModel](/docs/transformers/master/en/model_doc/encoderdecoder.html#transformers.EncoderDecoderModel) class as described in [Leveraging Pre-trained Checkpoints for Sequence
...
The [BertGenerationEncoder](/docs/transformers/master/en/model_doc/bertgeneration.html#transformers.BertGenerationEncoder) forward method, overrides the `__call__` special method.
...
- **input_ids** (`torch.LongTensor` of shape `(batch_size, sequence_length)`) --
  ...
  Indices can be obtained using [BertGenerationTokenizer](/docs/transformers/master/en/model_doc/bertgeneration.html#transformers.BertGenerationTokenizer). See
...
various elements depending on the configuration ([BertGenerationConfig](/docs/transformers/master/en/model_doc/bertgeneration.html#transformers.BertGenerationConfig)) and inputs.
...
The [BertGenerationDecoder](/docs/transformers/master/en/model_doc/bertgeneration.html#transformers.BertGenerationDecoder) forward method, overrides the `__call__` special method.
