...
The [generate()](docs/transformers/:version/:language/main_classes/model.html#transformers.generation_utils.GenerationMixin.generate) method can be used to generate text using GPT-J
model.
...
This is the configuration class to store the configuration of a [GPTJModel](docs/transformers/:version/:language/model_doc/gptj.html#transformers.GPTJModel). It is used to
...
- **vocab_size** (`int`, _optional_, defaults to 50400) --
  ...
  `inputs_ids` passed when calling [GPTJModel](docs/transformers/:version/:language/model_doc/gptj.html#transformers.GPTJModel).
...
- **config** ([GPTJConfig](docs/transformers/:version/:language/model_doc/gptj.html#transformers.GPTJConfig)) -- Model configuration class with all the parameters of the model.
...
The [GPTJModel](docs/transformers/:version/:language/model_doc/gptj.html#transformers.GPTJModel) forward method, overrides the `__call__` special method.
...
various elements depending on the configuration ([GPTJConfig](docs/transformers/:version/:language/model_doc/gptj.html#transformers.GPTJConfig)) and inputs.
...
The [GPTJForCausalLM](docs/transformers/:version/:language/model_doc/gptj.html#transformers.GPTJForCausalLM) forward method, overrides the `__call__` special method.
...
[GPTJForSequenceClassification](docs/transformers/:version/:language/model_doc/gptj.html#transformers.GPTJForSequenceClassification) uses the last token in order to do the classification, as
...
The [GPTJForSequenceClassification](docs/transformers/:version/:language/model_doc/gptj.html#transformers.GPTJForSequenceClassification) forward method, overrides the `__call__` special method.
