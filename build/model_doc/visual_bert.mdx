...
- local: usage
  title: Usage
- local: visualbertconfig
  title: VisualBertConfig
- local: visualbertmodel
  title: VisualBertModel
- local: visualbertforpretraining
  title: VisualBertForPreTraining
- local: visualbertforquestionanswering
  title: VisualBertForQuestionAnswering
- local: visualbertformultiplechoice
  title: VisualBertForMultipleChoice
- local: visualbertforvisualreasoning
  title: VisualBertForVisualReasoning
- local: visualbertforregiontophrasealignment
...
1. Most of the checkpoints provided work with the [VisualBertForPreTraining](/docs/transformers/master/en/model_doc/visual_bert.html#transformers.VisualBertForPreTraining) configuration. Other
...
The [BertTokenizer](/docs/transformers/master/en/model_doc/bert.html#transformers.BertTokenizer) is used to encode the text. A custom detector/feature extractor must be used
...
The following example shows how to get the last hidden state using [VisualBertModel](/docs/transformers/master/en/model_doc/visual_bert.html#transformers.VisualBertModel):
...
This is the configuration class to store the configuration of a [VisualBertModel](/docs/transformers/master/en/model_doc/visual_bert.html#transformers.VisualBertModel). It is used
...
- **vocab_size** (`int`, _optional_, defaults to 30522) --
  ...
  the `inputs_ids` passed when calling [VisualBertModel](/docs/transformers/master/en/model_doc/visual_bert.html#transformers.VisualBertModel). Vocabulary size of the
  model. Defines the different tokens that can be represented by the `inputs_ids` passed to the forward
  method of [VisualBertModel](/docs/transformers/master/en/model_doc/visual_bert.html#transformers.VisualBertModel).
...
- **type_vocab_size** (`int`, _optional_, defaults to 2) --
  ...
  [VisualBertModel](/docs/transformers/master/en/model_doc/visual_bert.html#transformers.VisualBertModel).
...
## [VisualBertModel](#visualbertmodel)
...
- **config** ([VisualBertConfig](/docs/transformers/master/en/model_doc/visual_bert.html#transformers.VisualBertConfig)) -- Model configuration class with all the parameters of the model.
...
The [VisualBertModel](/docs/transformers/master/en/model_doc/visual_bert.html#transformers.VisualBertModel) forward method, overrides the `__call__` special method.
...
The [VisualBertForPreTraining](/docs/transformers/master/en/model_doc/visual_bert.html#transformers.VisualBertForPreTraining) forward method, overrides the `__call__` special method.
...
various elements depending on the configuration ([VisualBertConfig](/docs/transformers/master/en/model_doc/visual_bert.html#transformers.VisualBertConfig)) and inputs.
...
The [VisualBertForQuestionAnswering](/docs/transformers/master/en/model_doc/visual_bert.html#transformers.VisualBertForQuestionAnswering) forward method, overrides the `__call__` special method.
...
The [VisualBertForMultipleChoice](/docs/transformers/master/en/model_doc/visual_bert.html#transformers.VisualBertForMultipleChoice) forward method, overrides the `__call__` special method.
...
The [VisualBertForVisualReasoning](/docs/transformers/master/en/model_doc/visual_bert.html#transformers.VisualBertForVisualReasoning) forward method, overrides the `__call__` special method.
...
## [VisualBertForRegionToPhraseAlignment](#visualbertforregiontophrasealignment)
...
The [VisualBertForRegionToPhraseAlignment](/docs/transformers/master/en/model_doc/visual_bert.html#transformers.VisualBertForRegionToPhraseAlignment) forward method, overrides the `__call__` special method.
