...
- This implementation is the same as [RobertaModel](docs/transformers/:version/:language/model_doc/roberta.html#transformers.RobertaModel) with the addition of entity embeddings as well
...
- LUKE treats entities as input tokens; therefore, it takes `entity_ids`, `entity_attention_mask`,
  ...
  [LukeTokenizer](docs/transformers/:version/:language/model_doc/luke.html#transformers.LukeTokenizer).
- [LukeTokenizer](docs/transformers/:version/:language/model_doc/luke.html#transformers.LukeTokenizer) takes `entities` and `entity_spans` (character-based start and end
...
- There are three head models for the former use case:
  ...
  - [LukeForEntityClassification](docs/transformers/:version/:language/model_doc/luke.html#transformers.LukeForEntityClassification), for tasks to classify a single entity in an input text such as
  ...
  - [LukeForEntityPairClassification](docs/transformers/:version/:language/model_doc/luke.html#transformers.LukeForEntityPairClassification), for tasks to classify the relationship between two entities
  ...
  - [LukeForEntitySpanClassification](docs/transformers/:version/:language/model_doc/luke.html#transformers.LukeForEntitySpanClassification), for tasks to classify the sequence of entity spans, such as
    named entity recognition (NER). This model places a linear head on top of the output entity representations. You
    can address NER using this model by inputting all possible entity spans in the text to the model.

  [LukeTokenizer](docs/transformers/:version/:language/model_doc/luke.html#transformers.LukeTokenizer) has a `task` argument, which enables you to easily create an input to these
...
This is the configuration class to store the configuration of a [LukeModel](docs/transformers/:version/:language/model_doc/luke.html#transformers.LukeModel). It is used to
...
- **vocab_size** (`int`, _optional_, defaults to 30522) --
  ...
  `inputs_ids` passed when calling [LukeModel](docs/transformers/:version/:language/model_doc/luke.html#transformers.LukeModel).
- **entity_vocab_size** (`int`, _optional_, defaults to 500000) --
  ...
  by the `entity_ids` passed when calling [LukeModel](docs/transformers/:version/:language/model_doc/luke.html#transformers.LukeModel).
...
- **type_vocab_size** (`int`, _optional_, defaults to 2) --
  The vocabulary size of the `token_type_ids` passed when calling [LukeModel](docs/transformers/:version/:language/model_doc/luke.html#transformers.LukeModel).
...
This tokenizer inherits from [RobertaTokenizer](docs/transformers/:version/:language/model_doc/roberta.html#transformers.RobertaTokenizer) which contains most of the main methods. Users
should refer to this superclass for more information regarding those methods. Compared to
[RobertaTokenizer](docs/transformers/:version/:language/model_doc/roberta.html#transformers.RobertaTokenizer), [LukeTokenizer](docs/transformers/:version/:language/model_doc/luke.html#transformers.LukeTokenizer) also creates entity sequences, namely
...
- **config** ([LukeConfig](docs/transformers/:version/:language/model_doc/luke.html#transformers.LukeConfig)) -- Model configuration class with all the parameters of the
...
The [LukeModel](docs/transformers/:version/:language/model_doc/luke.html#transformers.LukeModel) forward method, overrides the `__call__` special method.
...
- **input_ids** (`torch.LongTensor` of shape `(batch_size, sequence_length)`) --
  ...
  Indices can be obtained using [LukeTokenizer](docs/transformers/:version/:language/model_doc/luke.html#transformers.LukeTokenizer). See
...
various elements depending on the configuration ([LukeConfig](docs/transformers/:version/:language/model_doc/luke.html#transformers.LukeConfig)) and inputs.
...
The [LukeForEntityClassification](docs/transformers/:version/:language/model_doc/luke.html#transformers.LukeForEntityClassification) forward method, overrides the `__call__` special method.
...
The [LukeForEntityPairClassification](docs/transformers/:version/:language/model_doc/luke.html#transformers.LukeForEntityPairClassification) forward method, overrides the `__call__` special method.
...
The [LukeForEntitySpanClassification](docs/transformers/:version/:language/model_doc/luke.html#transformers.LukeForEntitySpanClassification) forward method, overrides the `__call__` special method.
