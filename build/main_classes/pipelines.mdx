...
local: pipelines
sections:
- local: the-pipeline-abstraction
...
> **class transformers.TokenClassificationPipeline**(args_parser = &amp;lt;transformers.pipelines.token_classification.TokenClassificationArgumentHandler object at 0x1a62628b0>, *args, **kwargs)
...
> **class transformers.TableQuestionAnsweringPipeline**(args_parser = &amp;lt;transformers.pipelines.table_question_answering.TableQuestionAnsweringArgumentHandler object at 0x1a6247cd0>, *args, **kwargs)
...
### [Text2TextGenerationPipeline](#texttextgenerationpipeline)
...
> **class transformers.ZeroShotClassificationPipeline**(args_parser = &amp;lt;transformers.pipelines.zero_shot_classification.ZeroShotClassificationArgumentHandler object at 0x1a62701c0>, *args, **kwargs)
...
> **\_\_call\_\_**(self, sequences: typing.Union[str, typing.List[str]], **kwargs)
...
## [Parent class: `Pipeline`](#parent-class-pipeline)
