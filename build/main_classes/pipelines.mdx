...
- The other task-specific pipelines:
  ...
  - [ImageSegmentationPipeline](main_classes/pipelines.html#transformers.ImageSegmentationPipeline)
  - [ObjectDetectionPipeline](main_classes/pipelines.html#transformers.ObjectDetectionPipeline)
...
- **task** (`str`) --
  ...
  - `"audio-classification"`: will return a [AudioClassificationPipeline](main_classes/pipelines.html#transformers.AudioClassificationPipeline):.
  ...
  - `"image-classification"`: will return a [ImageClassificationPipeline](main_classes/pipelines.html#transformers.ImageClassificationPipeline):.
  ...
  - `"table-question-answering"`: will return a [TableQuestionAnsweringPipeline](main_classes/pipelines.html#transformers.TableQuestionAnsweringPipeline):.
  ...
  - `"token-classification"` (alias `"ner"` available): will return a
    [TokenClassificationPipeline](main_classes/pipelines.html#transformers.TokenClassificationPipeline):.
  - `"translation"`: will return a [TranslationPipeline](main_classes/pipelines.html#transformers.TranslationPipeline):.
...
[Implementing a new pipeline](../add_new_pipeline.html)
...
This image segmntation pipeline can currently be loaded from [pipeline()](main_classes/pipelines.html#transformers.pipeline) using the following
...
- **mask** (`str`) -- base64 string of a single-channel PNG image that contain masks information. The
...
> **class transformers.TokenClassificationPipeline**(args_parser = <transformers.pipelines.token_classification.TokenClassificationArgumentHandler object at 0x7f4af994d190>, *args, **kwargs)
...
This object detection pipeline can currently be loaded from [pipeline()](main_classes/pipelines.html#transformers.pipeline) using the following task
...
> **class transformers.TableQuestionAnsweringPipeline**(args_parser = <transformers.pipelines.table_question_answering.TableQuestionAnsweringArgumentHandler object at 0x7f4af99bd3d0>, *args, **kwargs)
...
> **class transformers.ZeroShotClassificationPipeline**(args_parser = <transformers.pipelines.zero_shot_classification.ZeroShotClassificationArgumentHandler object at 0x7f4af994de90>, *args, **kwargs)
