...
[task summary](../task_summary.html) for examples of use.

There are two categories of pipeline abstractions to be aware about:

- The [pipeline()](main_classes/pipelines.html#transformers.pipeline) which is the most powerful object encapsulating all other pipelines.
- The other task-specific pipelines:

  - [AudioClassificationPipeline](main_classes/pipelines.html#transformers.AudioClassificationPipeline)
  - [AutomaticSpeechRecognitionPipeline](main_classes/pipelines.html#transformers.AutomaticSpeechRecognitionPipeline)
  - [ConversationalPipeline](main_classes/pipelines.html#transformers.ConversationalPipeline)
  - [FeatureExtractionPipeline](main_classes/pipelines.html#transformers.FeatureExtractionPipeline)
  - [FillMaskPipeline](main_classes/pipelines.html#transformers.FillMaskPipeline)
  - [ImageClassificationPipeline](main_classes/pipelines.html#transformers.ImageClassificationPipeline)
  - [QuestionAnsweringPipeline](main_classes/pipelines.html#transformers.QuestionAnsweringPipeline)
  - [SummarizationPipeline](main_classes/pipelines.html#transformers.SummarizationPipeline)
  - [TableQuestionAnsweringPipeline](main_classes/pipelines.html#transformers.TableQuestionAnsweringPipeline)
  - [TextClassificationPipeline](main_classes/pipelines.html#transformers.TextClassificationPipeline)
  - [TextGenerationPipeline](main_classes/pipelines.html#transformers.TextGenerationPipeline)
  - [Text2TextGenerationPipeline](main_classes/pipelines.html#transformers.Text2TextGenerationPipeline)
  - [TokenClassificationPipeline](main_classes/pipelines.html#transformers.TokenClassificationPipeline)
  - [TranslationPipeline](main_classes/pipelines.html#transformers.TranslationPipeline)
  - [ZeroShotClassificationPipeline](main_classes/pipelines.html#transformers.ZeroShotClassificationPipeline)
...
- **task** (`str`) --
  ...
  - `"feature-extraction"`: will return a [FeatureExtractionPipeline](main_classes/pipelines.html#transformers.FeatureExtractionPipeline).
  - `"text-classification"`: will return a [TextClassificationPipeline](main_classes/pipelines.html#transformers.TextClassificationPipeline).
  - `"sentiment-analysis"`: (alias of `"text-classification"`) will return a
    [TextClassificationPipeline](main_classes/pipelines.html#transformers.TextClassificationPipeline).
  - `"token-classification"`: will return a [TokenClassificationPipeline](main_classes/pipelines.html#transformers.TokenClassificationPipeline).
  - `"ner"` (alias of `"token-classification"`): will return a
    [TokenClassificationPipeline](main_classes/pipelines.html#transformers.TokenClassificationPipeline).
  - `"question-answering"`: will return a [QuestionAnsweringPipeline](main_classes/pipelines.html#transformers.QuestionAnsweringPipeline).
  - `"fill-mask"`: will return a [FillMaskPipeline](main_classes/pipelines.html#transformers.FillMaskPipeline).
  - `"summarization"`: will return a [SummarizationPipeline](main_classes/pipelines.html#transformers.SummarizationPipeline).
  - `"translation_xx_to_yy"`: will return a [TranslationPipeline](main_classes/pipelines.html#transformers.TranslationPipeline).
  - `"text2text-generation"`: will return a [Text2TextGenerationPipeline](main_classes/pipelines.html#transformers.Text2TextGenerationPipeline).
  - `"text-generation"`: will return a [TextGenerationPipeline](main_classes/pipelines.html#transformers.TextGenerationPipeline).
  - `"zero-shot-classification:`: will return a [ZeroShotClassificationPipeline](main_classes/pipelines.html#transformers.ZeroShotClassificationPipeline).
  - `"conversational"`: will return a [ConversationalPipeline](main_classes/pipelines.html#transformers.ConversationalPipeline).
- **model** (`str` or `~transformers.PreTrainedModel` or `~transformers.TFPreTrainedModel`, _optional_) --
  The model that will be used by the pipeline to make predictions. This can be a model identifier or an
  actual instance of a pretrained model inheriting from [PreTrainedModel](main_classes/model.html#transformers.PreTrainedModel) (for PyTorch)
  or [TFPreTrainedModel](main_classes/model.html#transformers.TFPreTrainedModel) (for TensorFlow).
...
- **tokenizer** (`str` or `~transformers.PreTrainedTokenizer`, _optional_) --
  ...
  identifier or an actual pretrained tokenizer inheriting from [PreTrainedTokenizer](main_classes/tokenizer.html#transformers.PreTrainedTokenizer).
...
- **use_fast** (`bool`, _optional_, defaults to `True`) --
  Whether or not to use a Fast tokenizer if possible (a [PreTrainedTokenizerFast](main_classes/tokenizer.html#transformers.PreTrainedTokenizerFast)).
...
[Pipeline](main_classes/pipelines.html#transformers.Pipeline)
...
> **class transformers.AudioClassificationPipeline**(model: typing.Union[ForwardRef('PreTrainedModel'), ForwardRef('TFPreTrainedModel')], feature_extractor: ForwardRef('SequenceFeatureExtractor'), framework: typing.Optional[str] = None, **kwargs)
...
This pipeline can currently be loaded from [pipeline()](main_classes/pipelines.html#transformers.pipeline) using the following task identifier:
...
[PreTrainedModel](main_classes/model.html#transformers.PreTrainedModel) for PyTorch and [TFPreTrainedModel](main_classes/model.html#transformers.TFPreTrainedModel) for
TensorFlow.
...
args_parser ([ArgumentHandler](internal/pipelines_utils.html#transformers.pipelines.ArgumentHandler), _optional_):
...
> **\_\_call\_\_**(self, inputs: typing.Union[numpy.ndarray, bytes, str], top_k: typing.Optional[int] = None, **kwargs)
...
[ConversationalPipeline](main_classes/pipelines.html#transformers.ConversationalPipeline). The conversation contains a number of utility function to manage the
addition of new user input and generated model responses. A conversation needs to contain an unprocessed user input
before being passed to the [ConversationalPipeline](main_classes/pipelines.html#transformers.ConversationalPipeline). This user input is either created when
...
manually using the [add_user_input()](main_classes/pipelines.html#transformers.Conversation.add_user_input) method before the conversation can
begin.
...
> **class transformers.ConversationalPipeline**(min_length_for_response = 32, minimum_tokens = 10, *args, **kwargs)


Multi-turn conversational pipeline.

This conversational pipeline can currently be loaded from [pipeline()](main_classes/pipelines.html#transformers.pipeline) using the following task
...
> **\_\_call\_\_**(self, conversations: typing.Union[transformers.pipelines.conversational.Conversation, typing.List[transformers.pipelines.conversational.Conversation]], clean_up_tokenization_spaces = True, **generate_kwargs)
...
- **conversations** (a [Conversation](main_classes/pipelines.html#transformers.Conversation) or a list of [Conversation](main_classes/pipelines.html#transformers.Conversation)) --
...
[Conversation](main_classes/pipelines.html#transformers.Conversation) or a list of [Conversation](main_classes/pipelines.html#transformers.Conversation)


### FeatureExtractionPipeline

<a id='transformers.FeatureExtractionPipeline'></a>
> **class transformers.FeatureExtractionPipeline**(model: typing.Union[ForwardRef('PreTrainedModel'), ForwardRef('TFPreTrainedModel')], tokenizer: PreTrainedTokenizer, feature_extractor: typing.Optional[ForwardRef('SequenceFeatureExtractor')] = None, modelcard: typing.Optional[transformers.modelcard.ModelCard] = None, framework: typing.Optional[str] = None, args_parser: ArgumentHandler = None, device: int = -1, task: str = )


Feature extraction pipeline using no model head. This pipeline extracts the hidden states from the base
transformer, which can be used as features in downstream tasks.

This feature extraction pipeline can currently be loaded from [pipeline()](main_classes/pipelines.html#transformers.pipeline) using the task
...
> **class transformers.FillMaskPipeline**(model: typing.Union[ForwardRef('PreTrainedModel'), ForwardRef('TFPreTrainedModel')], tokenizer: PreTrainedTokenizer, modelcard: typing.Optional[transformers.modelcard.ModelCard] = None, framework: typing.Optional[str] = None, args_parser: ArgumentHandler = None, device: int = -1, top_k = 5, targets = None, task: str = )


Masked language modeling prediction pipeline using any `ModelWithLMHead`. See the [masked language modeling
examples](../task_summary.html#masked-language-modeling) for more information.

This mask filling pipeline can currently be loaded from [pipeline()](main_classes/pipelines.html#transformers.pipeline) using the following task
...
> **\_\_call\_\_**(self, inputs, *args, targets = None, top_k: typing.Optional[int] = None, **kwargs)
...
> **class transformers.ImageClassificationPipeline**(model: typing.Union[ForwardRef('PreTrainedModel'), ForwardRef('TFPreTrainedModel')], feature_extractor: ForwardRef('SequenceFeatureExtractor'), framework: typing.Optional[str] = None, **kwargs)


Image classification pipeline using any `AutoModelForImageClassification`. This pipeline predicts the class of
an image.

This image classification pipeline can currently be loaded from [pipeline()](main_classes/pipelines.html#transformers.pipeline) using the following
...
> **\_\_call\_\_**(self, images: typing.Union[str, typing.List[str], ForwardRef('Image'), typing.List[ForwardRef('Image')]], top_k = 5)
...
> **class transformers.TokenClassificationPipeline**(model: typing.Union[ForwardRef('PreTrainedModel'), ForwardRef('TFPreTrainedModel')], tokenizer: PreTrainedTokenizer, modelcard: typing.Optional[transformers.modelcard.ModelCard] = None, framework: typing.Optional[str] = None, args_parser: ArgumentHandler = &lcubtransformers.pipelines.token_classification.TokenClassificationArgumentHandler object at 0x7f37c161b950>, device: int = -1, binary_output: bool = False, ignore_labels = ['O'], task: str = , grouped_entities: typing.Optional[bool] = None, ignore_subwords: typing.Optional[bool] = None, aggregation_strategy: typing.Optional[transformers.pipelines.token_classification.AggregationStrategy] = None)


Named Entity Recognition pipeline using any `ModelForTokenClassification`. See the [named entity recognition
examples](../task_summary.html#named-entity-recognition) for more information.

This token recognition pipeline can currently be loaded from [pipeline()](main_classes/pipelines.html#transformers.pipeline) using the following
...
- "simple" : Will attempt to group entities following the default schema. (A, B-TAG), (B, I-TAG), (C,
  I-TAG), (D, B-TAG2) (E, B-TAG2) will end up being [&lcub"word": ABC, "entity": "TAG"&rcub, &lcub"word": "D",
  "entity": "TAG2"&rcub, &lcub"word": "E", "entity": "TAG2"&rcub] Notice that two consecutive B tags will end up as
  different entities. On word based languages, we might end up splitting words undesirably : Imagine
  Microsoft being tagged as [&lcub"word": "Micro", "entity": "ENTERPRISE"&rcub, &lcub"word": "soft", "entity":
  "NAME"&rcub]. Look for FIRST, MAX, AVERAGE for ways to mitigate that and disambiguate words (on languages
...
> **gather\_pre\_entities**(self, sentence: str, input_ids: ndarray, scores: ndarray, offset_mapping: typing.Union[typing.List[typing.Tuple[int, int]], NoneType], special_tokens_mask: ndarray)
...
See [TokenClassificationPipeline](main_classes/pipelines.html#transformers.TokenClassificationPipeline) for all details.
...
This question answering pipeline can currently be loaded from [pipeline()](main_classes/pipelines.html#transformers.pipeline) using the following
...
This summarizing pipeline can currently be loaded from [pipeline()](main_classes/pipelines.html#transformers.pipeline) using the following task
...
> **class transformers.TableQuestionAnsweringPipeline**(args_parser = &lcubtransformers.pipelines.table_question_answering.TableQuestionAnsweringArgumentHandler object at 0x7f37c1611450>, *args, **kwargs)


Table Question Answering pipeline using a `ModelForTableQuestionAnswering`. This pipeline is only available in
PyTorch.

This tabular question answering pipeline can currently be loaded from [pipeline()](main_classes/pipelines.html#transformers.pipeline) using the
...
- `pipeline(table=table, query=[query])`
- `pipeline(&lcub"table": table, "query": query&rcub)`
- `pipeline(&lcub"table": table, "query": [query]&rcub)`
- `pipeline([&lcub"table": table, "query": query&rcub, &lcub"table": table, "query": query&rcub])`
...
> **class transformers.TextClassificationPipeline**(return_all_scores: bool = None, function_to_apply: str = None, **kwargs)


Text classification pipeline using any `ModelForSequenceClassification`. See the [sequence classification
examples](../task_summary.html#sequence-classification) for more information.

This text classification pipeline can currently be loaded from [pipeline()](main_classes/pipelines.html#transformers.pipeline) using the following
...
> **\_\_call\_\_**(self, *args, return_all_scores: typing.Optional[bool] = None, function_to_apply: typing.Optional[transformers.pipelines.text_classification.ClassificationFunction] = None, **kwargs)
...
> **class transformers.TextGenerationPipeline**(*args, return_full_text = True, **kwargs)


Language generation pipeline using any `ModelWithLMHead`. This pipeline predicts the words that will follow a
specified text prompt.

This language generation pipeline can currently be loaded from [pipeline()](main_classes/pipelines.html#transformers.pipeline) using the following
...
> **\_\_call\_\_**(self, text_inputs, return_tensors = False, return_text = True, return_full_text = None, clean_up_tokenization_spaces = False, prefix = None, **generate_kwargs)
...
This Text2TextGenerationPipeline pipeline can currently be loaded from [pipeline()](main_classes/pipelines.html#transformers.pipeline) using the
...
> **\_\_call\_\_**(self, *args, return_tensors = False, return_text = True, clean_up_tokenization_spaces = False, truncation = TruncationStrategy.DO_NOT_TRUNCATE, **generate_kwargs)
...
> **class transformers.TranslationPipeline**(*args, src_lang = None, tgt_lang = None, **kwargs)


Translates from one language to another.

This translation pipeline can currently be loaded from [pipeline()](main_classes/pipelines.html#transformers.pipeline) using the following task
...
> **\_\_call\_\_**(self, *args, return_tensors = False, return_text = True, clean_up_tokenization_spaces = False, truncation = TruncationStrategy.DO_NOT_TRUNCATE, src_lang = None, tgt_lang = None, **generate_kwargs)
...
> **class transformers.ZeroShotClassificationPipeline**(args_parser = &lcubtransformers.pipelines.zero_shot_classification.ZeroShotClassificationArgumentHandler object at 0x7f37c1623350>, *args, **kwargs)
...
This NLI pipeline can currently be loaded from [pipeline()](main_classes/pipelines.html#transformers.pipeline) using the following task identifier:
...
> **\_\_call\_\_**(self, sequences: typing.Union[str, typing.List[str]], candidate_labels, hypothesis_template = This example is &lcub&rcub., multi_label = False, **kwargs)
...
- **hypothesis_template** (`str`, _optional_, defaults to `"This example is &lcub&rcub."`) --
  The template used to turn each label into an NLI-style hypothesis. This template must include a &lcub&rcub or
  similar syntax for the candidate label to be inserted into the template. For example, the default
  template is `"This example is &lcub&rcub."` With the candidate label `"sports"`, this would be fed
...
Some pipeline, like for instance [FeatureExtractionPipeline](main_classes/pipelines.html#transformers.FeatureExtractionPipeline) (`'feature-extraction'` )
