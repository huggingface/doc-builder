...
The base classes [PreTrainedTokenizer](main_classes/tokenizer.html#transformers.PreTrainedTokenizer) and [PreTrainedTokenizerFast](main_classes/tokenizer.html#transformers.PreTrainedTokenizerFast)
implement the common methods for encoding string inputs in model inputs (see below) and instantiating/saving python and
"Fast" tokenizers either from a local file or directory or from a pretrained tokenizer provided by the library
(downloaded from HuggingFace's AWS S3 repository). They both rely on
[PreTrainedTokenizerBase](internal/tokenization_utils.html#transformers.PreTrainedTokenizerBase) that contains the common methods, and
[SpecialTokensMixin](internal/tokenization_utils.html#transformers.SpecialTokensMixin).

[PreTrainedTokenizer](main_classes/tokenizer.html#transformers.PreTrainedTokenizer) and [PreTrainedTokenizerFast](main_classes/tokenizer.html#transformers.PreTrainedTokenizerFast) thus implement the main
...
[BatchEncoding](main_classes/tokenizer.html#transformers.BatchEncoding) holds the output of the tokenizer's encoding methods (`__call__`,
...
Inherits from [PreTrainedTokenizerBase](internal/tokenization_utils.html#transformers.PreTrainedTokenizerBase).
...
The [PreTrainedTokenizerFast](main_classes/tokenizer.html#transformers.PreTrainedTokenizerFast) depend on the [tokenizers](https://huggingface.co/docs/tokenizers) library. The tokenizers obtained from the 🤗 tokenizers library can be
loaded very simply into 🤗 transformers. Take a look at the [Using tokenizers from 🤗 tokenizers](../fast_tokenizers.html) page to understand how this is done.
...
- **tokenizer_object** (`tokenizers.Tokenizer`) --
  ...
  from 🤗 tokenizers](../fast_tokenizers.html) for more information.
- **tokenizer_file** (`str`) --
...
- **padding_strategy** ([PaddingStrategy](internal/file_utils.html#transformers.file_utils.PaddingStrategy)) --
  The kind of padding that will be applied to the input
- **truncation_strategy** ([TruncationStrategy](internal/tokenization_utils.html#transformers.tokenization_utils_base.TruncationStrategy)) --
...
[PreTrainedTokenizerFast](main_classes/tokenizer.html#transformers.PreTrainedTokenizerFast)
...
Holds the output of the [encode_plus()](internal/tokenization_utils.html#transformers.PreTrainedTokenizerBase.encode_plus) and
...
Character spans are returned as a [CharSpan](internal/tokenization_utils.html#transformers.CharSpan) with:
...
[CharSpan](internal/tokenization_utils.html#transformers.CharSpan)
...
Token spans are returned as a [TokenSpan](internal/tokenization_utils.html#transformers.TokenSpan) with:
...
Optional [TokenSpan](internal/tokenization_utils.html#transformers.TokenSpan) Span of tokens in the encoded sequence.
