...
sections:
- local: featureextractionmixin
  title: FeatureExtractionMixin
- local: sequencefeatureextractor
  title: SequenceFeatureExtractor
- local: batchfeature
  title: BatchFeature
- local: imagefeatureextractionmixin
...
Instantiate a type of [FeatureExtractionMixin](/docs/transformers/master/en/main_classes/feature_extractor.html#transformers.feature_extraction_utils.FeatureExtractionMixin) from a feature
extractor, *e.g.* a derived class of [SequenceFeatureExtractor](/docs/transformers/master/en/main_classes/feature_extractor.html#transformers.SequenceFeatureExtractor).
...
A feature extractor of type [FeatureExtractionMixin](/docs/transformers/master/en/main_classes/feature_extractor.html#transformers.feature_extraction_utils.FeatureExtractionMixin).
...
[from_pretrained()](/docs/transformers/master/en/main_classes/feature_extractor.html#transformers.feature_extraction_utils.FeatureExtractionMixin.from_pretrained) class method.
...
Holds the output of the [pad()](/docs/transformers/master/en/main_classes/feature_extractor.html#transformers.SequenceFeatureExtractor.pad) and feature extractor specific
`__call__` methods.
...
## [ImageFeatureExtractionMixin](#imagefeatureextractionmixin)
