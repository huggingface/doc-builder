...
> **save\_pretrained**(self, save_directory: typing.Union[str, os.PathLike], save_config: bool = True, state_dict: typing.Optional[dict] = None, save_function: typing.Callable = &amp;lt;function save at 0x7f12aecbbef0>, push_to_hub: bool = False, **kwargs)
...
> **get\_extended\_attention\_mask**(self, attention_mask: Tensor, input_shape: typing.Tuple[int], device: &amp;lt;property object at 0x7f111e57aa10>)
