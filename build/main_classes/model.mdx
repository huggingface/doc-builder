...
The base classes [PreTrainedModel](main_classes/model.html#transformers.PreTrainedModel), [TFPreTrainedModel](main_classes/model.html#transformers.TFPreTrainedModel), and
[FlaxPreTrainedModel](main_classes/model.html#transformers.FlaxPreTrainedModel) implement the common methods for loading/saving a model either from a local
file or directory, or from a pretrained model configuration provided by the library (downloaded from HuggingFace's AWS
S3 repository).

[PreTrainedModel](main_classes/model.html#transformers.PreTrainedModel) and [TFPreTrainedModel](main_classes/model.html#transformers.TFPreTrainedModel) also implement a few methods which
are common among all the models to:

- resize the input token embeddings when new tokens are added to the vocabulary
- prune the attention heads of the model.

The other methods that are common to each model are defined in [ModuleUtilsMixin](main_classes/model.html#transformers.modeling_utils.ModuleUtilsMixin)
(for the PyTorch models) and `TFModuleUtilsMixin` (for the TensorFlow models) or
for text generation, [GenerationMixin](main_classes/model.html#transformers.generation_utils.GenerationMixin) (for the PyTorch models),
[TFGenerationMixin](main_classes/model.html#transformers.generation_tf_utils.TFGenerationMixin) (for the TensorFlow models) and
[FlaxGenerationMixin](main_classes/model.html#transformers.generation_flax_utils.FlaxGenerationMixin) (for the Flax/JAX models).
...
[PreTrainedModel](main_classes/model.html#transformers.PreTrainedModel) takes care of storing the configuration of the models and handles methods
...
- **config_class** ([PretrainedConfig](main_classes/configuration.html#transformers.PretrainedConfig)) -- A subclass of
  [PretrainedConfig](main_classes/configuration.html#transformers.PretrainedConfig) to use as configuration class for this model architecture.
- **load_tf_weights** (`Callable`) -- A python _method_ for loading a TensorFlow checkpoint in a PyTorch
  model, taking as arguments:

  - **model** ([PreTrainedModel](main_classes/model.html#transformers.PreTrainedModel)) -- An instance of the model on which to load the
...
- **config** (`Union[PretrainedConfig, str, os.PathLike]`, _optional_) --
  ...
  - an instance of a class derived from [PretrainedConfig](main_classes/configuration.html#transformers.PretrainedConfig),
  - a string or path valid as input to [from_pretrained()](main_classes/configuration.html#transformers.PretrainedConfig.from_pretrained).
...
heads to prune in said layer (list of `int`). For instance &lcub1: [0, 2], 2: [2, 3]} will prune heads
...
> **save\_pretrained**(self, save_directory: typing.Union[str, os.PathLike], save_config: bool = True, state_dict: typing.Optional[dict] = None, save_function: typing.Callable = <function save at 0x7fc61fea50e0>, push_to_hub: bool = False, **kwargs)


Save a model and its configuration file to a directory, so that it can be re-loaded using the
`[from_pretrained()](main_classes/model.html#transformers.PreTrainedModel.from_pretrained)` class method.
...
> **get\_extended\_attention\_mask**(self, attention_mask: Tensor, input_shape: typing.Tuple[int], device: <property object at 0x7fc5a232cad0>)
...
[add_memory_hooks()](main_classes/model.html#transformers.modeling_utils.ModuleUtilsMixin.add_memory_hooks)).
...
[TFPreTrainedModel](main_classes/model.html#transformers.TFPreTrainedModel) takes care of storing the configuration of the models and handles methods
for loading, downloading and saving models as well as a few methods common to all models to:
...
- **pretrained_model_name_or_path** (`str`, _optional_) --
  ...
  - A string, the _model id_ of a pretrained model hosted inside a model repo on huggingface.co.
    ...
    a user or organization name, like `dbmdz/bert-base-german-cased`.
  - A path to a _directory_ containing model weights saved using
    [save_pretrained()](main_classes/model.html#transformers.TFPreTrainedModel.save_pretrained), e.g., `./my_model_directory/`.
...
- **config** (`Union[PretrainedConfig, str]`, _optional_) --
  ...
  - an instance of a class derived from [PretrainedConfig](main_classes/configuration.html#transformers.PretrainedConfig),
  - a string valid as input to [from_pretrained()](main_classes/configuration.html#transformers.PretrainedConfig.from_pretrained).
...
- The model is a model provided by the library (loaded with the _model id_ string of a pretrained
  model).
- The model was saved using [save_pretrained()](main_classes/model.html#transformers.TFPreTrainedModel.save_pretrained) and is reloaded
  by supplying the save directory.
- The model is loaded by supplying a local directory as `pretrained_model_name_or_path` and a
  configuration JSON file named _config.json_ is found in the directory.
...
Save a model and its configuration file to a directory, so that it can be re-loaded using the
[from_pretrained()](main_classes/model.html#transformers.TFPreTrainedModel.from_pretrained) class method.
...
[FlaxPreTrainedModel](main_classes/model.html#transformers.FlaxPreTrainedModel) takes care of storing the configuration of the models and handles
...
Save a model and its configuration file to a directory, so that it can be re-loaded using the
`[from_pretrained()](main_classes/model.html#transformers.FlaxPreTrainedModel.from_pretrained)` class method
...
[PreTrainedModel](main_classes/model.html#transformers.PreTrainedModel).
...
Implement in subclasses of [PreTrainedModel](main_classes/model.html#transformers.PreTrainedModel) for custom behavior to adjust the logits in
the generate method.
...
- **beam_scorer** (`BeamScorer`) --
  A derived instance of [BeamScorer](internal/generation_utils.html#transformers.BeamScorer) that defines how beam hypotheses are
  constructed, stored and sorted during generation. For more information, the documentation of
  [BeamScorer](internal/generation_utils.html#transformers.BeamScorer) should be read.
- **logits_processor** (`LogitsProcessorList`, _optional_) --
  An instance of [LogitsProcessorList](internal/generation_utils.html#transformers.LogitsProcessorList). List of instances of class derived from
  [LogitsProcessor](internal/generation_utils.html#transformers.LogitsProcessor) used to modify the prediction scores of the language modeling
  head applied at each generation step.
- **stopping_criteria** (`StoppingCriteriaList`, _optional_) --
  An instance of [StoppingCriteriaList](internal/generation_utils.html#transformers.StoppingCriteriaList). List of instances of class derived from
  [StoppingCriteria](internal/generation_utils.html#transformers.StoppingCriteria) used to tell if the generation loop should stop.
- **logits_warper** (`LogitsProcessorList`, _optional_) --
  An instance of [LogitsProcessorList](internal/generation_utils.html#transformers.LogitsProcessorList). List of instances of class derived from
  [LogitsWarper](internal/generation_utils.html#transformers.LogitsWarper) used to warp the prediction score distribution of the language
...
[BeamSampleDecoderOnlyOutput](internal/generation_utils.html#transformers.generation_utils.BeamSampleDecoderOnlyOutput),
[BeamSampleEncoderDecoderOutput](internal/generation_utils.html#transformers.generation_utils.BeamSampleEncoderDecoderOutput) or obj:_torch.LongTensor_: A
`torch.LongTensor` containing the generated tokens (default behaviour) or a
[BeamSampleDecoderOnlyOutput](internal/generation_utils.html#transformers.generation_utils.BeamSampleDecoderOnlyOutput) if
`model.config.is_encoder_decoder=False` and `return_dict_in_generate=True` or a
[BeamSampleEncoderDecoderOutput](internal/generation_utils.html#transformers.generation_utils.BeamSampleEncoderDecoderOutput) if
...
- **input_ids** (`torch.LongTensor` of shape `(batch_size, sequence_length)`) --
  The sequence used as a prompt for the generation.
- **beam_scorer** (`BeamScorer`) --
  An derived instance of [BeamScorer](internal/generation_utils.html#transformers.BeamScorer) that defines how beam hypotheses are
  constructed, stored and sorted during generation. For more information, the documentation of
  [BeamScorer](internal/generation_utils.html#transformers.BeamScorer) should be read.
- **logits_processor** (`LogitsProcessorList`, _optional_) --
  An instance of [LogitsProcessorList](internal/generation_utils.html#transformers.LogitsProcessorList). List of instances of class derived from
...
[BeamSearchEncoderDecoderOutput](internal/generation_utils.html#transformers.generation_utils.BeamSearchEncoderDecoderOutput) or obj:_torch.LongTensor_: A
`torch.LongTensor` containing the generated tokens (default behaviour) or a
[BeamSearchDecoderOnlyOutput](internal/generation_utils.html#transformers.generation_utils.BeamSearchDecoderOnlyOutput) if
`model.config.is_encoder_decoder=False` and `return_dict_in_generate=True` or a
[BeamSearchEncoderDecoderOutput](internal/generation_utils.html#transformers.generation_utils.BeamSearchEncoderDecoderOutput) if
`model.config.is_encoder_decoder=True`.
...
attribute of the same name inside the [PretrainedConfig](main_classes/configuration.html#transformers.PretrainedConfig) of the model. The default values
...
A
[ModelOutput](main_classes/output.html#transformers.file_utils.ModelOutput) (if `return_dict_in_generate=True` or when
...
possible [ModelOutput](main_classes/output.html#transformers.file_utils.ModelOutput) types are:

- [GreedySearchDecoderOnlyOutput](internal/generation_utils.html#transformers.generation_utils.GreedySearchDecoderOnlyOutput),
- [SampleDecoderOnlyOutput](internal/generation_utils.html#transformers.generation_utils.SampleDecoderOnlyOutput),
- [BeamSearchDecoderOnlyOutput](internal/generation_utils.html#transformers.generation_utils.BeamSearchDecoderOnlyOutput),
- [BeamSampleDecoderOnlyOutput](internal/generation_utils.html#transformers.generation_utils.BeamSampleDecoderOnlyOutput)

If the model is an encoder-decoder model (`model.config.is_encoder_decoder=True`), the possible
[ModelOutput](main_classes/output.html#transformers.file_utils.ModelOutput) types are:

- [GreedySearchEncoderDecoderOutput](internal/generation_utils.html#transformers.generation_utils.GreedySearchEncoderDecoderOutput),
- [SampleEncoderDecoderOutput](internal/generation_utils.html#transformers.generation_utils.SampleEncoderDecoderOutput),
- [BeamSearchEncoderDecoderOutput](internal/generation_utils.html#transformers.generation_utils.BeamSearchEncoderDecoderOutput),
- [BeamSampleEncoderDecoderOutput](internal/generation_utils.html#transformers.generation_utils.BeamSampleEncoderDecoderOutput)

> Return type

[ModelOutput](main_classes/output.html#transformers.file_utils.ModelOutput) or `torch.LongTensor`
...
[GreedySearchDecoderOnlyOutput](internal/generation_utils.html#transformers.generation_utils.GreedySearchDecoderOnlyOutput),
[GreedySearchEncoderDecoderOutput](internal/generation_utils.html#transformers.generation_utils.GreedySearchEncoderDecoderOutput) or obj:_torch.LongTensor_: A
`torch.LongTensor` containing the generated tokens (default behaviour) or a
[GreedySearchDecoderOnlyOutput](internal/generation_utils.html#transformers.generation_utils.GreedySearchDecoderOnlyOutput) if
`model.config.is_encoder_decoder=False` and `return_dict_in_generate=True` or a
[GreedySearchEncoderDecoderOutput](internal/generation_utils.html#transformers.generation_utils.GreedySearchEncoderDecoderOutput) if
`model.config.is_encoder_decoder=True`.
...
Implement in subclasses of [PreTrainedModel](main_classes/model.html#transformers.PreTrainedModel) for custom behavior to prepare inputs in the
generate method.
...
[SampleDecoderOnlyOutput](internal/generation_utils.html#transformers.generation_utils.SampleDecoderOnlyOutput),
[SampleEncoderDecoderOutput](internal/generation_utils.html#transformers.generation_utils.SampleEncoderDecoderOutput) or obj:_torch.LongTensor_: A
`torch.LongTensor` containing the generated tokens (default behaviour) or a
[SampleDecoderOnlyOutput](internal/generation_utils.html#transformers.generation_utils.SampleDecoderOnlyOutput) if
`model.config.is_encoder_decoder=False` and `return_dict_in_generate=True` or a
[SampleEncoderDecoderOutput](internal/generation_utils.html#transformers.generation_utils.SampleEncoderDecoderOutput) if
`model.config.is_encoder_decoder=True`.
...
A class containing all of the functions supporting generation, to be used as a mixin in
[TFPreTrainedModel](main_classes/model.html#transformers.TFPreTrainedModel).
...
[ModelOutput](main_classes/output.html#transformers.file_utils.ModelOutput) or `tf.Tensor`
...
print(f'Generated: &lcubtokenizer.decode(outputs[0], skip_special_tokens=True)}')
...
print(f'Generated &lcubi}: &lcubtokenizer.decode(outputs[i], skip_special_tokens=True)}')
...
Implement in subclasses of [TFPreTrainedModel](main_classes/model.html#transformers.TFPreTrainedModel) for custom behavior to prepare inputs in
the generate method.
...
A class containing all of the functions supporting generation, to be used as a mixin in
[FlaxPreTrainedModel](main_classes/model.html#transformers.FlaxPreTrainedModel).
...
name inside the [PretrainedConfig](main_classes/configuration.html#transformers.PretrainedConfig) of the model. The default values indicated are the
...
[ModelOutput](main_classes/output.html#transformers.file_utils.ModelOutput).
...
Upload the &lcubobject_files} to the 🤗 Model Hub while synchronizing a local clone of the repo in
`repo_path_or_name`.

> Parameters

- **repo_path_or_name** (`str`, _optional_) --
  Can either be a repository name for your &lcubobject} in the Hub or a path to a local folder (in which case
  the repository will have the name of that local folder). If not specified, will default to the name
  given by `repo_url` and a local directory with that name will be created.
- **repo_url** (`str`, _optional_) --
  Specify this in case you want to push to an existing repository in the hub. If unspecified, a new
...
- **use_temp_dir** (`bool`, _optional_, defaults to `False`) --
  ...
  since you will need to clone the repo before every push.
- **commit_message** (`str`, _optional_) --
  Message to commit while pushing. Will default to `"add &lcubobject}"`.
- **organization** (`str`, _optional_) --
  Organization in which you want to push your &lcubobject} (you must be a member of this organization).
- **private** (`bool`, _optional_) --
  Whether or not the repository created should be private (requires a paying subscription).
- **use_auth_token** (`bool` or `str`, _optional_) --
  The token to use as HTTP bearer authorization for remote files. If `True`, will use the token
...
The url of the commit of your &lcubobject} in the given repository.
...
```python
from transformers import &lcubobject_class}

&lcubobject} = &lcubobject_class}.from_pretrained("bert-base-cased")

# Push the &lcubobject} to your namespace with the name "my-finetuned-bert" and have a local clone in the
# _my-finetuned-bert_ folder.
&lcubobject}.push_to_hub("my-finetuned-bert")

# Push the &lcubobject} to your namespace with the name "my-finetuned-bert" with no local clone.
&lcubobject}.push_to_hub("my-finetuned-bert", use_temp_dir=True)

# Push the &lcubobject} to an organization with the name "my-finetuned-bert" and have a local clone in the
# _my-finetuned-bert_ folder.
&lcubobject}.push_to_hub("my-finetuned-bert", organization="huggingface")

# Make a change to an existing repo that has been cloned locally in _my-finetuned-bert_.
&lcubobject}.push_to_hub("my-finetuned-bert", repo_url="https://huggingface.co/sgugger/my-finetuned-bert")
```
