...
models) and is not well defined for masked language models like BERT (see [summary of the models](/docs/transformers/:version/:language/model_summary.html)).
...
process. The largest version of [GPT-2](/docs/transformers/:version/:language/model_doc/gpt2.html), for example, has a fixed length of 1024 tokens, so we
