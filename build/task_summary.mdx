...
# [Summary of the tasks](#summary-of-the-tasks)
...
automatically selecting the correct model architecture. Please check the [AutoModel](/docs/transformers/master/en/model_doc/auto.html#transformers.AutoModel) documentation
...
In the next section, we show how [generate()](/docs/transformers/master/en/main_classes/model.html#transformers.generation_utils.GenerationMixin.generate) can be used to
...
[generate()](/docs/transformers/master/en/main_classes/model.html#transformers.generation_utils.GenerationMixin.generate) to generate text. The default arguments for this method can be
