...
automatically selecting the correct model architecture. Please check the [AutoModel](docs/transformers/:version/:language/model_doc/auto.html#transformers.AutoModel) documentation
...
In the next section, we show how [generate()](docs/transformers/:version/:language/main_classes/model.html#transformers.generation_utils.GenerationMixin.generate) can be used to
...
[generate()](docs/transformers/:version/:language/main_classes/model.html#transformers.generation_utils.GenerationMixin.generate) to generate text. The default arguments for this method can be
