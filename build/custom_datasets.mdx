...
[Trainer](docs/transformers/:version/:language/main_classes/trainer.html#transformers.Trainer)/[TFTrainer](docs/transformers/:version/:language/main_classes/trainer.html#transformers.TFTrainer) or with native PyTorch/TensorFlow.
...
[forward()](docs/transformers/:version/:language/model_doc/distilbert.html#transformers.DistilBertForSequenceClassification.forward) method of the model we will train.
...
[Trainer](docs/transformers/:version/:language/main_classes/trainer.html#transformers.Trainer)/[TFTrainer](docs/transformers/:version/:language/main_classes/trainer.html#transformers.TFTrainer) or with native PyTorch/TensorFlow. See [training](/docs/transformers/:version/:language/training.html).
...
to fine-tune, define the [TrainingArguments](docs/transformers/:version/:language/main_classes/trainer.html#transformers.TrainingArguments)/[TFTrainingArguments](docs/transformers/:version/:language/main_classes/trainer.html#transformers.TFTrainingArguments) and
instantiate a [Trainer](docs/transformers/:version/:language/main_classes/trainer.html#transformers.Trainer)/[TFTrainer](docs/transformers/:version/:language/main_classes/trainer.html#transformers.TFTrainer).
...
[Trainer](docs/transformers/:version/:language/main_classes/trainer.html#transformers.Trainer)/[TFTrainer](docs/transformers/:version/:language/main_classes/trainer.html#transformers.TFTrainer) or with native PyTorch/TensorFlow, exactly as in the
...
we can use the built in [char_to_token()](docs/transformers/:version/:language/main_classes/tokenizer.html#transformers.BatchEncoding.char_to_token) method.
...
[Trainer](docs/transformers/:version/:language/main_classes/trainer.html#transformers.Trainer)/[TFTrainer](docs/transformers/:version/:language/main_classes/trainer.html#transformers.TFTrainer) exactly as in the sequence classification example
...
- [Preprocessing](/docs/transformers/:version/:language/preprocessing.html). Docs page on data preprocessing.
- [Training](/docs/transformers/:version/:language/training.html). Docs page on training and fine-tuning.
