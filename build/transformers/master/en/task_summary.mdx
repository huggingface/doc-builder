...
model on a GLUE sequence classification task, you may leverage the :prefix_link:_run_glue.py
 , :prefix_link:_run_tf_glue.py
 , :prefix_link:_run_tf_text_classification.py
  or :prefix_link:_run_xnli.py
  scripts.
...
task, you may leverage the :prefix_link:_run_mlm.py   script.
...
:prefix_link:_run_clm.py   script.
...
:prefix_link:_run_ner.py   script.
...
approaches are described in this :prefix_link:_document  .
