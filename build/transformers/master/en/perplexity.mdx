...
models) and is not well defined for masked language models like BERT (see [summary of the models](/docs/transformers/master/en/model_summary)).
...
process. The largest version of [GPT-2](/docs/transformers/master/en/model_doc/gpt2), for example, has a fixed length of 1024 tokens, so we
...
<h2 id="example-calculating-perplexity-with-gpt-in-transformers">Example: Calculating perplexity with GPT-2 in 🤗 Transformers</h2>
