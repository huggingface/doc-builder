...
<div class="docstring">
<docstring><name>dict\_torch\_dtype\_to\_str</name><anchor>transformers.PretrainedConfig.dict_torch_dtype_to_str</anchor><source>https://github.com/huggingface/transformers/blob/master/src/transformers/configuration_utils.py#L807</source><parameters>[{"name": "d", "val": ": typing.Dict[str, typing.Any]"}]</parameters></docstring>
...
<div class="docstring">
<docstring><name>from\_dict</name><anchor>transformers.PretrainedConfig.from_dict</anchor><source>https://github.com/huggingface/transformers/blob/master/src/transformers/configuration_utils.py#L610</source><parameters>[{"name": "config_dict", "val": ": typing.Dict[str, typing.Any]"}, {"name": "**kwargs", "val": ""}]</parameters><paramsdesc>- **config_dict** (`Dict[str, Any]`) --
...
<div class="docstring">
<docstring><name>get\_config\_dict</name><anchor>transformers.PretrainedConfig.get_config_dict</anchor><source>https://github.com/huggingface/transformers/blob/master/src/transformers/configuration_utils.py#L512</source><parameters>[{"name": "pretrained_model_name_or_path", "val": ": typing.Union[str, os.PathLike]"}, {"name": "**kwargs", "val": ""}]</parameters><paramsdesc>- **pretrained_model_name_or_path** (`str` or `os.PathLike`) --
...
<div class="docstring">
<docstring><name>to\_json\_string</name><anchor>transformers.PretrainedConfig.to_json_string</anchor><source>https://github.com/huggingface/transformers/blob/master/src/transformers/configuration_utils.py#L727</source><parameters>[{"name": "use_diff", "val": ": bool = True"}]</parameters><paramsdesc>- **use_diff** (`bool`, *optional*, defaults to `True`) --
  If set to `True`, only the difference between the config instance and the default
...
<div class="docstring">
<docstring><name>update</name><anchor>transformers.PretrainedConfig.update</anchor><source>https://github.com/huggingface/transformers/blob/master/src/transformers/configuration_utils.py#L759</source><parameters>[{"name": "config_dict", "val": ": typing.Dict[str, typing.Any]"}]</parameters><paramsdesc>- **config_dict** (`Dict[str, Any]`) -- Dictionary of attributes that should be updated for this class.</paramsdesc><paramgroups>0</paramgroups></docstring>
