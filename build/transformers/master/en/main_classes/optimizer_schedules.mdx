...
<div class="docstring">
<docstring><name>step</name><anchor>transformers.Adafactor.step</anchor><source>https://github.com/huggingface/transformers/blob/master/src/transformers/optimization.py#L512</source><parameters>[{"name": "closure", "val": " = None"}]</parameters><paramsdesc>- **closure** (callable, optional) -- A closure that reevaluates the model
...
<docstring><name>class transformers.AdamWeightDecay</name><anchor>transformers.AdamWeightDecay</anchor><source>https://github.com/huggingface/transformers/blob/master/src/transformers/optimization_tf.py#L152</source><parameters>[{"name": "learning_rate", "val": ": typing.Union[float, tensorflow.python.keras.optimizer_v2.learning_rate_schedule.LearningRateSchedule] = 0.001"}, {"name": "beta_1", "val": ": float = 0.9"}, {"name": "beta_2", "val": ": float = 0.999"}, {"name": "epsilon", "val": ": float = 1e-07"}, {"name": "amsgrad", "val": ": bool = False"}, {"name": "weight_decay_rate", "val": ": float = 0.0"}, {"name": "include_in_weight_decay", "val": ": typing.Optional[typing.List[str]] = None"}, {"name": "exclude_from_weight_decay", "val": ": typing.Optional[typing.List[str]] = None"}, {"name": "name", "val": ": str = 'AdamWeightDecay'"}, {"name": "**kwargs", "val": ""}]</parameters><paramsdesc>- **learning_rate** (`Union[float, tf.keras.optimizers.schedules.LearningRateSchedule]`, *optional*, defaults to 1e-3) --
