...
> When using `lr=None` with [Trainer](main_classes/trainer.html#transformers.Trainer) you will most likely need to use `AdafactorSchedule` scheduler as following:
