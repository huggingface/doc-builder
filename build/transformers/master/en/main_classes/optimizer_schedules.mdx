...
<div class="docstring">
<docstring><name>step</name><anchor>transformers.Adafactor.step</anchor><source>https://github.com/huggingface/transformers/blob/master/src/transformers/optimization.py#L520</source><parameters>[{"name": "closure", "val": " = None"}]</parameters><paramsdesc>- **closure** (callable, optional) -- A closure that reevaluates the model
