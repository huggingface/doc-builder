...
<docstring><name>"class transformers.deepspeed.HfDeepSpeedConfig"</name><anchor>"transformers.deepspeed.HfDeepSpeedConfig"</anchor><source>"https://github.com/huggingface/transformers/blob/master/src/transformers/deepspeed.py#L40"</source><parameters>[{"name": "config_file_or_dict", "val": ""}]</parameters><paramsdesc>[{"name": "config_file_or_dict", "description": "- **config_file_or_dict** (`Union[str, Dict]`) -- path to DeepSpeed config file or dict.", "anchor": "transformers.deepspeed.HfDeepSpeedConfig.config_file_or_dict"}]</paramsdesc></docstring>
