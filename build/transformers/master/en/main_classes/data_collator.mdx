...
- **pad_to_multiple_of** (`int`, _optional_) --
  ...
  7.5 (Volta).</paramsdesc><paramgroups>0</paramgroups></docstring>
...
- **label_pad_token_id** (`int`, _optional_, defaults to -100) --
  The id to use when padding the labels (-100 will be automatically ignore by PyTorch loss functions).</paramsdesc><paramgroups>0</paramgroups></docstring>
...
- **pad_to_multiple_of** (`int`, _optional_) --
  ...
  7.5 (Volta).
- **label_pad_token_id** (`int`, _optional_, defaults to -100) --
  The id to use when padding the labels (-100 will be automatically ignored by PyTorch loss functions).</paramsdesc><paramgroups>0</paramgroups></docstring>
...
- **pad_to_multiple_of** (`int`, _optional_) --
  If set will pad the sequence to a multiple of the provided value.</paramsdesc><paramgroups>0</paramgroups></docstring>
