...
<docstring><name>"class transformers.EvalPrediction"</name><anchor>"transformers.EvalPrediction"</anchor><source>"https://github.com/huggingface/transformers/blob/master/src/transformers/trainer_utils.py#L68"</source><parameters>[{"name": "predictions", "val": ": typing.Union[numpy.ndarray, typing.Tuple[numpy.ndarray]]"}, {"name": "label_ids", "val": ": typing.Union[numpy.ndarray, typing.Tuple[numpy.ndarray]]"}]</parameters><paramsdesc>[{"name": "predictions", "description": "- **predictions** (`np.ndarray`) -- Predictions of the model.", "anchor": "transformers.EvalPrediction.predictions"}, {"name": "label_ids", "description": "- **label_ids** (`np.ndarray`) -- Targets to be matched.", "anchor": "transformers.EvalPrediction.label_ids"}]</paramsdesc></docstring>
...
<docstring><name>"transformers.set\_seed"</name><anchor>"transformers.set_seed"</anchor><source>"https://github.com/huggingface/transformers/blob/master/src/transformers/trainer_utils.py#L50"</source><parameters>[{"name": "seed", "val": ": int"}]</parameters><paramsdesc>[{"name": "seed", "description": "- **seed** (`int`) -- The seed to set.", "anchor": "transformers.set_seed.seed"}]</paramsdesc></docstring>
...
<docstring><name>"transformers.torch\_distributed\_zero\_first"</name><anchor>"transformers.torch_distributed_zero_first"</anchor><source>"https://github.com/huggingface/transformers/blob/master/src/transformers/trainer_pt_utils.py#L206"</source><parameters>[{"name": "local_rank", "val": ": int"}]</parameters><paramsdesc>[{"name": "local_rank", "description": "- **local_rank** (`int`) -- The rank of the local process.", "anchor": "transformers.torch_distributed_zero_first.local_rank"}]</paramsdesc></docstring>
...
<docstring><name>"class transformers.trainer\_pt\_utils.DistributedTensorGatherer"</name><anchor>"transformers.trainer_pt_utils.DistributedTensorGatherer"</anchor><source>"https://github.com/huggingface/transformers/blob/master/src/transformers/trainer_pt_utils.py#L332"</source><parameters>[{"name": "world_size", "val": ""}, {"name": "num_samples", "val": ""}, {"name": "make_multiple_of", "val": " = None"}, {"name": "padding_index", "val": " = -100"}]</parameters><paramsdesc>[{"name": "world_size", "description": "- **world_size** (`int`) -- The number of processes used in the distributed training.", "anchor": "transformers.trainer_pt_utils.DistributedTensorGatherer.world_size"}, {"name": "num_samples", "description": "- **num_samples** (`int`) -- The number of samples in our dataset.", "anchor": "transformers.trainer_pt_utils.DistributedTensorGatherer.num_samples"}, {"name": "make_multiple_of", "description": "- **make_multiple_of** (`int`, _optional_) -- If passed, the class assumes the datasets passed to each process are made to be a multiple of this argument (by adding samples).", "anchor": "transformers.trainer_pt_utils.DistributedTensorGatherer.make_multiple_of"}, {"name": "padding_index", "description": "- **padding_index** (`int`, _optional_, defaults to -100) -- The padding index to use if the arrays don't all have the same sequence length.", "anchor": "transformers.trainer_pt_utils.DistributedTensorGatherer.padding_index"}]</paramsdesc></docstring>
...
<div class="docstring">
<docstring><name>"add\_arrays"</name><anchor>"transformers.trainer_pt_utils.DistributedTensorGatherer.add_arrays"</anchor><source>"https://github.com/huggingface/transformers/blob/master/src/transformers/trainer_pt_utils.py#L393"</source><parameters>[{"name": "arrays", "val": ""}]</parameters></docstring>
...
<div class="docstring">
<docstring><name>"finalize"</name><anchor>"transformers.trainer_pt_utils.DistributedTensorGatherer.finalize"</anchor><source>"https://github.com/huggingface/transformers/blob/master/src/transformers/trainer_pt_utils.py#L429"</source><parameters>[]</parameters></docstring>
...
<docstring><name>"class transformers.debug\_utils.DebugUnderflowOverflow"</name><anchor>"transformers.debug_utils.DebugUnderflowOverflow"</anchor><source>"https://github.com/huggingface/transformers/blob/master/src/transformers/debug_utils.py#L28"</source><parameters>[{"name": "model", "val": ""}, {"name": "max_frames_to_save", "val": " = 21"}, {"name": "trace_batch_nums", "val": " = []"}, {"name": "abort_after_batch_num", "val": " = None"}]</parameters><paramsdesc>[{"name": "model", "description": "- **model** (`nn.Module`) -- The model to debug.", "anchor": "transformers.debug_utils.DebugUnderflowOverflow.model"}, {"name": "max_frames_to_save", "description": "- **max_frames_to_save** (`int`, _optional_, defaults to 21) -- How many frames back to record", "anchor": "transformers.debug_utils.DebugUnderflowOverflow.max_frames_to_save"}, {"name": "trace_batch_nums(`List[int]`,", "description": "- **trace_batch_nums(`List[int]`,** _optional_, defaults to `[]`) -- Which batch numbers to trace (turns detection off)", "anchor": "transformers.debug_utils.DebugUnderflowOverflow.trace_batch_nums(`List[int]`,"}, {"name": "abort_after_batch_num", "description": "- **abort_after_batch_num** (`int``, _optional_) -- Whether to abort after a certain batch number has finished", "anchor": "transformers.debug_utils.DebugUnderflowOverflow.abort_after_batch_num"}]</paramsdesc></docstring>
