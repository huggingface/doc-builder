...
<div class="docstring">
<docstring><name>save</name><anchor>transformers.CsvPipelineDataFormat.save</anchor><source>https://github.com/huggingface/transformers/blob/master/src/transformers/pipelines/base.py#L528</source><parameters>[{"name": "data", "val": ": typing.List[dict]"}]</parameters><paramsdesc>- **data** (`List[dict]`) -- The data to store.</paramsdesc><paramgroups>0</paramgroups></docstring>
