...
- a *config.json* file, which saves the [configuration](/docs/transformers/master/en/main_classes/configuration) of your model ;
- a *pytorch_model.bin* file, which is the PyTorch checkpoint (unless you can't have it for some reason) ;
- a *tf_model.h5* file, which is the TensorFlow checkpoint (unless you can't have it for some reason) ;
- a *special_tokens_map.json*, which is part of your [tokenizer](/docs/transformers/master/en/main_classes/tokenizer) save;
- a *tokenizer_config.json*, which is part of your [tokenizer](/docs/transformers/master/en/main_classes/tokenizer) save;
...
- maybe a *added_tokens.json*, which is part of your [tokenizer](/docs/transformers/master/en/main_classes/tokenizer) save.
