...
This is the configuration class to store the configuration of a [CTRLModel](model_doc/ctrl.html#transformers.CTRLModel) or a
[TFCTRLModel](model_doc/ctrl.html#transformers.TFCTRLModel). It is used to instantiate a CTRL model according to the specified arguments,
...
- **vocab_size** (`int`, _optional_, defaults to 246534) --
  ...
  `inputs_ids` passed when calling [CTRLModel](model_doc/ctrl.html#transformers.CTRLModel) or
  [TFCTRLModel](model_doc/ctrl.html#transformers.TFCTRLModel).
...
- **config** ([CTRLConfig](model_doc/ctrl.html#transformers.CTRLConfig)) -- Model configuration class with all the parameters of the model.
...
The [CTRLModel](model_doc/ctrl.html#transformers.CTRLModel) forward method, overrides the `__call__` special method.
...
- **input_ids** (`torch.LongTensor` of shape `(batch_size, sequence_length)`) --
  ...
  Indices can be obtained using [CTRLTokenizer](model_doc/ctrl.html#transformers.CTRLTokenizer). See
...
A [BaseModelOutputWithPast](main_classes/output.html#transformers.modeling_outputs.BaseModelOutputWithPast) or a tuple of
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising
various elements depending on the configuration ([CTRLConfig](model_doc/ctrl.html#transformers.CTRLConfig)) and inputs.
...
[BaseModelOutputWithPast](main_classes/output.html#transformers.modeling_outputs.BaseModelOutputWithPast) or `tuple(torch.FloatTensor)`
...
The [CTRLLMHeadModel](model_doc/ctrl.html#transformers.CTRLLMHeadModel) forward method, overrides the `__call__` special method.
...
A [CausalLMOutputWithPast](main_classes/output.html#transformers.modeling_outputs.CausalLMOutputWithPast) or a tuple of
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising
various elements depending on the configuration ([CTRLConfig](model_doc/ctrl.html#transformers.CTRLConfig)) and inputs.
...
[CausalLMOutputWithPast](main_classes/output.html#transformers.modeling_outputs.CausalLMOutputWithPast) or `tuple(torch.FloatTensor)`
...
[CTRLForSequenceClassification](model_doc/ctrl.html#transformers.CTRLForSequenceClassification) uses the last token in order to do the classification, as
...
The [CTRLForSequenceClassification](model_doc/ctrl.html#transformers.CTRLForSequenceClassification) forward method, overrides the `__call__` special method.
...
The [TFCTRLModel](model_doc/ctrl.html#transformers.TFCTRLModel) forward method, overrides the `__call__` special method.
...
elements depending on the configuration ([CTRLConfig](model_doc/ctrl.html#transformers.CTRLConfig)) and inputs.
...
The [TFCTRLLMHeadModel](model_doc/ctrl.html#transformers.TFCTRLLMHeadModel) forward method, overrides the `__call__` special method.
...
[TFCTRLForSequenceClassification](model_doc/ctrl.html#transformers.TFCTRLForSequenceClassification) uses the last token in order to do the classification, as
...
The [TFCTRLForSequenceClassification](model_doc/ctrl.html#transformers.TFCTRLForSequenceClassification) forward method, overrides the `__call__` special method.
