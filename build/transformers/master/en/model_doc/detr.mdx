...
<div class="docstring">
<docstring><name>post\_process</name><anchor>transformers.DetrFeatureExtractor.post_process</anchor><source>https://github.com/huggingface/transformers/blob/master/src/transformers/models/detr/feature_extraction_detr.py#L675</source><parameters>[{"name": "outputs", "val": ""}, {"name": "target_sizes", "val": ""}]</parameters><paramsdesc>- **outputs** (`DetrObjectDetectionOutput`) --
...
<div class="docstring">
<docstring><name>post\_process\_segmentation</name><anchor>transformers.DetrFeatureExtractor.post_process_segmentation</anchor><source>https://github.com/huggingface/transformers/blob/master/src/transformers/models/detr/feature_extraction_detr.py#L713</source><parameters>[{"name": "outputs", "val": ""}, {"name": "target_sizes", "val": ""}, {"name": "threshold", "val": " = 0.9"}, {"name": "mask_threshold", "val": " = 0.5"}]</parameters><paramsdesc>- **outputs** (`DetrSegmentationOutput`) --
  Raw outputs of the model.
...
<div class="docstring">
<docstring><name>post\_process\_panoptic</name><anchor>transformers.DetrFeatureExtractor.post_process_panoptic</anchor><source>https://github.com/huggingface/transformers/blob/master/src/transformers/models/detr/feature_extraction_detr.py#L800</source><parameters>[{"name": "outputs", "val": ""}, {"name": "processed_sizes", "val": ""}, {"name": "target_sizes", "val": " = None"}, {"name": "is_thing_map", "val": " = None"}, {"name": "threshold", "val": " = 0.85"}]</parameters><paramsdesc>- **outputs** (`DetrSegmentationOutput`) --
  Raw outputs of the model.
...
<docstring><name>forward</name><anchor>transformers.DetrModel.forward</anchor><source>https://github.com/huggingface/transformers/blob/master/src/transformers/models/detr/modeling_detr.py#L1191</source><parameters>[{"name": "pixel_values", "val": ""}, {"name": "pixel_mask", "val": " = None"}, {"name": "decoder_attention_mask", "val": " = None"}, {"name": "encoder_outputs", "val": " = None"}, {"name": "inputs_embeds", "val": " = None"}, {"name": "decoder_inputs_embeds", "val": " = None"}, {"name": "output_attentions", "val": " = None"}, {"name": "output_hidden_states", "val": " = None"}, {"name": "return_dict", "val": " = None"}]</parameters><paramsdesc>- **pixel_values** (`torch.FloatTensor` of shape `(batch_size, num_channels, height, width)`) --
  ...
  [DetrFeatureExtractor.__call__()](/docs/transformers/master/en/model_doc/detr#transformers.DetrFeatureExtractor.__call__) for details.
...
```python --
 transformers import DetrFeatureExtractor, DetrModel
 PIL import Image
rt requests
...
ure_extractor = DetrFeatureExtractor.from_pretrained('facebook/detr-resnet-50')
l = DetrModel.from_pretrained('facebook/detr-resnet-50')
...
```python --
 transformers import DetrFeatureExtractor, DetrForObjectDetection
 PIL import Image
rt requests
...
ure_extractor = DetrFeatureExtractor.from_pretrained('facebook/detr-resnet-50')
l = DetrForObjectDetection.from_pretrained('facebook/detr-resnet-50')

ts = feature_extractor(images=image, return_tensors="pt")
uts = model(**inputs)
del predicts bounding boxes and corresponding COCO classes
ts = outputs.logits
es = outputs.pred_boxes
``` --</paramsdesc><paramgroups>0</paramgroups></docstring>
...
ure_extractor = DetrFeatureExtractor.from_pretrained('facebook/detr-resnet-50-panoptic')
l = DetrForSegmentation.from_pretrained('facebook/detr-resnet-50-panoptic')

ts = feature_extractor(images=image, return_tensors="pt")
uts = model(**inputs)
del predicts COCO classes, bounding boxes, and masks
ts = outputs.logits
es = outputs.pred_boxes
s = outputs.pred_masks
``` --</paramsdesc><paramgroups>0</paramgroups></docstring>
