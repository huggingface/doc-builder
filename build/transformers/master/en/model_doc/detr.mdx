...
<docstring><name>class transformers.DetrModel</name><anchor>transformers.DetrModel</anchor><source>https://github.com/huggingface/transformers/blob/master/src/transformers/models/detr/modeling_detr.py#L1168</source><parameters>[{"name": "config", "val": ": DetrConfig"}]</parameters><paramsdesc>- **config** ([DetrConfig](/docs/transformers/master/en/model_doc/detr#transformers.DetrConfig)) --
...
<docstring><name>class transformers.DetrForSegmentation</name><anchor>transformers.DetrForSegmentation</anchor><source>https://github.com/huggingface/transformers/blob/master/src/transformers/models/detr/modeling_detr.py#L1483</source><parameters>[{"name": "config", "val": ": DetrConfig"}]</parameters><paramsdesc>- **config** ([DetrConfig](/docs/transformers/master/en/model_doc/detr#transformers.DetrConfig)) --
  Model configuration class with all the parameters of the model. Initializing with a config file does not
  load the weights associated with the model, only the configuration. Check out the
  [from_pretrained()](/docs/transformers/master/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.</paramsdesc><paramgroups>0</paramgroups></docstring>
...
<div class="docstring">
<docstring><name>forward</name><anchor>transformers.DetrForSegmentation.forward</anchor><source>https://github.com/huggingface/transformers/blob/master/src/transformers/models/detr/modeling_detr.py#L1505</source><parameters>[{"name": "pixel_values", "val": ""}, {"name": "pixel_mask", "val": " = None"}, {"name": "decoder_attention_mask", "val": " = None"}, {"name": "encoder_outputs", "val": " = None"}, {"name": "inputs_embeds", "val": " = None"}, {"name": "decoder_inputs_embeds", "val": " = None"}, {"name": "labels", "val": " = None"}, {"name": "output_attentions", "val": " = None"}, {"name": "output_hidden_states", "val": " = None"}, {"name": "return_dict", "val": " = None"}]</parameters><paramsdesc>- **pixel_values** (`torch.FloatTensor` of shape `(batch_size, num_channels, height, width)`) --
  Pixel values. Padding will be ignored by default should you provide it.
