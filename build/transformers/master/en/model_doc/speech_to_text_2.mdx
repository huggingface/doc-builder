...
The Speech2Text2 model is used together with [Wav2Vec2](wav2vec2.html) for Speech Translation models proposed in
...
[Wav2Vec2](wav2vec2.html) or [HuBERT](hubert.html) for Speech-to-Text tasks. Please refer to the
[SpeechEncoderDecoder](speechencoderdecoder.html) class on how to combine Speech2Text2 with any speech *encoder-only*
model.
...
- Speech2Text2 is always used within the [SpeechEncoderDecoder](speechencoderdecoder.html) framework.
- Speech2Text2's tokenizer currently only supports inference, but not training.

## Inference

Speech2Text2's [SpeechEncoderDecoderModel](model_doc/speechencoderdecoder.html#transformers.SpeechEncoderDecoderModel) model accepts raw waveform input values from speech and
makes use of [generate()](main_classes/model.html#transformers.generation_utils.GenerationMixin.generate) to translate the input speech
autoregressively to the target language.

The [Wav2Vec2FeatureExtractor](model_doc/wav2vec2.html#transformers.Wav2Vec2FeatureExtractor) class is responsible for preprocessing the input speech and
[Speech2Text2Tokenizer](model_doc/speech_to_text_2.html#transformers.Speech2Text2Tokenizer) decodes the generated target tokens to the target string. The
[Speech2Text2Processor](model_doc/speech_to_text_2.html#transformers.Speech2Text2Processor) wraps [Wav2Vec2FeatureExtractor](model_doc/wav2vec2.html#transformers.Wav2Vec2FeatureExtractor) and
[Speech2Text2Tokenizer](model_doc/speech_to_text_2.html#transformers.Speech2Text2Tokenizer) into a single instance to both extract the input features and decode the
predicted token ids.
...
> **class transformers.Speech2Text2Config**(vocab_size = 10000, decoder_layers = 6, decoder_ffn_dim = 2048, decoder_attention_heads = 4, decoder_layerdrop = 0.0, use_cache = True, activation_function = relu, d_model = 256, dropout = 0.1, attention_dropout = 0.0, activation_dropout = 0.0, init_std = 0.02, decoder_start_token_id = 2, classifier_dropout = 0.0, scale_embedding = True, gradient_checkpointing = False, pad_token_id = 1, bos_token_id = 0, eos_token_id = 2, max_source_positions = 6000, max_target_positions = 1024, **kwargs)


This is the configuration class to store the configuration of a [Speech2Text2ForCausalLM](model_doc/speech_to_text_2.html#transformers.Speech2Text2ForCausalLM). It
...
[Speech2Text2Processor](model_doc/speech_to_text_2.html#transformers.Speech2Text2Processor) offers all the functionalities of
[AutoFeatureExtractor](model_doc/auto.html#transformers.AutoFeatureExtractor) and [Speech2Text2Tokenizer](model_doc/speech_to_text_2.html#transformers.Speech2Text2Tokenizer). See the
[__call__()](model_doc/speech_to_text_2.html#transformers.Speech2Text2Processor.__call__) and [decode()](model_doc/speech_to_text_2.html#transformers.Speech2Text2Processor.decode) for
more information.

> Parameters

- **feature_extractor** (`AutoFeatureExtractor`) --
  An instance of [AutoFeatureExtractor](model_doc/auto.html#transformers.AutoFeatureExtractor). The feature extractor is a required input.
- **tokenizer** (`Speech2Text2Tokenizer`) --
  An instance of [Speech2Text2Tokenizer](model_doc/speech_to_text_2.html#transformers.Speech2Text2Tokenizer). The tokenizer is a required input.
...
[as_target_processor()](model_doc/speech_to_text_2.html#transformers.Speech2Text2Processor.as_target_processor) this method forwards all its arguments to
Speech2Text2Tokenizer's [__call__()](internal/tokenization_utils.html#transformers.PreTrainedTokenizerBase.__call__). Please refer to the doctsring of
...
Instantiate a [Speech2Text2Processor](model_doc/speech_to_text_2.html#transformers.Speech2Text2Processor) from a pretrained Speech2Text2 processor.
...
[from_pretrained()](model_doc/speech_to_text_2.html#transformers.Speech2Text2Processor.from_pretrained) class method.
...
The Speech2Text2 Decoder with a language modeling head. Can be used as the decoder part of [EncoderDecoderModel](model_doc/encoderdecoder.html#transformers.EncoderDecoderModel) and `SpeechEncoderDecoder`.
...
- **config** ([Speech2Text2Config](model_doc/speech_to_text_2.html#transformers.Speech2Text2Config)) --
...
- **input_ids** (`torch.LongTensor` of shape `(batch_size, sequence_length)`) --
  ...
  Indices can be obtained using [Speech2Text2Tokenizer](model_doc/speech_to_text_2.html#transformers.Speech2Text2Tokenizer). See
...
various elements depending on the configuration ([Speech2Text2Config](model_doc/speech_to_text_2.html#transformers.Speech2Text2Config)) and inputs.
