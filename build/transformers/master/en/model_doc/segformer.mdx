...
<docstring><name>forward</name><anchor>transformers.SegformerModel.forward</anchor><source>https://github.com/huggingface/transformers/blob/master/src/transformers/models/segformer/modeling_segformer.py#L482</source><parameters>[{"name": "pixel_values", "val": ""}, {"name": "output_attentions", "val": " = None"}, {"name": "output_hidden_states", "val": " = None"}, {"name": "return_dict", "val": " = None"}]</parameters><paramsdesc>- **pixel_values** (`torch.FloatTensor` of shape `(batch_size, num_channels, height, width)`) --
  ...
  [SegformerFeatureExtractor.__call__()](/docs/transformers/master/en/model_doc/segformer#transformers.SegformerFeatureExtractor.__call__) for details.
...
```python --
 transformers import SegformerFeatureExtractor, SegformerModel
 PIL import Image
rt requests

ure_extractor = SegformerFeatureExtractor.from_pretrained("nvidia/segformer-b0-finetuned-ade-512-512")
l = SegformerModel("nvidia/segformer-b0-finetuned-ade-512-512")
...
```python --
 transformers import SegformerFeatureExtractor, SegformerForImageClassification
 PIL import Image
rt requests
...
ure_extractor = SegformerFeatureExtractor.from_pretrained('nvidia/mit-b0')
l = SegformerForImageClassification.from_pretrained('nvidia/mit-b0')
...
```python --
 transformers import SegformerFeatureExtractor, SegformerForSemanticSegmentation
 PIL import Image
rt requests

ure_extractor = SegformerFeatureExtractor.from_pretrained("nvidia/segformer-b0-finetuned-ade-512-512")
l = SegformerForSemanticSegmentation.from_pretrained("nvidia/segformer-b0-finetuned-ade-512-512")
...
ts = feature_extractor(images=image, return_tensors="pt")
uts = model(**inputs)
ts = outputs.logits # shape (batch_size, num_labels, height/4, width/4)
``` --</paramsdesc><paramgroups>0</paramgroups></docstring>
