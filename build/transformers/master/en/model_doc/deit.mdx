...
<docstring><name>class transformers.DeiTModel</name><anchor>transformers.DeiTModel</anchor><source>https://github.com/huggingface/transformers/blob/master/src/transformers/models/deit/modeling_deit.py#L451</source><parameters>[{"name": "config", "val": ""}, {"name": "add_pooling_layer", "val": " = True"}]</parameters><paramsdesc>- **config** ([DeiTConfig](/docs/transformers/master/en/model_doc/deit#transformers.DeiTConfig)) -- Model configuration class with all the parameters of the model.
...
<div class="docstring">
<docstring><name>forward</name><anchor>transformers.DeiTModel.forward</anchor><source>https://github.com/huggingface/transformers/blob/master/src/transformers/models/deit/modeling_deit.py#L476</source><parameters>[{"name": "pixel_values", "val": " = None"}, {"name": "attention_mask", "val": " = None"}, {"name": "head_mask", "val": " = None"}, {"name": "output_attentions", "val": " = None"}, {"name": "output_hidden_states", "val": " = None"}, {"name": "return_dict", "val": " = None"}]</parameters><paramsdesc>- **pixel_values** (`torch.FloatTensor` of shape `(batch_size, num_channels, height, width)`) --
...
```python --
 transformers import DeiTFeatureExtractor, DeiTModel
 PIL import Image
rt requests
...
ure_extractor = DeiTFeatureExtractor.from_pretrained('facebook/deit-base-distilled-patch16-224')
l = DeiTModel.from_pretrained('facebook/deit-base-distilled-patch16-224', add_pooling_layer=False)
...
<docstring><name>class transformers.DeiTForImageClassification</name><anchor>transformers.DeiTForImageClassification</anchor><source>https://github.com/huggingface/transformers/blob/master/src/transformers/models/deit/modeling_deit.py#L570</source><parameters>[{"name": "config", "val": ""}]</parameters><paramsdesc>- **config** ([DeiTConfig](/docs/transformers/master/en/model_doc/deit#transformers.DeiTConfig)) -- Model configuration class with all the parameters of the model.
  Initializing with a config file does not load the weights associated with the model, only the
  configuration. Check out the [from_pretrained()](/docs/transformers/master/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model
  weights.</paramsdesc><paramgroups>0</paramgroups></docstring>
...
<div class="docstring">
<docstring><name>forward</name><anchor>transformers.DeiTForImageClassification.forward</anchor><source>https://github.com/huggingface/transformers/blob/master/src/transformers/models/deit/modeling_deit.py#L583</source><parameters>[{"name": "pixel_values", "val": " = None"}, {"name": "head_mask", "val": " = None"}, {"name": "labels", "val": " = None"}, {"name": "output_attentions", "val": " = None"}, {"name": "output_hidden_states", "val": " = None"}, {"name": "return_dict", "val": " = None"}]</parameters><paramsdesc>- **pixel_values** (`torch.FloatTensor` of shape `(batch_size, num_channels, height, width)`) --
  Pixel values. Pixel values can be obtained using [DeiTFeatureExtractor](/docs/transformers/master/en/model_doc/deit#transformers.DeiTFeatureExtractor). See
  [DeiTFeatureExtractor.__call__()](/docs/transformers/master/en/model_doc/deit#transformers.DeiTFeatureExtractor.__call__) for details.
...
```python --
 transformers import DeiTFeatureExtractor, DeiTForImageClassification
 PIL import Image
rt requests
...
te
 the head will be randomly initialized, hence the predictions will be random
ure_extractor = DeiTFeatureExtractor.from_pretrained('facebook/deit-base-distilled-patch16-224')
l = DeiTForImageClassification.from_pretrained('facebook/deit-base-distilled-patch16-224')
...
- **return_dict** (`bool`, *optional*) --
  ...
  Returns --
  `transformers.models.deit.modeling_deit.DeiTForImageClassificationWithTeacherOutput` or `tuple(torch.FloatTensor)`: A `transformers.models.deit.modeling_deit.DeiTForImageClassificationWithTeacherOutput` or a tuple of
  `torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
  elements depending on the configuration ([DeiTConfig](/docs/transformers/master/en/model_doc/deit#transformers.DeiTConfig)) and inputs.
...
```python --
 transformers import DeiTFeatureExtractor, DeiTForImageClassificationWithTeacher
 PIL import Image
rt requests
...
ure_extractor = DeiTFeatureExtractor.from_pretrained('facebook/deit-base-distilled-patch16-224')
l = DeiTForImageClassificationWithTeacher.from_pretrained('facebook/deit-base-distilled-patch16-224')
