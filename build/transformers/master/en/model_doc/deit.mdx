...
- There are 2 ways to fine-tune distilled models, either (1) in a classic way, by only placing a prediction head on top
  ...
  [DeiTForImageClassification](model_doc/deit.html#transformers.DeiTForImageClassification) and (2) corresponds to
  [DeiTForImageClassificationWithTeacher](model_doc/deit.html#transformers.DeiTForImageClassificationWithTeacher).
...
- The authors of DeiT also released more efficiently trained ViT models, which you can directly plug into
  [ViTModel](model_doc/vit.html#transformers.ViTModel) or [ViTForImageClassification](model_doc/vit.html#transformers.ViTForImageClassification). Techniques like data
  ...
  _facebook/deit-base-patch16-384_. Note that one should use [DeiTFeatureExtractor](model_doc/deit.html#transformers.DeiTFeatureExtractor) in order to
...
This is the configuration class to store the configuration of a [DeiTModel](model_doc/deit.html#transformers.DeiTModel). It is used to
...
- **config** ([DeiTConfig](model_doc/deit.html#transformers.DeiTConfig)) -- Model configuration class with all the parameters of the model.
...
The [DeiTModel](model_doc/deit.html#transformers.DeiTModel) forward method, overrides the `__call__` special method.
...
- **pixel_values** (`torch.FloatTensor` of shape `(batch_size, num_channels, height, width)`) --
  Pixel values. Pixel values can be obtained using [DeiTFeatureExtractor](model_doc/deit.html#transformers.DeiTFeatureExtractor). See
  [transformers.DeiTFeatureExtractor.__call__()](model_doc/deit.html#transformers.DeiTFeatureExtractor.__call__) for details.
...
various elements depending on the configuration ([DeiTConfig](model_doc/deit.html#transformers.DeiTConfig)) and inputs.
...
The [DeiTForImageClassification](model_doc/deit.html#transformers.DeiTForImageClassification) forward method, overrides the `__call__` special method.
...
The [DeiTForImageClassificationWithTeacher](model_doc/deit.html#transformers.DeiTForImageClassificationWithTeacher) forward method, overrides the `__call__` special method.
