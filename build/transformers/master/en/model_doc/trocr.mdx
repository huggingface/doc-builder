...
<docstring><name>class transformers.TrOCRForCausalLM</name><anchor>transformers.TrOCRForCausalLM</anchor><source>https://github.com/huggingface/transformers/blob/master/src/transformers/models/trocr/modeling_trocr.py#L776</source><parameters>[{"name": "config", "val": ""}]</parameters><paramsdesc>- **config** ([*TrOCRConfig*]) --
