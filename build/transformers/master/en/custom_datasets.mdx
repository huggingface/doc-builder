...
- [seq_imdb](/docs/transformers/master/en/custom_datasets#seq_imdb)
- [tok_ner](/docs/transformers/master/en/custom_datasets#tok_ner)
- [qa_squad](/docs/transformers/master/en/custom_datasets#qa_squad)
...
Now load your model with the [AutoModel](/docs/transformers/master/en/model_doc/auto#transformers.AutoModel) class along with the number of expected labels:
...
2. Pass the training arguments to a [Trainer](/docs/transformers/master/en/main_classes/trainer#transformers.Trainer) along with the model, dataset, tokenizer, and data
   collator.
...
Load your model with the [TFAutoModel](/docs/transformers/master/en/model_doc/auto#transformers.TFAutoModel) class along with the number of expected labels:
...
<h3 id="load-wnut-dataset">Load WNUT 17 dataset</h3>
...
Load your model with the [AutoModel](/docs/transformers/master/en/model_doc/auto#transformers.AutoModel) class along with the number of expected labels:
...
Load the model with the [TFAutoModel](/docs/transformers/master/en/model_doc/auto#transformers.TFAutoModel) class along with the number of expected labels:
...
Load your model with the [AutoModel](/docs/transformers/master/en/model_doc/auto#transformers.AutoModel) class:
...
Load your model with the [TFAutoModel](/docs/transformers/master/en/model_doc/auto#transformers.TFAutoModel) class:
