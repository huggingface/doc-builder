...
automatically selecting the correct model architecture. Please check the [AutoModel](model_doc/auto.html#transformers.AutoModel) documentation
...
- Not all models were fine-tuned on all tasks. If you want to fine-tune a model on a specific task, you can leverage
  one of the _run_$TASK.py_ scripts in the [examples](https://github.com/huggingface/transformers/tree/master/examples) directory.
...
model on a GLUE sequence classification task, you may leverage the :prefix_link:_run_glue.py
<examples/pytorch/text-classification/run_glue.py>_, :prefix_link:_run_tf_glue.py
<examples/tensorflow/text-classification/run_tf_glue.py>_, :prefix_link:_run_tf_text_classification.py
<examples/tensorflow/text-classification/run_tf_text_classification.py>_ or :prefix_link:_run_xnli.py
<examples/pytorch/text-classification/run_xnli.py>_ scripts.
...
task, you may leverage the :prefix_link:_run_mlm.py <examples/pytorch/language-modeling/run_mlm.py>_ script.
...
:prefix_link:_run_clm.py <examples/pytorch/language-modeling/run_clm.py>_ script.
...
In the next section, we show how [generate()](main_classes/model.html#transformers.generation_utils.GenerationMixin.generate) can be used to
...
[generate()](main_classes/model.html#transformers.generation_utils.GenerationMixin.generate) to generate text. The default arguments for this method can be
...
:prefix_link:_run_ner.py <examples/pytorch/token-classification/run_ner.py>_ script.
...
approaches are described in this :prefix_link:_document <examples/pytorch/summarization/README.md>_.
...
translation task, various approaches are described in this :prefix_link:_document
<examples/pytorch.translation/README.md>_.
