...
The [generate()](main_classes/model.html#transformers.generation_utils.GenerationMixin.generate) method can be used to generate text using GPT-J
model.
...
> **class transformers.GPTJConfig**(vocab_size = 50400, n_positions = 2048, n_ctx = 2048, n_embd = 4096, n_layer = 28, n_head = 16, rotary_dim = 64, n_inner = None, activation_function = gelu_new, resid_pdrop = 0.0, embd_pdrop = 0.0, attn_pdrop = 0.0, layer_norm_epsilon = 1e-05, initializer_range = 0.02, scale_attn_weights = True, gradient_checkpointing = False, use_cache = True, bos_token_id = 50256, eos_token_id = 50256, **kwargs)


This is the configuration class to store the configuration of a [GPTJModel](model_doc/gptj.html#transformers.GPTJModel). It is used to
...
- **vocab_size** (`int`, _optional_, defaults to 50400) --
  ...
  `inputs_ids` passed when calling [GPTJModel](model_doc/gptj.html#transformers.GPTJModel).
...
- **config** ([GPTJConfig](model_doc/gptj.html#transformers.GPTJConfig)) -- Model configuration class with all the parameters of the model.
...
The [GPTJModel](model_doc/gptj.html#transformers.GPTJModel) forward method, overrides the `__call__` special method.
...
various elements depending on the configuration ([GPTJConfig](model_doc/gptj.html#transformers.GPTJConfig)) and inputs.
...
The [GPTJForCausalLM](model_doc/gptj.html#transformers.GPTJForCausalLM) forward method, overrides the `__call__` special method.
...
[GPTJForSequenceClassification](model_doc/gptj.html#transformers.GPTJForSequenceClassification) uses the last token in order to do the classification, as
...
The [GPTJForSequenceClassification](model_doc/gptj.html#transformers.GPTJForSequenceClassification) forward method, overrides the `__call__` special method.
