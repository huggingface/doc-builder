...
- **annotations** (`Dict`, `List[Dict]`, _optional_) --
  ...
  In case [DetrFeatureExtractor](model_doc/detr.html#transformers.DetrFeatureExtractor) was initialized with `format = "coco_detection"`, the annotations for each image should have the following format: {'image_id': int,
  'annotations': [annotation]}, with the annotations being a list of COCO object annotations.

  In case [DetrFeatureExtractor](model_doc/detr.html#transformers.DetrFeatureExtractor) was initialized with `format = "coco_panoptic"`, the annotations for each image should have the following format: {'image_id': int,
