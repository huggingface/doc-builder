...
- Examples and scripts for fine-tuning BART and other models for sequence to sequence tasks can be found in
  :prefix_link:_examples/pytorch/summarization/ <examples/pytorch/summarization/README.md>_.
...
- Bart doesn't use `token_type_ids` for sequence classification. Use [BartTokenizer](model_doc/bart.html#transformers.BartTokenizer) or
  [encode()](internal/tokenization_utils.html#transformers.PreTrainedTokenizerBase.encode) to get the proper splitting.
- The forward pass of [BartModel](model_doc/bart.html#transformers.BartModel) will create the `decoder_input_ids` if they are not passed.
...
- [generate()](main_classes/model.html#transformers.generation_utils.GenerationMixin.generate) should be used for conditional generation tasks like
...
This is the configuration class to store the configuration of a [BartModel](model_doc/bart.html#transformers.BartModel). It is used to
...
- **vocab_size** (`int`, _optional_, defaults to 50265) --
  ...
  `inputs_ids` passed when calling [BartModel](model_doc/bart.html#transformers.BartModel) or
  [TFBartModel](model_doc/bart.html#transformers.TFBartModel).
...
- **use_cache** (`bool`, _optional_, defaults to `True`) --
  ...
  The number of labels to use in [BartForSequenceClassification](model_doc/bart.html#transformers.BartForSequenceClassification).
...
[BartTokenizer](model_doc/bart.html#transformers.BartTokenizer) is identical to [RobertaTokenizer](model_doc/roberta.html#transformers.RobertaTokenizer). Refer to superclass
[RobertaTokenizer](model_doc/roberta.html#transformers.RobertaTokenizer) for usage examples and documentation concerning the initialization
...
[BartTokenizerFast](model_doc/bart.html#transformers.BartTokenizerFast) is identical to [RobertaTokenizerFast](model_doc/roberta.html#transformers.RobertaTokenizerFast). Refer to
superclass [RobertaTokenizerFast](model_doc/roberta.html#transformers.RobertaTokenizerFast) for usage examples and documentation concerning the
...
- **config** ([BartConfig](model_doc/bart.html#transformers.BartConfig)) --
...
The [BartModel](model_doc/bart.html#transformers.BartModel) forward method, overrides the `__call__` special method.
...
- **input_ids** (`torch.LongTensor` of shape `(batch_size, sequence_length)`) --
  ...
  Indices can be obtained using [BartTokenizer](model_doc/bart.html#transformers.BartTokenizer). See
...
various elements depending on the configuration ([BartConfig](model_doc/bart.html#transformers.BartConfig)) and inputs.
...
The [BartForConditionalGeneration](model_doc/bart.html#transformers.BartForConditionalGeneration) forward method, overrides the `__call__` special method.
...
The [BartForSequenceClassification](model_doc/bart.html#transformers.BartForSequenceClassification) forward method, overrides the `__call__` special method.
...
The [BartForQuestionAnswering](model_doc/bart.html#transformers.BartForQuestionAnswering) forward method, overrides the `__call__` special method.
...
- **config** ([BartConfig](model_doc/bart.html#transformers.BartConfig)) -- Model configuration class with all the parameters of the model.
...
The [TFBartModel](model_doc/bart.html#transformers.TFBartModel) forward method, overrides the `__call__` special method.
...
elements depending on the configuration ([BartConfig](model_doc/bart.html#transformers.BartConfig)) and inputs.
...
The [TFBartForConditionalGeneration](model_doc/bart.html#transformers.TFBartForConditionalGeneration) forward method, overrides the `__call__` special method.
