...
using SentencePiece are [ALBERT](/docs/transformers/master/en/model_doc/albert.html), [XLNet](/docs/transformers/master/en/model_doc/xlnet.html), [Marian](/docs/transformers/master/en/model_doc/marian.html), and [T5](/docs/transformers/master/en/model_doc/t5.html).
