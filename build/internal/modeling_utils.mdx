...
sections:
- local: pytorch-custom-modules
  title: Pytorch custom modules
- local: pytorch-helper-functions
  title: PyTorch Helper Functions
- local: tensorflow-custom-layers
  title: TensorFlow custom layers
- local: tensorflow-loss-functions
  title: TensorFlow loss functions
- local: tensorflow-helper-functions
...
Base class for outputs of question answering models using a [SQuADHead](/docs/transformers/master/en/internal/modeling_utils.html#transformers.modeling_utils.SQuADHead).
...
A [SquadHeadOutput](/docs/transformers/master/en/internal/modeling_utils.html#transformers.modeling_utils.SquadHeadOutput) or a tuple of
...
[SquadHeadOutput](/docs/transformers/master/en/internal/modeling_utils.html#transformers.modeling_utils.SquadHeadOutput) or `tuple(torch.FloatTensor)`
...
`torch.nn.Linear` or [Conv1D](/docs/transformers/master/en/internal/modeling_utils.html#transformers.Conv1D)
...
- **layer** ([Conv1D](/docs/transformers/master/en/internal/modeling_utils.html#transformers.Conv1D)) -- The layer to prune.
- **index** (`torch.LongTensor`) -- The indices to keep in the layer.
...
[Conv1D](/docs/transformers/master/en/internal/modeling_utils.html#transformers.Conv1D)
