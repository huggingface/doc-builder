...
Base interface for handling arguments for each [Pipeline](docs/transformers/:version/:language/main_classes/pipelines.html#transformers.Pipeline).
...
Creates an instance of the right subclass of [PipelineDataFormat](docs/transformers/:version/:language/internal/pipelines_utils.html#transformers.PipelineDataFormat) depending on
`format`.
...
[PipelineDataFormat](docs/transformers/:version/:language/internal/pipelines_utils.html#transformers.PipelineDataFormat)
...
Raised by a [Pipeline](docs/transformers/:version/:language/main_classes/pipelines.html#transformers.Pipeline) when handling __call__.
