...
[PreTrainedTokenizerBase](docs/transformers/:version/:language/internal/tokenization_utils.html#transformers.PreTrainedTokenizerBase) that implements the common methods between
[PreTrainedTokenizer](docs/transformers/:version/:language/main_classes/tokenizer.html#transformers.PreTrainedTokenizer) and [PreTrainedTokenizerFast](docs/transformers/:version/:language/main_classes/tokenizer.html#transformers.PreTrainedTokenizerFast) and the mixin
[SpecialTokensMixin](docs/transformers/:version/:language/internal/tokenization_utils.html#transformers.SpecialTokensMixin).
...
Base class for [PreTrainedTokenizer](docs/transformers/:version/:language/main_classes/tokenizer.html#transformers.PreTrainedTokenizer) and [PreTrainedTokenizerFast](docs/transformers/:version/:language/main_classes/tokenizer.html#transformers.PreTrainedTokenizerFast).
...
- **pretrained_init_configuration** (`Dict[str, Dict[str, Any]]`) -- A dictionary with, as keys, the
  ...
  tokenizer with the [from_pretrained()](docs/transformers/:version/:language/internal/tokenization_utils.html#transformers.PreTrainedTokenizerBase.from_pretrained)
  method.
...
- **model_max_length** (`int`, _optional_) --
  ...
  loaded with [from_pretrained()](docs/transformers/:version/:language/internal/tokenization_utils.html#transformers.PreTrainedTokenizerBase.from_pretrained), this
...
Instantiate a [PreTrainedTokenizerBase](docs/transformers/:version/:language/internal/tokenization_utils.html#transformers.PreTrainedTokenizerBase) (or a derived class) from
...
- **pretrained_model_name_or_path** (`str` or `os.PathLike`) --
  ...
  - A path to a _directory_ containing vocabulary files required by the tokenizer, for instance saved
    using the [save_pretrained()](docs/transformers/:version/:language/internal/tokenization_utils.html#transformers.PreTrainedTokenizerBase.save_pretrained)
...
- **encoded_inputs** ([BatchEncoding](docs/transformers/:version/:language/main_classes/tokenizer.html#transformers.BatchEncoding), list of [BatchEncoding](docs/transformers/:version/:language/main_classes/tokenizer.html#transformers.BatchEncoding), `Dict[str, List[int]]`, `Dict[str, List[List[int]]` or `List[Dict[str, List[int]]]`) --
  Tokenized inputs. Can represent one input ([BatchEncoding](docs/transformers/:version/:language/main_classes/tokenizer.html#transformers.BatchEncoding) or `Dict[str, List[int]]`) or a batch of tokenized inputs (list of [BatchEncoding](docs/transformers/:version/:language/main_classes/tokenizer.html#transformers.BatchEncoding), _Dict[str,
...
- `'pt'`: Return PyTorch `torch.Tensor` objects.
- `'np'`: Return Numpy `np.ndarray` objects.
truncation (`bool`, `str` or [TruncationStrategy](docs/transformers/:version/:language/internal/tokenization_utils.html#transformers.tokenization_utils_base.TruncationStrategy), _optional_, defaults to `True`):
Activates and controls truncation. Accepts the following values:
...
- **kwargs** (additional keyword arguments, _optional_) --
  ...
  [__call__()](docs/transformers/:version/:language/internal/tokenization_utils.html#transformers.PreTrainedTokenizerBase.__call__)
...
- **truncation_strategy** (`str` or [TruncationStrategy](docs/transformers/:version/:language/internal/tokenization_utils.html#transformers.tokenization_utils_base.TruncationStrategy), _optional_, defaults to `False`) --
...
A mixin derived by [PreTrainedTokenizer](docs/transformers/:version/:language/main_classes/tokenizer.html#transformers.PreTrainedTokenizer) and [PreTrainedTokenizerFast](docs/transformers/:version/:language/main_classes/tokenizer.html#transformers.PreTrainedTokenizerFast) to
...
In order to do that, please use the [resize_token_embeddings()](docs/transformers/:version/:language/main_classes/model.html#transformers.PreTrainedModel.resize_token_embeddings) method.
...
[BertTokenizer](docs/transformers/:version/:language/model_doc/bert.html#transformers.BertTokenizer) `cls_token` is already registered to be :obj_'[CLS]'_ and XLM's one
...
Possible values for the `truncation` argument in [PreTrainedTokenizerBase.__call__()](docs/transformers/:version/:language/internal/tokenization_utils.html#transformers.PreTrainedTokenizerBase.__call__). Useful for
