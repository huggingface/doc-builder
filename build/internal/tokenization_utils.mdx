...
sections:
- local: pretrainedtokenizerbase
  title: PreTrainedTokenizerBase
- local: specialtokensmixin
...
[PreTrainedTokenizerBase](/docs/transformers/master/en/internal/tokenization_utils.html#transformers.PreTrainedTokenizerBase) that implements the common methods between
[PreTrainedTokenizer](/docs/transformers/master/en/main_classes/tokenizer.html#transformers.PreTrainedTokenizer) and [PreTrainedTokenizerFast](/docs/transformers/master/en/main_classes/tokenizer.html#transformers.PreTrainedTokenizerFast) and the mixin
...
Base class for [PreTrainedTokenizer](/docs/transformers/master/en/main_classes/tokenizer.html#transformers.PreTrainedTokenizer) and [PreTrainedTokenizerFast](/docs/transformers/master/en/main_classes/tokenizer.html#transformers.PreTrainedTokenizerFast).
...
Instantiate a [PreTrainedTokenizerBase](/docs/transformers/master/en/internal/tokenization_utils.html#transformers.PreTrainedTokenizerBase) (or a derived class) from
...
- **pretrained_model_name_or_path** (`str` or `os.PathLike`) --
  ...
  - A path to a _directory_ containing vocabulary files required by the tokenizer, for instance saved
    using the [save_pretrained()](/docs/transformers/master/en/internal/tokenization_utils.html#transformers.PreTrainedTokenizerBase.save_pretrained)
...
- **proxies** (`Dict[str, str], `optional`) -- A dictionary of proxy servers to use by protocol or endpoint, e.g., `&amp;lcub;'http': 'foo.bar:3128',
  'http://hostname': 'foo.bar:4012'}`. The proxies are used on each request. - **use_auth_token** (`str` or _bool_, _optional_) -- The token to use as HTTP bearer authorization for remote files. If `True`, will use the token generated when running `transformers-cli login` (stored in `~/.huggingface`). - **local_files_only** (`bool`, _optional_, defaults to `False`) --
...
- **encoded_inputs** ([BatchEncoding](/docs/transformers/master/en/main_classes/tokenizer.html#transformers.BatchEncoding), list of [BatchEncoding](/docs/transformers/master/en/main_classes/tokenizer.html#transformers.BatchEncoding), `Dict[str, List[int]]`, `Dict[str, List[List[int]]` or `List[Dict[str, List[int]]]`) --
  Tokenized inputs. Can represent one input ([BatchEncoding](/docs/transformers/master/en/main_classes/tokenizer.html#transformers.BatchEncoding) or `Dict[str, List[int]]`) or a batch of tokenized inputs (list of [BatchEncoding](/docs/transformers/master/en/main_classes/tokenizer.html#transformers.BatchEncoding), _Dict[str,
...
- `'pt'`: Return PyTorch `torch.Tensor` objects.
- `'np'`: Return Numpy `np.ndarray` objects.
truncation (`bool`, `str` or [TruncationStrategy](/docs/transformers/master/en/internal/tokenization_utils.html#transformers.tokenization_utils_base.TruncationStrategy), _optional_, defaults to `True`):
Activates and controls truncation. Accepts the following values:
...
- **kwargs** (additional keyword arguments, _optional_) --
  ...
  [__call__()](/docs/transformers/master/en/internal/tokenization_utils.html#transformers.PreTrainedTokenizerBase.__call__)
...
- **truncation_strategy** (`str` or [TruncationStrategy](/docs/transformers/master/en/internal/tokenization_utils.html#transformers.tokenization_utils_base.TruncationStrategy), _optional_, defaults to `False`) --
...
A mixin derived by [PreTrainedTokenizer](/docs/transformers/master/en/main_classes/tokenizer.html#transformers.PreTrainedTokenizer) and [PreTrainedTokenizerFast](/docs/transformers/master/en/main_classes/tokenizer.html#transformers.PreTrainedTokenizerFast) to
...
In order to do that, please use the [resize_token_embeddings()](/docs/transformers/master/en/main_classes/model.html#transformers.PreTrainedModel.resize_token_embeddings) method.
...
[BertTokenizer](/docs/transformers/master/en/model_doc/bert.html#transformers.BertTokenizer) `cls_token` is already registered to be :obj_'[CLS]'_ and XLM's one
...
Possible values for the `truncation` argument in [PreTrainedTokenizerBase.__call__()](/docs/transformers/master/en/internal/tokenization_utils.html#transformers.PreTrainedTokenizerBase.__call__). Useful for
