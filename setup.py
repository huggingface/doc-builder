...
install_requires = ["black", "GitPython", "tqdm", "pyyaml", "packaging", "nbformat", "huggingface_hub @ git+https://github.com/huggingface/huggingface_hub.git@fix__prepare_payload_as_dict", "pillow", "meilisearch"]
