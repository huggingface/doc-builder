...
def convert_special_chars(text):
    ...
    """
    _re_lcub_svelte = re.compile(r"<(Question|Tip|DocNotebookDropdown|FrameworkSwitch)(((?!<(Question|Tip|DocNotebookDropdown|FrameworkSwitch)).)*)>|&amp;lcub;(#if|:else}|/if})", re.DOTALL)
