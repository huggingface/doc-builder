...
if __name__ == "__main__":
    """
    Will generate the documentation files in a `build` folder in the current working directory.
    If you would like to push to `doc-builder/build/...`, you should launch the command from the
    root of the repository:
    
    ```bash
    python src/build.py transformers ...
    ```
    """
