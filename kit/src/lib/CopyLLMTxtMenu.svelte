...
>
	<div bind:this={triggerEl} class="inline-flex rounded-md max-sm:rounded-sm">
		<button
			...
			aria-live="polite"
		>
			<span class="inline-flex items-center justify-center rounded-md p-0.5 max-sm:p-0 hover:text-gray-800 dark:hover:text-gray-200">
				<IconCopy classNames="sm:size-3.5 size-3" />
			</span>
		...
		>
			<IconCaret
				classNames={`transition-transform text-gray-400 overflow-visible sm:size-3.5 size-3 ${
