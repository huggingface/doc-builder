<script lang="ts">
	...
	function highlightSignature(name: string) {
		if (name.startsWith("class ")) {
			...
			return `<h4 class="!m-0"><span class="flex-1 rounded-xl py-0.5 break-all bg-gradient-to-r from-blue-50/60 to-white dark:from-gray-900 dark:to-gray-950 text-blue-700 dark:text-blue-300 font-medium px-2"><span class="text-xs">property&nbsp;</span>${name}</span></h4>`;
		} else {
